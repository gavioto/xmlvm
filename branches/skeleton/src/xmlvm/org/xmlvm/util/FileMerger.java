...
public class FileMerger {
     ...
     *            skeleton files.
     */
    public FileMerger(Collection<OutputFile> skeletons, String skeletonBasePath,
            Collection<UniversalFile> implementations, String implementationBasePath) {
    ...
    private Map<String, Map<String, String>> extractAllSections() {
        ...
        for (UniversalFile existingFile : implementations) {
            if (existingFile.isFile() && !existingFile.isEmpty()) {
                String key = implementationBasePath != null ? existingFile
                        .getRelativePath(implementationBasePath) : existingFile.getName();
