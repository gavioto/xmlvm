...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ALAssetsLibrary___INIT___]
    ALAssetsLibrary* objCObj = [[ALAssetsLibrary alloc ] init];
    org_xmlvm_ios_ALAssetsLibrary_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ALAssetsLibrary_videoAtPathIsCompatibleWithSavedPhotosAlbum___org_xmlvm_ios_NSURL]
    ...
    BOOL objCObj = [thiz  videoAtPathIsCompatibleWithSavedPhotosAlbum:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
