...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureStillImageOutput___INIT___]
    AVCaptureStillImageOutput* objCObj = [[AVCaptureStillImageOutput alloc ] init];
    org_xmlvm_ios_AVCaptureStillImageOutput_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureStillImageOutput_getAvailableImageDataCVPixelFormatTypes__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz availableImageDataCVPixelFormatTypes];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureStillImageOutput_getAvailableImageDataCodecTypes__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz availableImageDataCodecTypes];
    return fromNSArray(objCObj);
//XMLVM_END_WRAPPER
