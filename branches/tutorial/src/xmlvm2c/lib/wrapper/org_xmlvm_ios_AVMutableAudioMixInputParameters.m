...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVMutableAudioMixInputParameters___INIT___]
    AVMutableAudioMixInputParameters* objCObj = [[AVMutableAudioMixInputParameters alloc ] init];
    org_xmlvm_ios_AVMutableAudioMixInputParameters_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
