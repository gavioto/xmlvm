...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVMutableTimedMetadataGroup___INIT___]
    AVMutableTimedMetadataGroup* objCObj = [[AVMutableTimedMetadataGroup alloc ] init];
    org_xmlvm_ios_AVMutableTimedMetadataGroup_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVMutableTimedMetadataGroup___INIT____java_util_List_org_xmlvm_ios_CMTimeRange]
NSArray * ObjCVar1 = toNSArray(n1);
    
    AVMutableTimedMetadataGroup* objCObj = [[AVMutableTimedMetadataGroup alloc] initWithItems:ObjCVar1 timeRange:toCMTimeRange(n2)];
    [ObjCVar1 release];
