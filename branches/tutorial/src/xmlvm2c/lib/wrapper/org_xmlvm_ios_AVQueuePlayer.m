...
NSArray * ObjCVar1 = toNSArray(n1);
    ...
    AVQueuePlayer* objCObj = [[AVQueuePlayer alloc] initWithItems:ObjCVar1];
    [ObjCVar1 release];

    org_xmlvm_ios_AVQueuePlayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVQueuePlayer___INIT___]
    AVQueuePlayer* objCObj = [[AVQueuePlayer alloc ] init];
    org_xmlvm_ios_AVQueuePlayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVQueuePlayer___INIT____org_xmlvm_ios_NSURL]

    AVQueuePlayer* objCObj = [[AVQueuePlayer alloc] initWithURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_AVQueuePlayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVQueuePlayer___INIT____org_xmlvm_ios_AVPlayerItem]

    AVQueuePlayer* objCObj = [[AVQueuePlayer alloc] initWithPlayerItem:(AVPlayerItem*) (((org_xmlvm_ios_AVPlayerItem*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_AVQueuePlayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSArray * ObjCVar1 = toNSArray(n1);
    ...
    AVQueuePlayer* objCObj =  [AVQueuePlayer  queuePlayerWithItems:ObjCVar1];
    [ObjCVar1 release];

    if (!__TIB_org_xmlvm_ios_AVQueuePlayer.classInitialized) __INIT_org_xmlvm_ios_AVQueuePlayer();
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVQueuePlayer_canInsertItem___org_xmlvm_ios_AVPlayerItem_org_xmlvm_ios_AVPlayerItem]
    ...
    BOOL objCObj = [thiz  canInsertItem:(AVPlayerItem*) (((org_xmlvm_ios_AVPlayerItem*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) afterItem:(AVPlayerItem*) (((org_xmlvm_ios_AVPlayerItem*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
