...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVVideoCompositionCoreAnimationTool___INIT___]
    AVVideoCompositionCoreAnimationTool* objCObj = [[AVVideoCompositionCoreAnimationTool alloc ] init];
    org_xmlvm_ios_AVVideoCompositionCoreAnimationTool_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
