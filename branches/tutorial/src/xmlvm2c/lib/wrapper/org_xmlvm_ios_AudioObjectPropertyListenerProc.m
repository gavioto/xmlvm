...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AudioObjectPropertyListenerProc___INIT___]
    AudioObjectPropertyListenerProc* objCObj = [[AudioObjectPropertyListenerProc alloc ] init];
    org_xmlvm_ios_AudioObjectPropertyListenerProc_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
