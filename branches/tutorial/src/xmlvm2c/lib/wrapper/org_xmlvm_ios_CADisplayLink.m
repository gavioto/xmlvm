...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CADisplayLink___INIT___]
    CADisplayLink* objCObj = [[CADisplayLink alloc ] init];
    org_xmlvm_ios_CADisplayLink_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CADisplayLink_getFrameInterval__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz frameInterval];
    return objCObj;
//XMLVM_END_WRAPPER
