...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAPropertyAnimation___INIT___]
    CAPropertyAnimation* objCObj = [[CAPropertyAnimation alloc ] init];
    org_xmlvm_ios_CAPropertyAnimation_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [CAPropertyAnimation  animationWithKeyPath:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAPropertyAnimation_isCumulative__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz isCumulative];
    return objCObj;
//XMLVM_END_WRAPPER
