...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATransaction___INIT___]
    CATransaction* objCObj = [[CATransaction alloc ] init];
    org_xmlvm_ios_CATransaction_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATransaction_animationDuration__]
    ...
    double objCObj =  [CATransaction animationDuration];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATransaction_animationTimingFunction__]
    ...
    CAMediaTimingFunction* objCObj =  [CATransaction animationTimingFunction];
    if (!__TIB_org_xmlvm_ios_CAMediaTimingFunction.classInitialized) __INIT_org_xmlvm_ios_CAMediaTimingFunction();
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATransaction_disableActions__]
    ...
    BOOL objCObj =  [CATransaction disableActions];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATransaction_completionBlock__]
    ...
    NSObject* objCObj =  [CATransaction completionBlock];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [CATransaction  valueForKey:ObjCVar1];
    [ObjCVar1 release];
