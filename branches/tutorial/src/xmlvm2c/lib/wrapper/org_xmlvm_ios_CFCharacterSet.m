...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CFCharacterSet___INIT___]
    CFCharacterSet* objCObj = [[CFCharacterSet alloc ] init];
    org_xmlvm_ios_CFCharacterSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CFCharacterSet_getPredefined___long]
    ...
    CFCharacterSet* objCObj = CFCharacterSetGetPredefined(n1);
        if (!__TIB_org_xmlvm_ios_CFCharacterSet.classInitialized) __INIT_org_xmlvm_ios_CFCharacterSet();
...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CFCharacterSet* objCObj = CFCharacterSetCreateWithCharactersInRange(var1,toCFRange(n2));
        if (!__TIB_org_xmlvm_ios_CFCharacterSet.classInitialized) __INIT_org_xmlvm_ios_CFCharacterSet();
...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CFCharacterSet* objCObj = CFCharacterSetCreateWithCharactersInString(var1,ObjCVar2);
...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CFCharacterSet* objCObj = CFCharacterSetCreateInvertedSet(var1,(CFCharacterSet*) (((org_xmlvm_ios_CFCharacterSet*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj));
        if (!__TIB_org_xmlvm_ios_CFCharacterSet.classInitialized) __INIT_org_xmlvm_ios_CFCharacterSet();
...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CFCharacterSet* objCObj = ABMultiValueCreateMutable(var1);
        if (!__TIB_org_xmlvm_ios_CFCharacterSet.classInitialized) __INIT_org_xmlvm_ios_CFCharacterSet();
...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CFCharacterSet* objCObj = CFHostCreateCopy(var1,(CFCharacterSet*) (((org_xmlvm_ios_CFCharacterSet*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj));
        if (!__TIB_org_xmlvm_ios_CFCharacterSet.classInitialized) __INIT_org_xmlvm_ios_CFCharacterSet();
...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CFCharacterSet* objCObj = ABMultiValueCreateMutableCopy(var1,(CFCharacterSet*) (((org_xmlvm_ios_CFCharacterSet*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj));
        if (!__TIB_org_xmlvm_ios_CFCharacterSet.classInitialized) __INIT_org_xmlvm_ios_CFCharacterSet();
