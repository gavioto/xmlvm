...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CFPlugInInstance* objCObj = [[CFPlugInInstance alloc] create:var1];
    org_xmlvm_ios_CFPlugInInstance_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CFPlugInInstance___INIT___]
    CFPlugInInstance* objCObj = [[CFPlugInInstance alloc ] init];
    org_xmlvm_ios_CFPlugInInstance_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CFPlugInInstance* objCObj = CFPlugInInstanceCreateWithInstanceDataSize(var1,n2,((org_xmlvm_ios_NSObject*) n3)->fields.org_xmlvm_ios_NSObject.wrappedObj,ObjCVar4,((org_xmlvm_ios_NSObject*) n5)->fields.org_xmlvm_ios_NSObject.wrappedObj);
    
    [ObjCVar4 release];
    if (!__TIB_org_xmlvm_ios_CFPlugInInstance.classInitialized) __INIT_org_xmlvm_ios_CFPlugInInstance();
