...
XMLVM_VAR_BYTE_ARRAY(a3, n3); 
    ...
    CGPDFScanner* objCObj = [[CGPDFScanner alloc] create:(CGPDFContentStream*) (((org_xmlvm_ios_CGPDFContentStream*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_CGPDFScanner_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CGPDFScanner___INIT___]
    CGPDFScanner* objCObj = [[CGPDFScanner alloc ] init];
    org_xmlvm_ios_CGPDFScanner_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
