...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CMMuxedFormatDescription* objCObj = [[CMMuxedFormatDescription alloc] create:var1];
    org_xmlvm_ios_CMMuxedFormatDescription_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CMMuxedFormatDescription___INIT___]
    CMMuxedFormatDescription* objCObj = [[CMMuxedFormatDescription alloc ] init];
    org_xmlvm_ios_CMMuxedFormatDescription_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CMMuxedFormatDescription___INIT____org_xmlvm_ios_CFAllocator_int_int_org_xmlvm_ios_CFDictionary_org_xmlvm_ios_Reference<CMFormatDescription>]
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
