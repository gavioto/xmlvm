...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CMSimpleQueue* objCObj = [[CMSimpleQueue alloc] create:var1];
    org_xmlvm_ios_CMSimpleQueue_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CMSimpleQueue___INIT___]
    CMSimpleQueue* objCObj = [[CMSimpleQueue alloc ] init];
    org_xmlvm_ios_CMSimpleQueue_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
