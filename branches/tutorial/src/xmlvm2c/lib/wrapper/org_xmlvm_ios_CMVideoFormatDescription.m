...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CMVideoFormatDescription* objCObj = [[CMVideoFormatDescription alloc] create:var1];
    org_xmlvm_ios_CMVideoFormatDescription_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CMVideoFormatDescription___INIT___]
    CMVideoFormatDescription* objCObj = [[CMVideoFormatDescription alloc ] init];
    org_xmlvm_ios_CMVideoFormatDescription_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CMVideoFormatDescription___INIT____org_xmlvm_ios_CFAllocator_int_int_org_xmlvm_ios_CFDictionary_org_xmlvm_ios_Reference<CMFormatDescription>]
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    int objCObj = CMVideoFormatDescriptionCreateForImageBuffer(var1,(CVImageBuffer*) (((org_xmlvm_ios_CVImageBuffer*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj),(CMVideoFormatDescription*) (((org_xmlvm_ios_CMVideoFormatDescription*) n3)->fields.org_xmlvm_ios_NSObject.wrappedObj));
