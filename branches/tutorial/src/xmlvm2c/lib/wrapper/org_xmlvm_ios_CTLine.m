...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CTLine___INIT___]
    CTLine* objCObj = [[CTLine alloc ] init];
    org_xmlvm_ios_CTLine_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CTLine_createWithAttributedString___org_xmlvm_ios_CFAttributedString]
    ...
    CTLine* objCObj = CTFramesetterCreateWithAttributedString((CFAttributedString*) (((org_xmlvm_ios_CFAttributedString*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj));
        if (!__TIB_org_xmlvm_ios_CTLine.classInitialized) __INIT_org_xmlvm_ios_CTLine();
