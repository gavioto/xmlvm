...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_EKEventEditViewController___INIT___]
    EKEventEditViewController* objCObj = [[EKEventEditViewController alloc ] init];
    org_xmlvm_ios_EKEventEditViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_EKEventEditViewController___INIT____org_xmlvm_ios_UIViewController]

    EKEventEditViewController* objCObj = [[EKEventEditViewController alloc] initWithRootViewController:(UIViewController*) (((org_xmlvm_ios_UIViewController*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_EKEventEditViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    EKEventEditViewController* objCObj = [[EKEventEditViewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
