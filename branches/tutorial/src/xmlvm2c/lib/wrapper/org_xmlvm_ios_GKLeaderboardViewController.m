...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKLeaderboardViewController___INIT___]
    GKLeaderboardViewController* objCObj = [[GKLeaderboardViewController alloc ] init];
    org_xmlvm_ios_GKLeaderboardViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKLeaderboardViewController___INIT____org_xmlvm_ios_UIViewController]

    GKLeaderboardViewController* objCObj = [[GKLeaderboardViewController alloc] initWithRootViewController:(UIViewController*) (((org_xmlvm_ios_UIViewController*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_GKLeaderboardViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    GKLeaderboardViewController* objCObj = [[GKLeaderboardViewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
