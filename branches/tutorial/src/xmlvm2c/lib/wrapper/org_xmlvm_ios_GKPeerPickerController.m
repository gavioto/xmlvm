...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKPeerPickerController___INIT___]
    GKPeerPickerController* objCObj = [[GKPeerPickerController alloc ] init];
    org_xmlvm_ios_GKPeerPickerController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKPeerPickerController_getConnectionTypesMask__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz connectionTypesMask];
    return objCObj;
//XMLVM_END_WRAPPER
