...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDINetworkHost___INIT___]
    MIDINetworkHost* objCObj = [[MIDINetworkHost alloc ] init];
    org_xmlvm_ios_MIDINetworkHost_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [MIDINetworkHost  hostWithName:ObjCVar1 address:ObjCVar2 port:n3];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [MIDINetworkHost  hostWithName:ObjCVar1 netService:(NSNetService*) (((org_xmlvm_ios_NSNetService*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [MIDINetworkHost  hostWithName:ObjCVar1 netServiceName:ObjCVar2 netServiceDomain:ObjCVar3];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDINetworkHost_hasSameAddressAs___org_xmlvm_ios_MIDINetworkHost]
    ...
    BOOL objCObj = [thiz  hasSameAddressAs:(MIDINetworkHost*) (((org_xmlvm_ios_MIDINetworkHost*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDINetworkHost_getNetServiceName__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz netServiceName];
    return fromNSString(objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDINetworkHost_getNetServiceDomain__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz netServiceDomain];
    return fromNSString(objCObj);
//XMLVM_END_WRAPPER
