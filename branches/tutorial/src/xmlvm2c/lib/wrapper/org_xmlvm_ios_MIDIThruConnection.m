...
NSString * ObjCVar1 = toNSString(n1);
    ...
    MIDIThruConnection* objCObj = [[MIDIThruConnection alloc] create:ObjCVar1];
    [ObjCVar1 release];

    org_xmlvm_ios_MIDIThruConnection_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDIThruConnection___INIT___]
    MIDIThruConnection* objCObj = [[MIDIThruConnection alloc ] init];
    org_xmlvm_ios_MIDIThruConnection_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
