...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKAnnotationView_getLeftCalloutAccessoryView__]
    ...
    XMLVM_VAR_THIZ;
    UIView* objCObj = [thiz leftCalloutAccessoryView];    if (!__TIB_org_xmlvm_ios_UIView.classInitialized) __INIT_org_xmlvm_ios_UIView();
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKAnnotationView_getRightCalloutAccessoryView__]
    ...
    XMLVM_VAR_THIZ;
    UIView* objCObj = [thiz rightCalloutAccessoryView];    if (!__TIB_org_xmlvm_ios_UIView.classInitialized) __INIT_org_xmlvm_ios_UIView();
