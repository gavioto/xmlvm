...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKPinAnnotationView___INIT___]
    MKPinAnnotationView* objCObj = [[MKPinAnnotationView alloc ] init];
    org_xmlvm_ios_MKPinAnnotationView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKPinAnnotationView___INIT____org_xmlvm_ios_CGRect]
    ...
    MKPinAnnotationView* objCObj = [[MKPinAnnotationView alloc] initWithFrame:toCGRect(n1)];
    org_xmlvm_ios_MKPinAnnotationView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKPinAnnotationView_getAnimatesDrop__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz animatesDrop];
    return objCObj;
//XMLVM_END_WRAPPER
