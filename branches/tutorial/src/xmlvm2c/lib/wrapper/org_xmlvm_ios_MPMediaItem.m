...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaItem___INIT___]
    MPMediaItem* objCObj = [[MPMediaItem alloc ] init];
    org_xmlvm_ios_MPMediaItem_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaItem_persistentIDPropertyForGroupingType___int]
    ...
    NSString* objCObj =  [MPMediaItem  persistentIDPropertyForGroupingType:n1];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaItem_titlePropertyForGroupingType___int]
    ...
    NSString* objCObj =  [MPMediaItem  titlePropertyForGroupingType:n1];
