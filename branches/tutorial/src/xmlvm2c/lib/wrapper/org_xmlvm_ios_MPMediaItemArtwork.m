...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaItemArtwork___INIT___]
    MPMediaItemArtwork* objCObj = [[MPMediaItemArtwork alloc ] init];
    org_xmlvm_ios_MPMediaItemArtwork_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaItemArtwork_imageWithSize___org_xmlvm_ios_CGSize]
    ...
    UIImage* objCObj = [thiz  imageWithSize:toCGSize(n1)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaItemArtwork_getImageCropRect__]
    ...
    XMLVM_VAR_THIZ;
    CGRect objCObj = [thiz imageCropRect];
    return fromCGRect(objCObj);
//XMLVM_END_WRAPPER
