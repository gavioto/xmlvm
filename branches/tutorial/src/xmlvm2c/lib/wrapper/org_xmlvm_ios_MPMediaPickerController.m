...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaPickerController___INIT___]
    ...
    MPMediaPickerController* objCObj = [[MPMediaPickerController alloc]init];

    org_xmlvm_ios_MPMediaPickerController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaPickerController___INIT____int]

    MPMediaPickerController* objCObj = [[MPMediaPickerController alloc] initWithMediaTypes:n1];
    org_xmlvm_ios_MPMediaPickerController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    MPMediaPickerController* objCObj = [[MPMediaPickerController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaPickerController_getAllowsPickingMultipleItems__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz allowsPickingMultipleItems];
    return objCObj;
//XMLVM_END_WRAPPER
