...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaPlaylist___INIT___]
    MPMediaPlaylist* objCObj = [[MPMediaPlaylist alloc ] init];
    org_xmlvm_ios_MPMediaPlaylist_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaPlaylist___INIT____java_util_List]
NSArray * ObjCVar1 = toNSArray(n1);
    
    MPMediaPlaylist* objCObj = [[MPMediaPlaylist alloc] initWithItems:ObjCVar1];
    [ObjCVar1 release];
