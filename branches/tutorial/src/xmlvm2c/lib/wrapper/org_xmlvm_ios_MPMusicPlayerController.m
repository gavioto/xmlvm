...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMusicPlayerController___INIT___]
    MPMusicPlayerController* objCObj = [[MPMusicPlayerController alloc ] init];
    org_xmlvm_ios_MPMusicPlayerController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
