...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSAssertionHandler___INIT___]
    NSAssertionHandler* objCObj = [[NSAssertionHandler alloc ] init];
    org_xmlvm_ios_NSAssertionHandler_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSAssertionHandler_currentHandler__]
    ...
    NSAssertionHandler* objCObj =  [NSAssertionHandler currentHandler];
    if (!__TIB_org_xmlvm_ios_NSAssertionHandler.classInitialized) __INIT_org_xmlvm_ios_NSAssertionHandler();
