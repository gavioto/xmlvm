...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSCondition___INIT___]
    NSCondition* objCObj = [[NSCondition alloc ] init];
    org_xmlvm_ios_NSCondition_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSCondition_waitUntilDate___org_xmlvm_ios_NSDate]
    ...
    BOOL objCObj = [thiz  waitUntilDate:(NSDate*) (((org_xmlvm_ios_NSDate*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
