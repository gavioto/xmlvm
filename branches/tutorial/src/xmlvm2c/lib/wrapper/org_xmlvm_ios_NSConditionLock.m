...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSConditionLock___INIT____int]
    ...
    NSConditionLock* objCObj = [[NSConditionLock alloc] initWithCondition:n1];
    org_xmlvm_ios_NSConditionLock_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSConditionLock___INIT___]
    NSConditionLock* objCObj = [[NSConditionLock alloc ] init];
    org_xmlvm_ios_NSConditionLock_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSConditionLock_tryLockWhenCondition___int]
    ...
    BOOL objCObj = [thiz  tryLockWhenCondition:n1];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSConditionLock_lockBeforeDate___org_xmlvm_ios_NSDate]
    ...
    BOOL objCObj = [thiz  lockBeforeDate:(NSDate*) (((org_xmlvm_ios_NSDate*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSConditionLock_lockWhenCondition___int_org_xmlvm_ios_NSDate]
    ...
    BOOL objCObj = [thiz  lockWhenCondition:n1 beforeDate:(NSDate*) (((org_xmlvm_ios_NSDate*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
