...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSException___INIT___]
    NSException* objCObj = [[NSException alloc ] init];
    org_xmlvm_ios_NSException_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSException_callStackReturnAddresses__]
    ...
    NSArray* objCObj = [thiz callStackReturnAddresses];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSException_callStackSymbols__]
    ...
    NSArray* objCObj = [thiz callStackSymbols];
