...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSFetchedPropertyDescription___INIT___]
    NSFetchedPropertyDescription* objCObj = [[NSFetchedPropertyDescription alloc ] init];
    org_xmlvm_ios_NSFetchedPropertyDescription_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
