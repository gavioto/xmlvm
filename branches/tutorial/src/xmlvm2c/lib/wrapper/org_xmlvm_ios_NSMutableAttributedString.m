...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableAttributedString___INIT___]
    NSMutableAttributedString* objCObj = [[NSMutableAttributedString alloc ] init];
    org_xmlvm_ios_NSMutableAttributedString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableAttributedString___INIT____java_lang_String]
NSString * ObjCVar1 = toNSString(n1);
    
    NSMutableAttributedString* objCObj = [[NSMutableAttributedString alloc] initWithString:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableAttributedString___INIT____org_xmlvm_ios_NSAttributedString]
    ...
    NSMutableAttributedString* objCObj = [[NSMutableAttributedString alloc] initWithAttributedString:(NSAttributedString*) (((org_xmlvm_ios_NSAttributedString*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMutableAttributedString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
