...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableData___INIT____int_org_xmlvm_ios_NSMutableData_Data]
    ...
    {
    NSMutableData* objCObj = [[NSMutableData alloc] initWithLength:n1];
    ...
    {
    NSMutableData* objCObj = [[NSMutableData alloc] initWithCapacity:n1];
    org_xmlvm_ios_NSMutableData_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableData___INIT___]
    NSMutableData* objCObj = [[NSMutableData alloc ] init];
    org_xmlvm_ios_NSMutableData_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableData___INIT____byte_1ARRAY_int_org_xmlvm_ios_NSMutableData_Data]
    ...
    NSMutableData* objCObj = [[NSMutableData alloc] initWithBytesNoCopy:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2];
    org_xmlvm_ios_NSMutableData_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
    ...
    NSMutableData* objCObj = [[NSMutableData alloc] initWithBytes:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2];
    org_xmlvm_ios_NSMutableData_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
//XMLVM_END_WRAPPER
...
XMLVM_VAR_BYTE_ARRAY(a1, n1); 
    ...
    NSMutableData* objCObj = [[NSMutableData alloc] initWithBytesNoCopy:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 freeWhenDone:n3];
    org_xmlvm_ios_NSMutableData_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableData___INIT____java_lang_String_org_xmlvm_ios_NSMutableData_File]
    ...
    NSMutableData* objCObj = [[NSMutableData alloc] initWithContentsOfMappedFile:ObjCVar1];
    [ObjCVar1 release];
    ...
    NSMutableData* objCObj = [[NSMutableData alloc] initWithContentsOfFile:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableData___INIT____org_xmlvm_ios_NSURL]
    ...
    NSMutableData* objCObj = [[NSMutableData alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMutableData_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableData___INIT____org_xmlvm_ios_NSData]

    NSMutableData* objCObj = [[NSMutableData alloc] initWithData:(NSData*) (((org_xmlvm_ios_NSData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMutableData_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
