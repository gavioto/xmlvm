...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableDictionary___INIT____int]
    ...
    NSMutableDictionary* objCObj = [[NSMutableDictionary alloc] initWithCapacity:n1];
    org_xmlvm_ios_NSMutableDictionary_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableDictionary___INIT___]
    NSMutableDictionary* objCObj = [[NSMutableDictionary alloc ] init];
    org_xmlvm_ios_NSMutableDictionary_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_OBJECT_ARRAY(a1, n1); 
    ...
    NSMutableDictionary* objCObj = [[NSMutableDictionary alloc] initWithObjects:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ forKeys:a2->fields.org_xmlvm_runtime_XMLVMArray.array_ count:n3];
    org_xmlvm_ios_NSMutableDictionary_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSArray * ObjCVar1 = toNSArray(n1);
    ...
    NSMutableDictionary* objCObj = [[NSMutableDictionary alloc] initWithObjects:ObjCVar1 forKeys:ObjCVar2];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSMutableDictionary* objCObj = [[NSMutableDictionary alloc] initWithContentsOfFile:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableDictionary___INIT____org_xmlvm_ios_NSURL]
    ...
    NSMutableDictionary* objCObj = [[NSMutableDictionary alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMutableDictionary_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
