...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableSet___INIT____int]
    ...
    NSMutableSet* objCObj = [[NSMutableSet alloc] initWithCapacity:n1];
    org_xmlvm_ios_NSMutableSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableSet___INIT___]
    NSMutableSet* objCObj = [[NSMutableSet alloc ] init];
    org_xmlvm_ios_NSMutableSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_OBJECT_ARRAY(a1, n1); 
    ...
    NSMutableSet* objCObj = [[NSMutableSet alloc] initWithObjects:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ count:n2];
    org_xmlvm_ios_NSMutableSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSSet * ObjCVar1 = toNSSet(n1);
    ...
    NSMutableSet* objCObj = [[NSMutableSet alloc] initWithSet:ObjCVar1];
    [ObjCVar1 release];
...
NSSet * ObjCVar1 = toNSSet(n1);
    ...
    NSMutableSet* objCObj = [[NSMutableSet alloc] initWithSet:ObjCVar1 copyItems:n2];
    [ObjCVar1 release];
...
NSArray * ObjCVar1 = toNSArray(n1);
    ...
    NSMutableSet* objCObj = [[NSMutableSet alloc] initWithArray:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableSet_setWithCapacity___int]
    ...
    NSSet* objCObj =  [NSMutableSet  setWithCapacity:n1];
