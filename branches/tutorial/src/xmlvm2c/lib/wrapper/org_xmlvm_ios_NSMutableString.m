...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString___INIT____int]
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithCapacity:n1];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString___INIT___]
    NSMutableString* objCObj = [[NSMutableString alloc ] init];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_SHORT_ARRAY(a1, n1); 
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithCharactersNoCopy:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 freeWhenDone:n3];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_SHORT_ARRAY(a1, n1); 
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithCharacters:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString___INIT____byte_1ARRAY_org_xmlvm_ios_NSMutableString_CStringNullTerminated]
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithCString:a1->fields.org_xmlvm_runtime_XMLVMArray.array_];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithUTF8String:a1->fields.org_xmlvm_runtime_XMLVMArray.array_];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString___INIT____java_lang_String_org_xmlvm_ios_NSMutableString_Type]
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithString:ObjCVar1];
    [ObjCVar1 release];
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithContentsOfFile:ObjCVar1];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithFormat:ObjCVar1 arguments:a2->fields.org_xmlvm_runtime_XMLVMArray.array_];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithFormat:ObjCVar1 locale:((org_xmlvm_ios_NSObject*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj arguments:a3->fields.org_xmlvm_runtime_XMLVMArray.array_];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString___INIT____org_xmlvm_ios_NSData_int]
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithData:(NSData*) (((org_xmlvm_ios_NSData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) encoding:n2];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_BYTE_ARRAY(a1, n1); 
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithBytes:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 encoding:n3];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_BYTE_ARRAY(a1, n1); 
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithBytesNoCopy:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 encoding:n3 freeWhenDone:n4];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString___INIT____byte_1ARRAY_int_org_xmlvm_ios_NSMutableString_CString]
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithCString:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithCString:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ encoding:n2];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
//XMLVM_END_WRAPPER
...
JAVA_OBJECT jObject3 = org_xmlvm_ios_Reference_get__(n3);
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) encoding:n2 error:&var3];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithContentsOfFile:ObjCVar1 encoding:n2 error:&var3];
    [ObjCVar1 release];
...
XMLVM_VAR_INT_ARRAY(a2, n2); 
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) usedEncoding:a2->fields.org_xmlvm_runtime_XMLVMArray.array_ error:&var3];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithContentsOfFile:ObjCVar1 usedEncoding:a2->fields.org_xmlvm_runtime_XMLVMArray.array_ error:&var3];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString___INIT____org_xmlvm_ios_NSURL]
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_BYTE_ARRAY(a1, n1); 
    ...
    NSMutableString* objCObj = [[NSMutableString alloc] initWithCStringNoCopy:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 freeWhenDone:n3];
    org_xmlvm_ios_NSMutableString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString_stringWithCapacity___int]
    ...
    NSMutableString* objCObj =  [NSMutableString  stringWithCapacity:n1];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableString_replaceOccurrencesOfString___java_lang_String_java_lang_String_int_org_xmlvm_ios_NSRange]
    ...
    int objCObj = [thiz  replaceOccurrencesOfString:ObjCVar1 withString:ObjCVar2 options:n3 range:toNSRange(n4)];
    [ObjCVar1 release];
