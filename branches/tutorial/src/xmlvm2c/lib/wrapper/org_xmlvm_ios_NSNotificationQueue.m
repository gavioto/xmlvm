...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSNotificationQueue___INIT____org_xmlvm_ios_NSNotificationCenter]
    ...
    NSNotificationQueue* objCObj = [[NSNotificationQueue alloc] initWithNotificationCenter:(NSNotificationCenter*) (((org_xmlvm_ios_NSNotificationCenter*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSNotificationQueue_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSNotificationQueue___INIT___]
    NSNotificationQueue* objCObj = [[NSNotificationQueue alloc ] init];
    org_xmlvm_ios_NSNotificationQueue_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSNotificationQueue_defaultQueue__]
    ...
    NSObject* objCObj =  [NSNotificationQueue defaultQueue];
