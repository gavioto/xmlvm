...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSimpleCString___INIT___]
    NSSimpleCString* objCObj = [[NSSimpleCString alloc ] init];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_SHORT_ARRAY(a1, n1); 
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithCharactersNoCopy:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 freeWhenDone:n3];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_SHORT_ARRAY(a1, n1); 
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithCharacters:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSimpleCString___INIT____byte_1ARRAY_org_xmlvm_ios_NSSimpleCString_CStringNullTerminated]
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithCString:a1->fields.org_xmlvm_runtime_XMLVMArray.array_];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithUTF8String:a1->fields.org_xmlvm_runtime_XMLVMArray.array_];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSimpleCString___INIT____java_lang_String_org_xmlvm_ios_NSSimpleCString_Type]
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithString:ObjCVar1];
    [ObjCVar1 release];
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithContentsOfFile:ObjCVar1];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithFormat:ObjCVar1 arguments:a2->fields.org_xmlvm_runtime_XMLVMArray.array_];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithFormat:ObjCVar1 locale:((org_xmlvm_ios_NSObject*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj arguments:a3->fields.org_xmlvm_runtime_XMLVMArray.array_];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSimpleCString___INIT____org_xmlvm_ios_NSData_int]
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithData:(NSData*) (((org_xmlvm_ios_NSData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) encoding:n2];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_BYTE_ARRAY(a1, n1); 
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithBytes:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 encoding:n3];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_BYTE_ARRAY(a1, n1); 
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithBytesNoCopy:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 encoding:n3 freeWhenDone:n4];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSimpleCString___INIT____byte_1ARRAY_int_org_xmlvm_ios_NSSimpleCString_CString]
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithCString:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithCString:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ encoding:n2];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
    }
//XMLVM_END_WRAPPER
...
JAVA_OBJECT jObject3 = org_xmlvm_ios_Reference_get__(n3);
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) encoding:n2 error:&var3];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithContentsOfFile:ObjCVar1 encoding:n2 error:&var3];
    [ObjCVar1 release];
...
XMLVM_VAR_INT_ARRAY(a2, n2); 
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) usedEncoding:a2->fields.org_xmlvm_runtime_XMLVMArray.array_ error:&var3];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithContentsOfFile:ObjCVar1 usedEncoding:a2->fields.org_xmlvm_runtime_XMLVMArray.array_ error:&var3];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSimpleCString___INIT____org_xmlvm_ios_NSURL]
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_BYTE_ARRAY(a1, n1); 
    ...
    NSSimpleCString* objCObj = [[NSSimpleCString alloc] initWithCStringNoCopy:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ length:n2 freeWhenDone:n3];
    org_xmlvm_ios_NSSimpleCString_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
