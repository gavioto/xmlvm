...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_QLPreviewController___INIT___]
    QLPreviewController* objCObj = [[QLPreviewController alloc ] init];
    org_xmlvm_ios_QLPreviewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_QLPreviewController___INIT____java_lang_String_org_xmlvm_ios_NSBundle]
NSString * ObjCVar1 = toNSString(n1);
    
    QLPreviewController* objCObj = [[QLPreviewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_QLPreviewController_getCurrentPreviewItemIndex__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz currentPreviewItemIndex];
    return objCObj;
//XMLVM_END_WRAPPER
