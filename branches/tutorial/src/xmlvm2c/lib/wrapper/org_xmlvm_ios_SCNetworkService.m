...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SCNetworkService___INIT____org_xmlvm_ios_SCPreferences_org_xmlvm_ios_SCNetworkInterface]
    ...
    SCNetworkService* objCObj = [[SCNetworkService alloc] create:(SCPreferences*) (((org_xmlvm_ios_SCPreferences*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_SCNetworkService_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SCNetworkService___INIT___]
    SCNetworkService* objCObj = [[SCNetworkService alloc ] init];
    org_xmlvm_ios_SCNetworkService_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar2 = toNSString(n2);
    ...
    SCNetworkService* objCObj = ABMultiValueCreateMutableCopy((SCPreferences*) (((org_xmlvm_ios_SCPreferences*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj),ObjCVar2);
    
    [ObjCVar2 release];
    if (!__TIB_org_xmlvm_ios_SCNetworkService.classInitialized) __INIT_org_xmlvm_ios_SCNetworkService();
