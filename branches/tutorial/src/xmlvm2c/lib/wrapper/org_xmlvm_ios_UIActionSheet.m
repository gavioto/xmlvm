...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIActionSheet___INIT___]
    UIActionSheet* objCObj = [[UIActionSheet alloc ] init];
    org_xmlvm_ios_UIActionSheet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIActionSheet___INIT____org_xmlvm_ios_CGRect]

    UIActionSheet* objCObj = [[UIActionSheet alloc] initWithFrame:toCGRect(n1)];
    org_xmlvm_ios_UIActionSheet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIActionSheet_getActionSheetStyle__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz actionSheetStyle];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIActionSheet_getDestructiveButtonIndex__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz destructiveButtonIndex];
    return objCObj;
//XMLVM_END_WRAPPER
