...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILongPressGestureRecognizer___INIT___]
    UILongPressGestureRecognizer* objCObj = [[UILongPressGestureRecognizer alloc ] init];
    org_xmlvm_ios_UILongPressGestureRecognizer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILongPressGestureRecognizer_getNumberOfTapsRequired__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz numberOfTapsRequired];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILongPressGestureRecognizer_getNumberOfTouchesRequired__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz numberOfTouchesRequired];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILongPressGestureRecognizer_getMinimumPressDuration__]
    ...
    XMLVM_VAR_THIZ;
    double objCObj = [thiz minimumPressDuration];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILongPressGestureRecognizer_getAllowableMovement__]
    ...
    XMLVM_VAR_THIZ;
    float objCObj = [thiz allowableMovement];
    return objCObj;
//XMLVM_END_WRAPPER
