...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIMenuController___INIT___]
    UIMenuController* objCObj = [[UIMenuController alloc ] init];
    org_xmlvm_ios_UIMenuController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIMenuController_sharedMenuController__]
    ...
    UIMenuController* objCObj =  [UIMenuController sharedMenuController];
    if (!__TIB_org_xmlvm_ios_UIMenuController.classInitialized) __INIT_org_xmlvm_ios_UIMenuController();
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIMenuController_isMenuVisible__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz isMenuVisible];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIMenuController_getArrowDirection__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz arrowDirection];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIMenuController_getMenuItems__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz menuItems];
