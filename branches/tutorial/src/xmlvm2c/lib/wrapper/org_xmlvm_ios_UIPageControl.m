...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPageControl___INIT___]
    UIPageControl* objCObj = [[UIPageControl alloc ] init];
    org_xmlvm_ios_UIPageControl_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPageControl___INIT____org_xmlvm_ios_CGRect]
    ...
    UIPageControl* objCObj = [[UIPageControl alloc] initWithFrame:toCGRect(n1)];
    org_xmlvm_ios_UIPageControl_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPageControl_getNumberOfPages__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz numberOfPages];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPageControl_getHidesForSinglePage__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz hidesForSinglePage];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPageControl_getDefersCurrentPageDisplay__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz defersCurrentPageDisplay];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPageControl_sizeForNumberOfPages___int]
    ...
    CGSize objCObj = [thiz  sizeForNumberOfPages:n1];
