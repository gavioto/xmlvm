...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPopoverController___INIT____org_xmlvm_ios_UIViewController]
    ...
    UIPopoverController* objCObj = [[UIPopoverController alloc] initWithContentViewController:(UIViewController*) (((org_xmlvm_ios_UIViewController*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_UIPopoverController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPopoverController___INIT___]
    UIPopoverController* objCObj = [[UIPopoverController alloc ] init];
    org_xmlvm_ios_UIPopoverController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPopoverController_getPopoverContentSize__]
    ...
    XMLVM_VAR_THIZ;
    CGSize objCObj = [thiz popoverContentSize];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPopoverController_isPopoverVisible__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz isPopoverVisible];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPopoverController_getPopoverArrowDirection__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz popoverArrowDirection];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPopoverController_getPassthroughViews__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz passthroughViews];
