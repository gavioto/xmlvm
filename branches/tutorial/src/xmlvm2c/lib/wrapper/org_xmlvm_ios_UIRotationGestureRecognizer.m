...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIRotationGestureRecognizer___INIT___]
    UIRotationGestureRecognizer* objCObj = [[UIRotationGestureRecognizer alloc ] init];
    org_xmlvm_ios_UIRotationGestureRecognizer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
