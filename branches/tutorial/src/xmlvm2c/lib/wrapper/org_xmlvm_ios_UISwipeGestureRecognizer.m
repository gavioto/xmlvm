...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UISwipeGestureRecognizer___INIT___]
    UISwipeGestureRecognizer* objCObj = [[UISwipeGestureRecognizer alloc ] init];
    org_xmlvm_ios_UISwipeGestureRecognizer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
