...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIVideoEditorController___INIT___]
    UIVideoEditorController* objCObj = [[UIVideoEditorController alloc ] init];
    org_xmlvm_ios_UIVideoEditorController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIVideoEditorController___INIT____org_xmlvm_ios_UIViewController]

    UIVideoEditorController* objCObj = [[UIVideoEditorController alloc] initWithRootViewController:(UIViewController*) (((org_xmlvm_ios_UIViewController*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_UIVideoEditorController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    UIVideoEditorController* objCObj = [[UIVideoEditorController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    BOOL objCObj =  [UIVideoEditorController  canEditVideoAtPath:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIVideoEditorController_getVideoPath__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz videoPath];
