...
void __INIT_IMPL_org_xmlvm_iphone_CALayer()
{
    if (!__TIB_org_xmlvm_iphone_CALayer.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CALayer.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_addAnimation___org_xmlvm_iphone_CAAnimation_java_lang_String;
        __TIB_org_xmlvm_iphone_CALayer.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_animationForKey___java_lang_String;
        __TIB_org_xmlvm_iphone_CALayer.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_removeAllAnimations__;
        __TIB_org_xmlvm_iphone_CALayer.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_removeAnimationForKey___java_lang_String;
        __TIB_org_xmlvm_iphone_CALayer.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_animationKeys__;
        __TIB_org_xmlvm_iphone_CALayer.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_renderInContext___org_xmlvm_iphone_CGContext;
        __TIB_org_xmlvm_iphone_CALayer.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_getDelegate__;
        __TIB_org_xmlvm_iphone_CALayer.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_setDelegate___org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_CALayer.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_getAnchorPoint__;
        __TIB_org_xmlvm_iphone_CALayer.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_CALayer_setAnchorPoint___org_xmlvm_iphone_CGPoint;
