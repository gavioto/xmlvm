...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CATransition);
    if (!__TIB_org_xmlvm_iphone_CATransition.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CATransition();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CATransition);
}

void __INIT_IMPL_org_xmlvm_iphone_CATransition()
{
    if (!__TIB_org_xmlvm_iphone_CATransition.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_CATransition.classInitializationBegan = 1;

        // Initialize base class if necessary
        if (!__TIB_org_xmlvm_iphone_CAAnimation.classInitialized) __INIT_IMPL_org_xmlvm_iphone_CAAnimation();
        ...
        __TIB_org_xmlvm_iphone_CATransition.vtable[29] = (VTABLE_PTR) &org_xmlvm_iphone_CATransition_getEndProgress__;
        __TIB_org_xmlvm_iphone_CATransition.vtable[30] = (VTABLE_PTR) &org_xmlvm_iphone_CATransition_setEndProgress___float;
        __TIB_org_xmlvm_iphone_CATransition.vtable[31] = (VTABLE_PTR) &org_xmlvm_iphone_CATransition_getStartProgress__;
        __TIB_org_xmlvm_iphone_CATransition.vtable[32] = (VTABLE_PTR) &org_xmlvm_iphone_CATransition_setStartProgress___float;
        __TIB_org_xmlvm_iphone_CATransition.vtable[33] = (VTABLE_PTR) &org_xmlvm_iphone_CATransition_getSubtype__;
        __TIB_org_xmlvm_iphone_CATransition.vtable[34] = (VTABLE_PTR) &org_xmlvm_iphone_CATransition_setSubtype___java_lang_String;
        __TIB_org_xmlvm_iphone_CATransition.vtable[35] = (VTABLE_PTR) &org_xmlvm_iphone_CATransition_getType__;
        __TIB_org_xmlvm_iphone_CATransition.vtable[36] = (VTABLE_PTR) &org_xmlvm_iphone_CATransition_setType___java_lang_String;
        ...
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAAction_runAction___java_lang_String_org_xmlvm_iphone_NSObject_java_util_Map] = __TIB_org_xmlvm_iphone_CATransition.vtable[15];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_isAutoreverses__] = __TIB_org_xmlvm_iphone_CATransition.vtable[28];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_setAutoreverses___boolean] = __TIB_org_xmlvm_iphone_CATransition.vtable[20];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_getBeginTime__] = __TIB_org_xmlvm_iphone_CATransition.vtable[12];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_setBeginTime___double] = __TIB_org_xmlvm_iphone_CATransition.vtable[17];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_getDuration__] = __TIB_org_xmlvm_iphone_CATransition.vtable[25];
        ...
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_getFillMode__] = __TIB_org_xmlvm_iphone_CATransition.vtable[18];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_setFillMode___java_lang_String] = __TIB_org_xmlvm_iphone_CATransition.vtable[23];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_getRepeatCount__] = __TIB_org_xmlvm_iphone_CATransition.vtable[26];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_setRepeatCount___float] = __TIB_org_xmlvm_iphone_CATransition.vtable[19];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_getRepeatDuration__] = __TIB_org_xmlvm_iphone_CATransition.vtable[27];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_setRepeatDuration___double] = __TIB_org_xmlvm_iphone_CATransition.vtable[21];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_getSpeed__] = __TIB_org_xmlvm_iphone_CATransition.vtable[22];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_setSpeed___float] = __TIB_org_xmlvm_iphone_CATransition.vtable[14];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_getTimeOffset__] = __TIB_org_xmlvm_iphone_CATransition.vtable[13];
        __TIB_org_xmlvm_iphone_CATransition.itable[XMLVM_ITABLE_IDX_org_xmlvm_iphone_CAMediaTiming_setTimeOffset___double] = __TIB_org_xmlvm_iphone_CATransition.vtable[24];

        _STATIC_org_xmlvm_iphone_CATransition_Fade = (java_lang_String*) xmlvm_create_java_string("fade");
        _STATIC_org_xmlvm_iphone_CATransition_MoveIn = (java_lang_String*) xmlvm_create_java_string("moveIn");
        _STATIC_org_xmlvm_iphone_CATransition_Push = (java_lang_String*) xmlvm_create_java_string("push");
        _STATIC_org_xmlvm_iphone_CATransition_Reveal = (java_lang_String*) xmlvm_create_java_string("reveal");
        _STATIC_org_xmlvm_iphone_CATransition_FromRight = (java_lang_String*) xmlvm_create_java_string("fromRight");
        _STATIC_org_xmlvm_iphone_CATransition_FromLeft = (java_lang_String*) xmlvm_create_java_string("fromLeft");
        _STATIC_org_xmlvm_iphone_CATransition_FromTop = (java_lang_String*) xmlvm_create_java_string("fromTop");
        _STATIC_org_xmlvm_iphone_CATransition_FromBottom = (java_lang_String*) xmlvm_create_java_string("fromBottom");
        ...
        __CLASS_org_xmlvm_iphone_CATransition_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CATransition, 3);
        __CLASS_org_xmlvm_iphone_CATransition_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CATransition, 2);
        __CLASS_org_xmlvm_iphone_CATransition_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CATransition, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_CATransition()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CATransition(me);
