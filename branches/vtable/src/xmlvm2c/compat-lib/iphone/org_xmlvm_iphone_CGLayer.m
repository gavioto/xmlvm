...
void __INIT_IMPL_org_xmlvm_iphone_CGLayer()
{
    if (!__TIB_org_xmlvm_iphone_CGLayer.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CGLayer.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_CGLayer_getContext__;
        __TIB_org_xmlvm_iphone_CGLayer.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_CGLayer_getSize__;
