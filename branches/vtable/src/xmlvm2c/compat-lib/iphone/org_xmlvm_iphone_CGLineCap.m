...
void __INIT_IMPL_org_xmlvm_iphone_CGLineCap()
{
    if (!__TIB_org_xmlvm_iphone_CGLineCap.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_CGLineCap_kCGLineCapButt = 0;
        ...
        __CLASS_org_xmlvm_iphone_CGLineCap_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGLineCap, 3);
        __CLASS_org_xmlvm_iphone_CGLineCap_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGLineCap, 2);
        __CLASS_org_xmlvm_iphone_CGLineCap_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGLineCap, 1);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CGLineCap(JAVA_OBJECT me)
{
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_CGLineCap()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CGLineCap(me);
