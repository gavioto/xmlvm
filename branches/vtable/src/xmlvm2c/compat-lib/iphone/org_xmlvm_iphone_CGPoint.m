...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CGPoint);
    if (!__TIB_org_xmlvm_iphone_CGPoint.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CGPoint();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CGPoint);
}

void __INIT_IMPL_org_xmlvm_iphone_CGPoint()
{
    if (!__TIB_org_xmlvm_iphone_CGPoint.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_CGPoint_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGPoint, 3);
        __CLASS_org_xmlvm_iphone_CGPoint_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGPoint, 2);
        __CLASS_org_xmlvm_iphone_CGPoint_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGPoint, 1);
