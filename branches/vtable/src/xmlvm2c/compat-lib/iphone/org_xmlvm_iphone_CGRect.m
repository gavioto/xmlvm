...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CGRect);
    if (!__TIB_org_xmlvm_iphone_CGRect.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CGRect();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CGRect);
}

void __INIT_IMPL_org_xmlvm_iphone_CGRect()
{
    if (!__TIB_org_xmlvm_iphone_CGRect.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CGRect.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_CGRect_isNull__;
        __TIB_org_xmlvm_iphone_CGRect.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_CGRect_isEmpty__;
        __TIB_org_xmlvm_iphone_CGRect.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_CGRect_isInfinite__;
        __TIB_org_xmlvm_iphone_CGRect.vtable[2] = (VTABLE_PTR) &org_xmlvm_iphone_CGRect_toString__;
        __TIB_org_xmlvm_iphone_CGRect.vtable[0] = (VTABLE_PTR) &org_xmlvm_iphone_CGRect_equals___java_lang_Object;
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_CGRect()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CGRect(me);
