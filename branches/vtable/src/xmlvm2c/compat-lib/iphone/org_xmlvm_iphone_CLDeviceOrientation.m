...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CLDeviceOrientation);
    if (!__TIB_org_xmlvm_iphone_CLDeviceOrientation.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CLDeviceOrientation();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CLDeviceOrientation);
}

void __INIT_IMPL_org_xmlvm_iphone_CLDeviceOrientation()
{
    if (!__TIB_org_xmlvm_iphone_CLDeviceOrientation.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_CLDeviceOrientation_Unknown = 0;
        ...
        __CLASS_org_xmlvm_iphone_CLDeviceOrientation_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLDeviceOrientation, 3);
        __CLASS_org_xmlvm_iphone_CLDeviceOrientation_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLDeviceOrientation, 2);
        __CLASS_org_xmlvm_iphone_CLDeviceOrientation_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLDeviceOrientation, 1);
