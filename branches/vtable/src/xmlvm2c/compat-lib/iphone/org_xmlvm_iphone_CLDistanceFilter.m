...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CLDistanceFilter);
    if (!__TIB_org_xmlvm_iphone_CLDistanceFilter.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CLDistanceFilter();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CLDistanceFilter);
}

void __INIT_IMPL_org_xmlvm_iphone_CLDistanceFilter()
{
    if (!__TIB_org_xmlvm_iphone_CLDistanceFilter.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_CLDistanceFilter_None = -1.0;
        ...
        __CLASS_org_xmlvm_iphone_CLDistanceFilter_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLDistanceFilter, 3);
        __CLASS_org_xmlvm_iphone_CLDistanceFilter_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLDistanceFilter, 2);
        __CLASS_org_xmlvm_iphone_CLDistanceFilter_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLDistanceFilter, 1);
