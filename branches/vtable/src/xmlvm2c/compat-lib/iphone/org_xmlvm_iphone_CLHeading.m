...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CLHeading);
    if (!__TIB_org_xmlvm_iphone_CLHeading.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CLHeading();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CLHeading);
}

void __INIT_IMPL_org_xmlvm_iphone_CLHeading()
{
    if (!__TIB_org_xmlvm_iphone_CLHeading.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CLHeading.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_getHeadingAccuracy__;
        __TIB_org_xmlvm_iphone_CLHeading.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_getMagneticHeading__;
        __TIB_org_xmlvm_iphone_CLHeading.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_getTimestamp__;
        __TIB_org_xmlvm_iphone_CLHeading.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_getTrueHeading__;
        __TIB_org_xmlvm_iphone_CLHeading.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_getX__;
        __TIB_org_xmlvm_iphone_CLHeading.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_getY__;
        __TIB_org_xmlvm_iphone_CLHeading.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_getZ__;
        __TIB_org_xmlvm_iphone_CLHeading.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_description__;
        __TIB_org_xmlvm_iphone_CLHeading.vtable[2] = (VTABLE_PTR) &org_xmlvm_iphone_CLHeading_toString__;
        ...
        __CLASS_org_xmlvm_iphone_CLHeading_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLHeading, 3);
        __CLASS_org_xmlvm_iphone_CLHeading_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLHeading, 2);
        __CLASS_org_xmlvm_iphone_CLHeading_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLHeading, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_CLHeading()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CLHeading(me);
