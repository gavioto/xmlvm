...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CLLocation);
    if (!__TIB_org_xmlvm_iphone_CLLocation.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CLLocation();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CLLocation);
}

void __INIT_IMPL_org_xmlvm_iphone_CLLocation()
{
    if (!__TIB_org_xmlvm_iphone_CLLocation.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CLLocation.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocation_getAltitude__;
        __TIB_org_xmlvm_iphone_CLLocation.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocation_getCoordinate__;
        __TIB_org_xmlvm_iphone_CLLocation.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocation_getCourse__;
        __TIB_org_xmlvm_iphone_CLLocation.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocation_getHorizontalAccuracy__;
        __TIB_org_xmlvm_iphone_CLLocation.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocation_getSpeed__;
        __TIB_org_xmlvm_iphone_CLLocation.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocation_getTimestamp__;
        __TIB_org_xmlvm_iphone_CLLocation.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocation_getVerticalAccuracy__;
        __TIB_org_xmlvm_iphone_CLLocation.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocation_distanceFromLocation___org_xmlvm_iphone_CLLocation;
        ...
        __CLASS_org_xmlvm_iphone_CLLocation_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocation, 3);
        __CLASS_org_xmlvm_iphone_CLLocation_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocation, 2);
        __CLASS_org_xmlvm_iphone_CLLocation_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocation, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_CLLocation()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CLLocation(me);
