...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CLLocationCoordinate2D);
    if (!__TIB_org_xmlvm_iphone_CLLocationCoordinate2D.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CLLocationCoordinate2D();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CLLocationCoordinate2D);
}

void __INIT_IMPL_org_xmlvm_iphone_CLLocationCoordinate2D()
{
    if (!__TIB_org_xmlvm_iphone_CLLocationCoordinate2D.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_CLLocationCoordinate2D_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocationCoordinate2D, 3);
        __CLASS_org_xmlvm_iphone_CLLocationCoordinate2D_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocationCoordinate2D, 2);
        __CLASS_org_xmlvm_iphone_CLLocationCoordinate2D_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocationCoordinate2D, 1);
