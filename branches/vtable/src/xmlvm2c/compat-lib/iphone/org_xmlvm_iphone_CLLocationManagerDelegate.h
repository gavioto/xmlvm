...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_CLLocationManagerDelegate, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_CLLocationManagerDelegate)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_CLLocationManagerDelegate 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLLocationManagerDelegate_didUpdateToLocation___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLLocation_org_xmlvm_iphone_CLLocation 3
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLLocationManagerDelegate_didFailWithError___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_NSError 4
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLLocationManagerDelegate_didUpdateHeading___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLHeading 5
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLLocationManagerDelegate_locationManagerShouldDisplayHeadingCalibration___org_xmlvm_iphone_CLLocationManager 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLLocationManagerDelegate_didEnterRegion___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLRegion 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLLocationManagerDelegate_didExitRegion___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLRegion 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLLocationManagerDelegate_monitoringDidFailForRegion___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLRegion_org_xmlvm_iphone_NSError 9
