...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CLRegion);
    if (!__TIB_org_xmlvm_iphone_CLRegion.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CLRegion();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CLRegion);
}

void __INIT_IMPL_org_xmlvm_iphone_CLRegion()
{
    if (!__TIB_org_xmlvm_iphone_CLRegion.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CLRegion.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_CLRegion_getCenter__;
        __TIB_org_xmlvm_iphone_CLRegion.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_CLRegion_getIdentifier__;
        __TIB_org_xmlvm_iphone_CLRegion.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_CLRegion_getRadius__;
        __TIB_org_xmlvm_iphone_CLRegion.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_CLRegion_containsCoordinate___org_xmlvm_iphone_CLLocationCoordinate2D;
        ...
        __CLASS_org_xmlvm_iphone_CLRegion_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLRegion, 3);
        __CLASS_org_xmlvm_iphone_CLRegion_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLRegion, 2);
        __CLASS_org_xmlvm_iphone_CLRegion_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLRegion, 1);
