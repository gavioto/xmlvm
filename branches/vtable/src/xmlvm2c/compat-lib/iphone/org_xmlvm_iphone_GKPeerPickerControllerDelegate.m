...
void __INIT_IMPL_org_xmlvm_iphone_GKPeerPickerControllerDelegate()
{
    if (!__TIB_org_xmlvm_iphone_GKPeerPickerControllerDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_GKPeerPickerControllerDelegate.vtable[3] = (VTABLE_PTR) &org_xmlvm_iphone_GKPeerPickerControllerDelegate_didSelectConnectionType___org_xmlvm_iphone_GKPeerPickerController_int;
        __TIB_org_xmlvm_iphone_GKPeerPickerControllerDelegate.vtable[4] = (VTABLE_PTR) &org_xmlvm_iphone_GKPeerPickerControllerDelegate_sessionForConnectionType___org_xmlvm_iphone_GKPeerPickerController_int;
        __TIB_org_xmlvm_iphone_GKPeerPickerControllerDelegate.vtable[5] = (VTABLE_PTR) &org_xmlvm_iphone_GKPeerPickerControllerDelegate_didConnectPeer___org_xmlvm_iphone_GKPeerPickerController_java_lang_String_org_xmlvm_iphone_GKSession;
        __TIB_org_xmlvm_iphone_GKPeerPickerControllerDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_GKPeerPickerControllerDelegate_didCancel___org_xmlvm_iphone_GKPeerPickerController;
