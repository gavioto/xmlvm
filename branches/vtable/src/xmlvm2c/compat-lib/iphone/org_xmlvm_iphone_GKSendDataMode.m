...
void __INIT_IMPL_org_xmlvm_iphone_GKSendDataMode()
{
    if (!__TIB_org_xmlvm_iphone_GKSendDataMode.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_GKSendDataMode_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKSendDataMode, 3);
        __CLASS_org_xmlvm_iphone_GKSendDataMode_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKSendDataMode, 2);
        __CLASS_org_xmlvm_iphone_GKSendDataMode_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKSendDataMode, 1);
