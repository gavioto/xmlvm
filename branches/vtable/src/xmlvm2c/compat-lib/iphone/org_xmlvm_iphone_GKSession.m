...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_GKSession);
    if (!__TIB_org_xmlvm_iphone_GKSession.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_GKSession();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_GKSession);
}

void __INIT_IMPL_org_xmlvm_iphone_GKSession()
{
    if (!__TIB_org_xmlvm_iphone_GKSession.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_GKSession.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_getDelegate__;
        __TIB_org_xmlvm_iphone_GKSession.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_setDelegate___org_xmlvm_iphone_GKSessionDelegate;
        __TIB_org_xmlvm_iphone_GKSession.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_isAvailable__;
        __TIB_org_xmlvm_iphone_GKSession.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_setAvailable___boolean;
        __TIB_org_xmlvm_iphone_GKSession.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_getDisconnectTimeout__;
        __TIB_org_xmlvm_iphone_GKSession.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_setDisconnectTimeout___double;
        __TIB_org_xmlvm_iphone_GKSession.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_getDisplayName__;
        __TIB_org_xmlvm_iphone_GKSession.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_getPeerID__;
        __TIB_org_xmlvm_iphone_GKSession.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_getSessionID__;
        __TIB_org_xmlvm_iphone_GKSession.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_getSessionMode__;
        __TIB_org_xmlvm_iphone_GKSession.vtable[16] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_peersWithConnectionState___int;
        __TIB_org_xmlvm_iphone_GKSession.vtable[17] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_displayNameForPeer___java_lang_String;
        __TIB_org_xmlvm_iphone_GKSession.vtable[18] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_connectToPeer___java_lang_String_double;
        __TIB_org_xmlvm_iphone_GKSession.vtable[19] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_cancelConnectToPeer___java_lang_String;
        __TIB_org_xmlvm_iphone_GKSession.vtable[20] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_acceptConnectionFromPeer___java_lang_String_org_xmlvm_iphone_NSErrorHolder;
        __TIB_org_xmlvm_iphone_GKSession.vtable[21] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_denyConnectionFromPeer___java_lang_String;
        __TIB_org_xmlvm_iphone_GKSession.vtable[22] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_setDataReceiveHandler___org_xmlvm_iphone_GKDataReceiveHandler_java_lang_Object;
        __TIB_org_xmlvm_iphone_GKSession.vtable[23] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_sendData___org_xmlvm_iphone_NSData_java_util_ArrayList_int_org_xmlvm_iphone_NSErrorHolder;
        __TIB_org_xmlvm_iphone_GKSession.vtable[24] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_sendDataToAllPeers___org_xmlvm_iphone_NSData_int_org_xmlvm_iphone_NSErrorHolder;
        __TIB_org_xmlvm_iphone_GKSession.vtable[25] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_disconnectFromAllPeers__;
        __TIB_org_xmlvm_iphone_GKSession.vtable[26] = (VTABLE_PTR) &org_xmlvm_iphone_GKSession_disconnectPeerFromAllPeers___java_lang_String;
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_GKSession(JAVA_OBJECT me)
{
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_GKSession()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_GKSession(me);
