...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_MFMailComposeResult);
    if (!__TIB_org_xmlvm_iphone_MFMailComposeResult.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_MFMailComposeResult();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_MFMailComposeResult);
}

void __INIT_IMPL_org_xmlvm_iphone_MFMailComposeResult()
{
    if (!__TIB_org_xmlvm_iphone_MFMailComposeResult.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_MFMailComposeResult_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeResult, 3);
        __CLASS_org_xmlvm_iphone_MFMailComposeResult_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeResult, 2);
        __CLASS_org_xmlvm_iphone_MFMailComposeResult_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeResult, 1);
