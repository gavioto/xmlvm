...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_MFMessageComposeViewControllerDelegate, 4, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_MFMessageComposeViewControllerDelegate)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_MFMessageComposeViewControllerDelegate 4
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_MFMessageComposeViewControllerDelegate_didFinishWithResult___org_xmlvm_iphone_MFMessageComposeViewController_int 3
