...
void __INIT_IMPL_org_xmlvm_iphone_MKMapPoint()
{
    if (!__TIB_org_xmlvm_iphone_MKMapPoint.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_MKMapPoint_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKMapPoint, 3);
        __CLASS_org_xmlvm_iphone_MKMapPoint_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKMapPoint, 2);
        __CLASS_org_xmlvm_iphone_MKMapPoint_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKMapPoint, 1);
