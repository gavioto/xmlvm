...
void __INIT_IMPL_org_xmlvm_iphone_MKOverlayView()
{
    if (!__TIB_org_xmlvm_iphone_MKOverlayView.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_getOverlay__;
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_pointForMapPoint___org_xmlvm_iphone_MKMapPoint;
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_mapPointForPoint___org_xmlvm_iphone_CGPoint;
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_rectForMapRect___org_xmlvm_iphone_MKMapRect;
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_mapRectForRect___org_xmlvm_iphone_CGRect;
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_canDrawMapRect___org_xmlvm_iphone_MKMapRect_float;
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_drawMapRect___org_xmlvm_iphone_MKMapRect_float_org_xmlvm_iphone_CGContext;
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_setNeedsDisplayInMapRect___org_xmlvm_iphone_MKMapRect;
        __TIB_org_xmlvm_iphone_MKOverlayView.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_MKOverlayView_setNeedsDisplayInMapRect___org_xmlvm_iphone_MKMapRect_float;
        ...
        __CLASS_org_xmlvm_iphone_MKOverlayView_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKOverlayView, 3);
        __CLASS_org_xmlvm_iphone_MKOverlayView_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKOverlayView, 2);
        __CLASS_org_xmlvm_iphone_MKOverlayView_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKOverlayView, 1);
