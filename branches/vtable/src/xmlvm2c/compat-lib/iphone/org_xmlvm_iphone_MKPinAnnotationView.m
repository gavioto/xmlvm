...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_MKPinAnnotationView);
    if (!__TIB_org_xmlvm_iphone_MKPinAnnotationView.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_MKPinAnnotationView();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_MKPinAnnotationView);
}

void __INIT_IMPL_org_xmlvm_iphone_MKPinAnnotationView()
{
    if (!__TIB_org_xmlvm_iphone_MKPinAnnotationView.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_MKPinAnnotationView.classInitializationBegan = 1;

        // Initialize base class if necessary
        if (!__TIB_org_xmlvm_iphone_MKAnnotationView.classInitialized) __INIT_IMPL_org_xmlvm_iphone_MKAnnotationView();
        ...
        __TIB_org_xmlvm_iphone_MKPinAnnotationView.vtable[90] = (VTABLE_PTR) &org_xmlvm_iphone_MKPinAnnotationView_isAnimatesDrop__;
        __TIB_org_xmlvm_iphone_MKPinAnnotationView.vtable[91] = (VTABLE_PTR) &org_xmlvm_iphone_MKPinAnnotationView_setAnimatesDrop___boolean;
        __TIB_org_xmlvm_iphone_MKPinAnnotationView.vtable[92] = (VTABLE_PTR) &org_xmlvm_iphone_MKPinAnnotationView_getPinColor__;
        __TIB_org_xmlvm_iphone_MKPinAnnotationView.vtable[93] = (VTABLE_PTR) &org_xmlvm_iphone_MKPinAnnotationView_setPinColor___int;
        ...
        __CLASS_org_xmlvm_iphone_MKPinAnnotationView_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKPinAnnotationView, 3);
        __CLASS_org_xmlvm_iphone_MKPinAnnotationView_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKPinAnnotationView, 2);
        __CLASS_org_xmlvm_iphone_MKPinAnnotationView_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKPinAnnotationView, 1);
