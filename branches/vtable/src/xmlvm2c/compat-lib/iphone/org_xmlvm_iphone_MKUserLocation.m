...
void __INIT_IMPL_org_xmlvm_iphone_MKUserLocation()
{
    if (!__TIB_org_xmlvm_iphone_MKUserLocation.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_MKUserLocation.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_MKUserLocation_getLocation__;
        __TIB_org_xmlvm_iphone_MKUserLocation.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_MKUserLocation_isUpdating__;
        __TIB_org_xmlvm_iphone_MKUserLocation.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_MKUserLocation_getSubtitle__;
        __TIB_org_xmlvm_iphone_MKUserLocation.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_MKUserLocation_setSubtitle___java_lang_String;
        __TIB_org_xmlvm_iphone_MKUserLocation.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_MKUserLocation_getTitle__;
        __TIB_org_xmlvm_iphone_MKUserLocation.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_MKUserLocation_setTitle___java_lang_String;
        __TIB_org_xmlvm_iphone_MKUserLocation.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_MKUserLocation_getCoordinate__;
        ...
        __CLASS_org_xmlvm_iphone_MKUserLocation_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKUserLocation, 3);
        __CLASS_org_xmlvm_iphone_MKUserLocation_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKUserLocation, 2);
        __CLASS_org_xmlvm_iphone_MKUserLocation_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKUserLocation, 1);
