...
void __INIT_IMPL_org_xmlvm_iphone_NSBundle()
{
    if (!__TIB_org_xmlvm_iphone_NSBundle.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSBundle.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSBundle_pathForResource___java_lang_String_java_lang_String_java_lang_String;
        __TIB_org_xmlvm_iphone_NSBundle.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSBundle_pathForResource___java_lang_String_java_lang_String;
        __TIB_org_xmlvm_iphone_NSBundle.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSBundle_bundlePath__;
        ...
        __CLASS_org_xmlvm_iphone_NSBundle_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSBundle, 3);
        __CLASS_org_xmlvm_iphone_NSBundle_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSBundle, 2);
        __CLASS_org_xmlvm_iphone_NSBundle_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSBundle, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_NSBundle()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSBundle(me);
