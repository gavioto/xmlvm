...
void __INIT_IMPL_org_xmlvm_iphone_NSData()
{
    if (!__TIB_org_xmlvm_iphone_NSData.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSData.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSData_writeToFile___java_lang_String_boolean;
        __TIB_org_xmlvm_iphone_NSData.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSData_length__;
        __TIB_org_xmlvm_iphone_NSData.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSData_getBytes__;
