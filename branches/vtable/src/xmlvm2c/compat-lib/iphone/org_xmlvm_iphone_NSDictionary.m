...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_NSDictionary);
    if (!__TIB_org_xmlvm_iphone_NSDictionary.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_NSDictionary();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_NSDictionary);
}

void __INIT_IMPL_org_xmlvm_iphone_NSDictionary()
{
    if (!__TIB_org_xmlvm_iphone_NSDictionary.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_NSDictionary_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSDictionary, 3);
        __CLASS_org_xmlvm_iphone_NSDictionary_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSDictionary, 2);
        __CLASS_org_xmlvm_iphone_NSDictionary_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSDictionary, 1);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSDictionary(JAVA_OBJECT me)
{
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_NSDictionary()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSDictionary(me);
