...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSError, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSError)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSError 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSError_domain__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSError_code__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSError_userInfo__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSError_description__ 9
