...
void __INIT_IMPL_org_xmlvm_iphone_NSError()
{
    if (!__TIB_org_xmlvm_iphone_NSError.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSError.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSError_domain__;
        __TIB_org_xmlvm_iphone_NSError.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSError_code__;
        __TIB_org_xmlvm_iphone_NSError.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSError_userInfo__;
        __TIB_org_xmlvm_iphone_NSError.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSError_description__;
        ...
        __CLASS_org_xmlvm_iphone_NSError_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSError, 3);
        __CLASS_org_xmlvm_iphone_NSError_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSError, 2);
        __CLASS_org_xmlvm_iphone_NSError_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSError, 1);
