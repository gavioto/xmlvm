...
void __INIT_IMPL_org_xmlvm_iphone_NSHTTPURLResponse()
{
    if (!__TIB_org_xmlvm_iphone_NSHTTPURLResponse.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_NSHTTPURLResponse_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSHTTPURLResponse, 3);
        __CLASS_org_xmlvm_iphone_NSHTTPURLResponse_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSHTTPURLResponse, 2);
        __CLASS_org_xmlvm_iphone_NSHTTPURLResponse_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSHTTPURLResponse, 1);
