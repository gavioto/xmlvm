...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_NSLocale);
    if (!__TIB_org_xmlvm_iphone_NSLocale.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_NSLocale();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_NSLocale);
}

void __INIT_IMPL_org_xmlvm_iphone_NSLocale()
{
    if (!__TIB_org_xmlvm_iphone_NSLocale.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSLocale.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSLocale_localeIdentifier__;
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_NSLocale()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSLocale(me);
