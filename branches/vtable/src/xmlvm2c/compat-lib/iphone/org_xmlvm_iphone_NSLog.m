...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_NSLog);
    if (!__TIB_org_xmlvm_iphone_NSLog.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_NSLog();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_NSLog);
}

void __INIT_IMPL_org_xmlvm_iphone_NSLog()
{
    if (!__TIB_org_xmlvm_iphone_NSLog.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_NSLog_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSLog, 3);
        __CLASS_org_xmlvm_iphone_NSLog_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSLog, 2);
        __CLASS_org_xmlvm_iphone_NSLog_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSLog, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_NSLog()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSLog(me);
