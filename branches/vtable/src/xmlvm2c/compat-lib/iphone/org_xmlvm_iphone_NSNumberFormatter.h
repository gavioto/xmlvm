...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSNumberFormatter, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSNumberFormatter)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSNumberFormatter 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSNumberFormatter_setNumberStyle___int 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSNumberFormatter_numberStyle__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSNumberFormatter_maximumFractionDigits__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSNumberFormatter_setMaximumFractionDigits___int 9
