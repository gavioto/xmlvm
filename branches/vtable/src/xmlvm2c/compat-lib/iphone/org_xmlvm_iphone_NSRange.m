...
void __INIT_IMPL_org_xmlvm_iphone_NSRange()
{
    if (!__TIB_org_xmlvm_iphone_NSRange.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_NSRange_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSRange, 3);
        __CLASS_org_xmlvm_iphone_NSRange_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSRange, 2);
        __CLASS_org_xmlvm_iphone_NSRange_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSRange, 1);
