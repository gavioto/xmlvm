...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_NSString);
    if (!__TIB_org_xmlvm_iphone_NSString.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_NSString();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_NSString);
}

void __INIT_IMPL_org_xmlvm_iphone_NSString()
{
    if (!__TIB_org_xmlvm_iphone_NSString.classInitializationBegan) {
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_NSString()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSString(me);
