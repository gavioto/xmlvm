...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSStringInputStream, 12, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSStringInputStream)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSStringInputStream 12
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_available__ 3
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_close__ 4
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_mark___int 5
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_markSupported__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_read___byte_1ARRAY_int_int 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_read___byte_1ARRAY 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_reset__ 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_skip___long 11
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSStringInputStream_read__ 7
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSStringInputStream(JAVA_OBJECT me);
