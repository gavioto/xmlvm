...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSURLConnectionDelegate, 9, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSURLConnectionDelegate)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSURLConnectionDelegate 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSURLConnectionDelegate_connectionDidFinishLoading___org_xmlvm_iphone_NSURLConnection 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSURLConnectionDelegate_connectionDidFailWithError___org_xmlvm_iphone_NSURLConnection_org_xmlvm_iphone_NSError 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSURLConnectionDelegate_connectionDidReceiveData___org_xmlvm_iphone_NSURLConnection_org_xmlvm_iphone_NSData 8
