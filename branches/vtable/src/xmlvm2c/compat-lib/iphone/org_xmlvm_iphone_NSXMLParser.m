...
void __INIT_IMPL_org_xmlvm_iphone_NSXMLParser()
{
    if (!__TIB_org_xmlvm_iphone_NSXMLParser.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSXMLParser.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParser_setDelegate___org_xmlvm_iphone_NSXMLParserDelegate;
        __TIB_org_xmlvm_iphone_NSXMLParser.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParser_setShouldProcessNamespaces___boolean;
        __TIB_org_xmlvm_iphone_NSXMLParser.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParser_shouldProcessNamespaces__;
        __TIB_org_xmlvm_iphone_NSXMLParser.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParser_setShouldReportNamespacePrefixes___boolean;
        __TIB_org_xmlvm_iphone_NSXMLParser.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParser_shouldReportNamespacePrefixes__;
        __TIB_org_xmlvm_iphone_NSXMLParser.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParser_parse__;
