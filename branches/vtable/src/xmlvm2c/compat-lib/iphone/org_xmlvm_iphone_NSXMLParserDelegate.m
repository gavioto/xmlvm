...
void __INIT_IMPL_org_xmlvm_iphone_NSXMLParserDelegate()
{
    if (!__TIB_org_xmlvm_iphone_NSXMLParserDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSXMLParserDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParserDelegate_didStartMappingPrefix___org_xmlvm_iphone_NSXMLParser_java_lang_String_java_lang_String;
        __TIB_org_xmlvm_iphone_NSXMLParserDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParserDelegate_didEndMappingPrefix___org_xmlvm_iphone_NSXMLParser_java_lang_String;
        __TIB_org_xmlvm_iphone_NSXMLParserDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParserDelegate_didStartElement___org_xmlvm_iphone_NSXMLParser_java_lang_String_java_lang_String_java_lang_String_java_util_Map;
        __TIB_org_xmlvm_iphone_NSXMLParserDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParserDelegate_didEndElement___org_xmlvm_iphone_NSXMLParser_java_lang_String_java_lang_String_java_lang_String;
        __TIB_org_xmlvm_iphone_NSXMLParserDelegate.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParserDelegate_foundCharacters___org_xmlvm_iphone_NSXMLParser_java_lang_String;
        __TIB_org_xmlvm_iphone_NSXMLParserDelegate.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParserDelegate_foundCDATA___org_xmlvm_iphone_NSXMLParser_org_xmlvm_iphone_NSData;
        __TIB_org_xmlvm_iphone_NSXMLParserDelegate.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_NSXMLParserDelegate_setParser___org_xmlvm_iphone_NSXMLParser;
        ...
        __CLASS_org_xmlvm_iphone_NSXMLParserDelegate_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSXMLParserDelegate, 3);
        __CLASS_org_xmlvm_iphone_NSXMLParserDelegate_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSXMLParserDelegate, 2);
        __CLASS_org_xmlvm_iphone_NSXMLParserDelegate_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSXMLParserDelegate, 1);
