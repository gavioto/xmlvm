...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_SKPayment, 9, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_SKPayment)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_SKPayment 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKPayment_getProductIdentifier__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKPayment_getQuantity__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKPayment_getRequestData__ 8
