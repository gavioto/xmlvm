...
void __INIT_IMPL_org_xmlvm_iphone_SKPayment()
{
    if (!__TIB_org_xmlvm_iphone_SKPayment.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKPayment.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_SKPayment_getProductIdentifier__;
        __TIB_org_xmlvm_iphone_SKPayment.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_SKPayment_getQuantity__;
        __TIB_org_xmlvm_iphone_SKPayment.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_SKPayment_getRequestData__;
