...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_SKPaymentTransactionObserver, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_SKPaymentTransactionObserver)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_SKPaymentTransactionObserver 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKPaymentTransactionObserver_updatedTransactions___org_xmlvm_iphone_SKPaymentQueue_java_util_ArrayList 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKPaymentTransactionObserver_removedTransactions___org_xmlvm_iphone_SKPaymentQueue_java_util_ArrayList 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKPaymentTransactionObserver_restoreCompletedTransactionsFailedWithError___org_xmlvm_iphone_SKPaymentQueue_org_xmlvm_iphone_NSError 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKPaymentTransactionObserver_paymentQueueRestoreCompletedTransactionsFinished___org_xmlvm_iphone_SKPaymentQueue 9
