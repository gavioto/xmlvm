...
void __INIT_IMPL_org_xmlvm_iphone_SKPaymentTransactionObserver()
{
    if (!__TIB_org_xmlvm_iphone_SKPaymentTransactionObserver.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKPaymentTransactionObserver.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransactionObserver_removedTransactions___org_xmlvm_iphone_SKPaymentQueue_java_util_ArrayList;
        __TIB_org_xmlvm_iphone_SKPaymentTransactionObserver.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransactionObserver_restoreCompletedTransactionsFailedWithError___org_xmlvm_iphone_SKPaymentQueue_org_xmlvm_iphone_NSError;
        __TIB_org_xmlvm_iphone_SKPaymentTransactionObserver.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransactionObserver_paymentQueueRestoreCompletedTransactionsFinished___org_xmlvm_iphone_SKPaymentQueue;
        ...
        __CLASS_org_xmlvm_iphone_SKPaymentTransactionObserver_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentTransactionObserver, 3);
        __CLASS_org_xmlvm_iphone_SKPaymentTransactionObserver_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentTransactionObserver, 2);
        __CLASS_org_xmlvm_iphone_SKPaymentTransactionObserver_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentTransactionObserver, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_SKPaymentTransactionObserver()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SKPaymentTransactionObserver(me);
