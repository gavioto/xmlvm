...
void __INIT_IMPL_org_xmlvm_iphone_SKPaymentTransactionObserver()
{
    if (!__TIB_org_xmlvm_iphone_SKPaymentTransactionObserver.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKPaymentTransactionObserver.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransactionObserver_removedTransactions___org_xmlvm_iphone_SKPaymentQueue_java_util_ArrayList;
        __TIB_org_xmlvm_iphone_SKPaymentTransactionObserver.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransactionObserver_restoreCompletedTransactionsFailedWithError___org_xmlvm_iphone_SKPaymentQueue_org_xmlvm_iphone_NSError;
        __TIB_org_xmlvm_iphone_SKPaymentTransactionObserver.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransactionObserver_paymentQueueRestoreCompletedTransactionsFinished___org_xmlvm_iphone_SKPaymentQueue;
