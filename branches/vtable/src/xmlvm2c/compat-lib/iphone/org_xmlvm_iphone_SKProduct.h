...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_SKProduct, 11, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_SKProduct)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_SKProduct 11
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKProduct_getLocalizedDescription__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKProduct_getLocalizedTitle__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKProduct_getPrice__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKProduct_getPriceLocale__ 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKProduct_getProductIdentifier__ 10
