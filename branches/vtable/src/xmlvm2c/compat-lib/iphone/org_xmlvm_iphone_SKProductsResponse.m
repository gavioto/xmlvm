...
void __INIT_IMPL_org_xmlvm_iphone_SKProductsResponse()
{
    if (!__TIB_org_xmlvm_iphone_SKProductsResponse.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKProductsResponse.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_SKProductsResponse_getInvalidProductIdentifiers__;
        __TIB_org_xmlvm_iphone_SKProductsResponse.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_SKProductsResponse_getProducts__;
