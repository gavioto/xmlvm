...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIAcceleration_3ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIAcceleration_2ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIAcceleration_1ARRAY;
...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIAcceleration);
    if (!__TIB_org_xmlvm_iphone_UIAcceleration.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIAcceleration();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIAcceleration);
}

void __INIT_IMPL_org_xmlvm_iphone_UIAcceleration()
{
    if (!__TIB_org_xmlvm_iphone_UIAcceleration.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_UIAcceleration.classInitializationBegan = 1;
        ...
        __TIB_org_xmlvm_iphone_UIAcceleration.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIAcceleration_x__;
        __TIB_org_xmlvm_iphone_UIAcceleration.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIAcceleration_y__;
        __TIB_org_xmlvm_iphone_UIAcceleration.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UIAcceleration_z__;
        ...
        __CLASS_org_xmlvm_iphone_UIAcceleration_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIAcceleration, 3);
        __CLASS_org_xmlvm_iphone_UIAcceleration_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIAcceleration, 2);
        __CLASS_org_xmlvm_iphone_UIAcceleration_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIAcceleration, 1);
