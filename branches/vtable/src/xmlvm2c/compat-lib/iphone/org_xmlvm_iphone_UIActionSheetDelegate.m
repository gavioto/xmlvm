...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIActionSheetDelegate);
    if (!__TIB_org_xmlvm_iphone_UIActionSheetDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIActionSheetDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIActionSheetDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_UIActionSheetDelegate()
{
    if (!__TIB_org_xmlvm_iphone_UIActionSheetDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIActionSheetDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheetDelegate_clickedButtonAtIndex___org_xmlvm_iphone_UIActionSheet_int;
        __TIB_org_xmlvm_iphone_UIActionSheetDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheetDelegate_willPresentActionSheet___org_xmlvm_iphone_UIActionSheet;
        __TIB_org_xmlvm_iphone_UIActionSheetDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheetDelegate_didPresentActionSheet___org_xmlvm_iphone_UIActionSheet;
        __TIB_org_xmlvm_iphone_UIActionSheetDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheetDelegate_willDismissWithButtonIndex___org_xmlvm_iphone_UIActionSheet_int;
        __TIB_org_xmlvm_iphone_UIActionSheetDelegate.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheetDelegate_didDismissWithButtonIndex___org_xmlvm_iphone_UIActionSheet_int;
        __TIB_org_xmlvm_iphone_UIActionSheetDelegate.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheetDelegate_actionSheetCancel___org_xmlvm_iphone_UIActionSheet;
        ...
        __CLASS_org_xmlvm_iphone_UIActionSheetDelegate_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIActionSheetDelegate, 3);
        __CLASS_org_xmlvm_iphone_UIActionSheetDelegate_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIActionSheetDelegate, 2);
        __CLASS_org_xmlvm_iphone_UIActionSheetDelegate_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIActionSheetDelegate, 1);
