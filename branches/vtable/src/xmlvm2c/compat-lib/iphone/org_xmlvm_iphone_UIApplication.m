...
void __INIT_IMPL_org_xmlvm_iphone_UIApplication()
{
    if (!__TIB_org_xmlvm_iphone_UIApplication.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIApplication.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_getDelegate__;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setDelegate___org_xmlvm_iphone_UIApplicationDelegate;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setIdleTimerDisabled___boolean;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[16] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_isIdleTimerDisabled__;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[17] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setKeyWindow___org_xmlvm_iphone_UIWindow;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[18] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_getKeyWindow__;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[19] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_getWindows__;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[20] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setStatusBarOrientation___int;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[21] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setStatusBarHidden___boolean;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[22] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setStatusBarHidden___boolean_boolean;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[23] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_getStatusBarStyle__;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[24] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setStatusBarStyle___int;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[25] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setStatusBarStyle___int_boolean;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[26] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_isNetworkActivityIndicatorVisible__;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[27] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_setNetworkActivityIndicatorVisible___boolean;
        __TIB_org_xmlvm_iphone_UIApplication.vtable[28] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplication_openURL___org_xmlvm_iphone_NSURL;
