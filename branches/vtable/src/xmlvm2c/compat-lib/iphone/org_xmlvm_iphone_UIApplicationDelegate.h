...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIApplicationDelegate, 11, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIApplicationDelegate)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIApplicationDelegate 11
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIApplicationDelegate_applicationDidFinishLaunching___org_xmlvm_iphone_UIApplication 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIApplicationDelegate_applicationWillTerminate___org_xmlvm_iphone_UIApplication 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIApplicationDelegate_applicationDidBecomeActive___org_xmlvm_iphone_UIApplication 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIApplicationDelegate_applicationWillResignActive___org_xmlvm_iphone_UIApplication 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIApplicationDelegate_applicationDidReceiveMemoryWarning___org_xmlvm_iphone_UIApplication 10
