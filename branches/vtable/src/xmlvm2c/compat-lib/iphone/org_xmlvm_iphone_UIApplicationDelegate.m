...
void __INIT_IMPL_org_xmlvm_iphone_UIApplicationDelegate()
{
    if (!__TIB_org_xmlvm_iphone_UIApplicationDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIApplicationDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplicationDelegate_applicationDidFinishLaunching___org_xmlvm_iphone_UIApplication;
        __TIB_org_xmlvm_iphone_UIApplicationDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplicationDelegate_applicationWillTerminate___org_xmlvm_iphone_UIApplication;
        __TIB_org_xmlvm_iphone_UIApplicationDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplicationDelegate_applicationDidBecomeActive___org_xmlvm_iphone_UIApplication;
        __TIB_org_xmlvm_iphone_UIApplicationDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplicationDelegate_applicationWillResignActive___org_xmlvm_iphone_UIApplication;
        __TIB_org_xmlvm_iphone_UIApplicationDelegate.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_UIApplicationDelegate_applicationDidReceiveMemoryWarning___org_xmlvm_iphone_UIApplication;
