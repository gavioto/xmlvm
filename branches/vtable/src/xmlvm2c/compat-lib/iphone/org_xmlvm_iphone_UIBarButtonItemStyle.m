...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIBarButtonItemStyle);
    if (!__TIB_org_xmlvm_iphone_UIBarButtonItemStyle.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIBarButtonItemStyle();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIBarButtonItemStyle);
}

void __INIT_IMPL_org_xmlvm_iphone_UIBarButtonItemStyle()
{
    if (!__TIB_org_xmlvm_iphone_UIBarButtonItemStyle.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UIBarButtonItemStyle_Plain = 0;
        ...
        __CLASS_org_xmlvm_iphone_UIBarButtonItemStyle_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIBarButtonItemStyle, 3);
        __CLASS_org_xmlvm_iphone_UIBarButtonItemStyle_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIBarButtonItemStyle, 2);
        __CLASS_org_xmlvm_iphone_UIBarButtonItemStyle_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIBarButtonItemStyle, 1);
