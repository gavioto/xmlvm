...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIBarItem, 19, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIBarItem)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIBarItem 19
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_getBar__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_setBar___org_xmlvm_iphone_UIView 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_isEnabled__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_setEnabled___boolean 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_getImage__ 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_setImage___org_xmlvm_iphone_UIImage 11
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_getImageInsets__ 12
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_setImageInsets___org_xmlvm_iphone_UIEdgeInsets 13
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_getTitle__ 14
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_setTitle___java_lang_String 15
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_getTag__ 16
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_setTag___int 17
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIBarItem_updateViews__ 18
