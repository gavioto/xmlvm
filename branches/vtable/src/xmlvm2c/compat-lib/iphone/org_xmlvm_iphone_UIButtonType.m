...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIButtonType);
    if (!__TIB_org_xmlvm_iphone_UIButtonType.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIButtonType();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIButtonType);
}

void __INIT_IMPL_org_xmlvm_iphone_UIButtonType()
{
    if (!__TIB_org_xmlvm_iphone_UIButtonType.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UIButtonType_Custom = 0;
        ...
        __CLASS_org_xmlvm_iphone_UIButtonType_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIButtonType, 3);
        __CLASS_org_xmlvm_iphone_UIButtonType_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIButtonType, 2);
        __CLASS_org_xmlvm_iphone_UIButtonType_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIButtonType, 1);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIButtonType(JAVA_OBJECT me)
{
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_UIButtonType()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIButtonType(me);
