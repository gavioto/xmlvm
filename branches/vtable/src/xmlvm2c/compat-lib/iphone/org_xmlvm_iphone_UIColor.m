...
void __INIT_IMPL_org_xmlvm_iphone_UIColor()
{
    if (!__TIB_org_xmlvm_iphone_UIColor.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_UIColor_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIColor, 3);
        __CLASS_org_xmlvm_iphone_UIColor_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIColor, 2);
        __CLASS_org_xmlvm_iphone_UIColor_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIColor, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_UIColor()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIColor(me);
