...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIControlState, 3, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIControlState)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIControlState 3
