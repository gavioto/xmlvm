...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIEdgeInsets);
    if (!__TIB_org_xmlvm_iphone_UIEdgeInsets.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIEdgeInsets();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIEdgeInsets);
}

void __INIT_IMPL_org_xmlvm_iphone_UIEdgeInsets()
{
    if (!__TIB_org_xmlvm_iphone_UIEdgeInsets.classInitializationBegan) {
