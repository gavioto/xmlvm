...
void __INIT_IMPL_org_xmlvm_iphone_UIFont()
{
    if (!__TIB_org_xmlvm_iphone_UIFont.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIFont.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIFont_fontWithSize___float;
        __TIB_org_xmlvm_iphone_UIFont.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIFont_familyName__;
        __TIB_org_xmlvm_iphone_UIFont.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UIFont_fontName__;
        __TIB_org_xmlvm_iphone_UIFont.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UIFont_pointSize__;
        ...
        __CLASS_org_xmlvm_iphone_UIFont_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIFont, 3);
        __CLASS_org_xmlvm_iphone_UIFont_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIFont, 2);
        __CLASS_org_xmlvm_iphone_UIFont_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIFont, 1);
