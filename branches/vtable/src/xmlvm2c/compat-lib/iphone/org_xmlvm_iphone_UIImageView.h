...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIImageView, 64, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIImageView)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIImageView 64
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIImageView_setImage___org_xmlvm_iphone_UIImage 62
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIImageView_getImage__ 63
