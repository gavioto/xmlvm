...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIImageView);
    if (!__TIB_org_xmlvm_iphone_UIImageView.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIImageView();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIImageView);
}

void __INIT_IMPL_org_xmlvm_iphone_UIImageView()
{
    if (!__TIB_org_xmlvm_iphone_UIImageView.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIImageView.vtable[62] = (VTABLE_PTR) &org_xmlvm_iphone_UIImageView_setImage___org_xmlvm_iphone_UIImage;
        __TIB_org_xmlvm_iphone_UIImageView.vtable[63] = (VTABLE_PTR) &org_xmlvm_iphone_UIImageView_getImage__;
        ...
        __CLASS_org_xmlvm_iphone_UIImageView_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIImageView, 3);
        __CLASS_org_xmlvm_iphone_UIImageView_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIImageView, 2);
        __CLASS_org_xmlvm_iphone_UIImageView_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIImageView, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_UIImageView()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIImageView(me);
