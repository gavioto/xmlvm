...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIInterfaceOrientation);
    if (!__TIB_org_xmlvm_iphone_UIInterfaceOrientation.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIInterfaceOrientation();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIInterfaceOrientation);
}

void __INIT_IMPL_org_xmlvm_iphone_UIInterfaceOrientation()
{
    if (!__TIB_org_xmlvm_iphone_UIInterfaceOrientation.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UIInterfaceOrientation_Portrait = 1;
