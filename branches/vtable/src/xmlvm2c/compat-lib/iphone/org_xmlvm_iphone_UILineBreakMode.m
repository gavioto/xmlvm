...
void __INIT_IMPL_org_xmlvm_iphone_UILineBreakMode()
{
    if (!__TIB_org_xmlvm_iphone_UILineBreakMode.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UILineBreakMode_WordWrap = 0;
        ...
        __CLASS_org_xmlvm_iphone_UILineBreakMode_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UILineBreakMode, 3);
        __CLASS_org_xmlvm_iphone_UILineBreakMode_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UILineBreakMode, 2);
        __CLASS_org_xmlvm_iphone_UILineBreakMode_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UILineBreakMode, 1);
