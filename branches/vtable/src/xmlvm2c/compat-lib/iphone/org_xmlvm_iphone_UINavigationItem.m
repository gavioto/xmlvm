...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UINavigationItem);
    if (!__TIB_org_xmlvm_iphone_UINavigationItem.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UINavigationItem();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UINavigationItem);
}

void __INIT_IMPL_org_xmlvm_iphone_UINavigationItem()
{
    if (!__TIB_org_xmlvm_iphone_UINavigationItem.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setToolbar___org_xmlvm_iphone_UINavigationBar;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_getBackBarButtonItem__;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setBackBarButtonItem___org_xmlvm_iphone_UIBarButtonItem;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_hidesBackButton__;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setHidesBackButton___boolean;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setHidesBackButton___boolean_boolean;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_getLeftBarButtonItem__;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setLeftBarButtonItem___org_xmlvm_iphone_UIBarButtonItem;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setLeftBarButtonItem___org_xmlvm_iphone_UIBarButtonItem_boolean;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_getPrompt__;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[16] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setPrompt___java_lang_String;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[17] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_getRightBarButtonItem__;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[18] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setRightBarButtonItem___org_xmlvm_iphone_UIBarButtonItem;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[19] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setRightBarButtonItem___org_xmlvm_iphone_UIBarButtonItem_boolean;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[20] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_getTitle__;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[21] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setTitle___java_lang_String;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[22] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_getTitleView__;
        __TIB_org_xmlvm_iphone_UINavigationItem.vtable[23] = (VTABLE_PTR) &org_xmlvm_iphone_UINavigationItem_setTitleView___org_xmlvm_iphone_UIView;
        ...
        __CLASS_org_xmlvm_iphone_UINavigationItem_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UINavigationItem, 3);
        __CLASS_org_xmlvm_iphone_UINavigationItem_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UINavigationItem, 2);
        __CLASS_org_xmlvm_iphone_UINavigationItem_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UINavigationItem, 1);
