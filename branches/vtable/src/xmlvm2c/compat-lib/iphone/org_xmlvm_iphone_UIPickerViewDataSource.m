...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIPickerViewDataSource);
    if (!__TIB_org_xmlvm_iphone_UIPickerViewDataSource.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIPickerViewDataSource();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIPickerViewDataSource);
}

void __INIT_IMPL_org_xmlvm_iphone_UIPickerViewDataSource()
{
    if (!__TIB_org_xmlvm_iphone_UIPickerViewDataSource.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_UIPickerViewDataSource_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPickerViewDataSource, 3);
        __CLASS_org_xmlvm_iphone_UIPickerViewDataSource_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPickerViewDataSource, 2);
        __CLASS_org_xmlvm_iphone_UIPickerViewDataSource_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPickerViewDataSource, 1);
