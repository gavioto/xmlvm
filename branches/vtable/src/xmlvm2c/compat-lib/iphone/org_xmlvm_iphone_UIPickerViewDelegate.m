...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIPickerViewDelegate);
    if (!__TIB_org_xmlvm_iphone_UIPickerViewDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIPickerViewDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIPickerViewDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_UIPickerViewDelegate()
{
    if (!__TIB_org_xmlvm_iphone_UIPickerViewDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIPickerViewDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIPickerViewDelegate_rowHeightForComponent___org_xmlvm_iphone_UIPickerView_int;
        __TIB_org_xmlvm_iphone_UIPickerViewDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIPickerViewDelegate_widthForComponent___org_xmlvm_iphone_UIPickerView_int;
        __TIB_org_xmlvm_iphone_UIPickerViewDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UIPickerViewDelegate_viewForRow___org_xmlvm_iphone_UIPickerView_int_int_org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_UIPickerViewDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UIPickerViewDelegate_titleForRow___org_xmlvm_iphone_UIPickerView_int_int;
        __TIB_org_xmlvm_iphone_UIPickerViewDelegate.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_UIPickerViewDelegate_didSelectRow___org_xmlvm_iphone_UIPickerView_int_int;
        ...
        __CLASS_org_xmlvm_iphone_UIPickerViewDelegate_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPickerViewDelegate, 3);
        __CLASS_org_xmlvm_iphone_UIPickerViewDelegate_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPickerViewDelegate, 2);
        __CLASS_org_xmlvm_iphone_UIPickerViewDelegate_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPickerViewDelegate, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_UIPickerViewDelegate()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIPickerViewDelegate(me);
