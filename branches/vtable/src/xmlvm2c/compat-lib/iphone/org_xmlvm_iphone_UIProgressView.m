...
void __INIT_IMPL_org_xmlvm_iphone_UIProgressView()
{
    if (!__TIB_org_xmlvm_iphone_UIProgressView.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIProgressView.vtable[70] = (VTABLE_PTR) &org_xmlvm_iphone_UIProgressView_setProgress___float;
        __TIB_org_xmlvm_iphone_UIProgressView.vtable[71] = (VTABLE_PTR) &org_xmlvm_iphone_UIProgressView_getProgress__;
        __TIB_org_xmlvm_iphone_UIProgressView.vtable[72] = (VTABLE_PTR) &org_xmlvm_iphone_UIProgressView_getProgressViewStyle__;
        __TIB_org_xmlvm_iphone_UIProgressView.vtable[73] = (VTABLE_PTR) &org_xmlvm_iphone_UIProgressView_setProgressViewStyle___int;
