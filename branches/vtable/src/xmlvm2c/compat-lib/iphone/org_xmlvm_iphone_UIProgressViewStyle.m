...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIProgressViewStyle);
    if (!__TIB_org_xmlvm_iphone_UIProgressViewStyle.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIProgressViewStyle();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIProgressViewStyle);
}

void __INIT_IMPL_org_xmlvm_iphone_UIProgressViewStyle()
{
    if (!__TIB_org_xmlvm_iphone_UIProgressViewStyle.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_UIProgressViewStyle_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIProgressViewStyle, 3);
        __CLASS_org_xmlvm_iphone_UIProgressViewStyle_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIProgressViewStyle, 2);
        __CLASS_org_xmlvm_iphone_UIProgressViewStyle_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIProgressViewStyle, 1);
