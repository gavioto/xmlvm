...
void __INIT_IMPL_org_xmlvm_iphone_UIScreen()
{
    if (!__TIB_org_xmlvm_iphone_UIScreen.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIScreen.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIScreen_getBounds__;
        __TIB_org_xmlvm_iphone_UIScreen.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIScreen_getApplicationFrame__;
