...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIScrollView);
    if (!__TIB_org_xmlvm_iphone_UIScrollView.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIScrollView();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIScrollView);
}

void __INIT_IMPL_org_xmlvm_iphone_UIScrollView()
{
    if (!__TIB_org_xmlvm_iphone_UIScrollView.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[65] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setContentOffset___org_xmlvm_iphone_CGPoint;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[66] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setContentOffset___org_xmlvm_iphone_CGPoint_boolean;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[67] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_getContentOffset__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[68] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setScrollEnabled___boolean;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[69] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_isScrollEnabled__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[70] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_isPagingEnabled__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[71] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setPagingEnabled___boolean;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[72] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_getContentSize__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[73] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setContentSize___org_xmlvm_iphone_CGSize;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[74] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_getDelegate__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[75] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setDelegate___org_xmlvm_iphone_UIScrollViewDelegate;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[76] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_isScrollsToTop__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[77] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setScrollsToTop___boolean;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[78] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_isShowsHorizontalScrollIndicator__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[79] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setShowsHorizontalScrollIndicator___boolean;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[80] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_isShowsVerticalScrollIndicator__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[81] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_isBounces__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[82] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setBounces___boolean;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[83] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_isDelaysContentTouches__;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[84] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setDelaysContentTouches___boolean;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[85] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_setShowsVerticalScrollIndicator___boolean;
        __TIB_org_xmlvm_iphone_UIScrollView.vtable[86] = (VTABLE_PTR) &org_xmlvm_iphone_UIScrollView_scrollRectToVisible___org_xmlvm_iphone_CGRect_boolean;
        ...
        __CLASS_org_xmlvm_iphone_UIScrollView_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIScrollView, 3);
        __CLASS_org_xmlvm_iphone_UIScrollView_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIScrollView, 2);
        __CLASS_org_xmlvm_iphone_UIScrollView_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIScrollView, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_UIScrollView()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIScrollView(me);
