...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UISearchBarDelegate);
    if (!__TIB_org_xmlvm_iphone_UISearchBarDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UISearchBarDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UISearchBarDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_UISearchBarDelegate()
{
    if (!__TIB_org_xmlvm_iphone_UISearchBarDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarTextDidChange___org_xmlvm_iphone_UISearchBar_java_lang_String;
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarShouldBeginEditing___org_xmlvm_iphone_UISearchBar;
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarTextDidBeginEditing___org_xmlvm_iphone_UISearchBar;
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarShouldEndEditing___org_xmlvm_iphone_UISearchBar;
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarTextDidEndEditing___org_xmlvm_iphone_UISearchBar;
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarBookmarkButtonClicked___org_xmlvm_iphone_UISearchBar;
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarCancelButtonClicked___org_xmlvm_iphone_UISearchBar;
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarSearchButtonClicked___org_xmlvm_iphone_UISearchBar;
        __TIB_org_xmlvm_iphone_UISearchBarDelegate.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_UISearchBarDelegate_searchBarSelectedScopeButtonIndexDidChange___org_xmlvm_iphone_UISearchBar_int;
        ...
        __CLASS_org_xmlvm_iphone_UISearchBarDelegate_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UISearchBarDelegate, 3);
        __CLASS_org_xmlvm_iphone_UISearchBarDelegate_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UISearchBarDelegate, 2);
        __CLASS_org_xmlvm_iphone_UISearchBarDelegate_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UISearchBarDelegate, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_UISearchBarDelegate()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UISearchBarDelegate(me);
