...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UISegmentedControlStyle);
    if (!__TIB_org_xmlvm_iphone_UISegmentedControlStyle.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UISegmentedControlStyle();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UISegmentedControlStyle);
}

void __INIT_IMPL_org_xmlvm_iphone_UISegmentedControlStyle()
{
    if (!__TIB_org_xmlvm_iphone_UISegmentedControlStyle.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UISegmentedControlStyle_Plain = 0;
        ...
        __CLASS_org_xmlvm_iphone_UISegmentedControlStyle_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UISegmentedControlStyle, 3);
        __CLASS_org_xmlvm_iphone_UISegmentedControlStyle_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UISegmentedControlStyle, 2);
        __CLASS_org_xmlvm_iphone_UISegmentedControlStyle_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UISegmentedControlStyle, 1);
