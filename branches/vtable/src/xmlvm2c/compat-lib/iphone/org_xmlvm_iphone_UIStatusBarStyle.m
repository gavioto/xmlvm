...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIStatusBarStyle);
    if (!__TIB_org_xmlvm_iphone_UIStatusBarStyle.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIStatusBarStyle();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIStatusBarStyle);
}

void __INIT_IMPL_org_xmlvm_iphone_UIStatusBarStyle()
{
    if (!__TIB_org_xmlvm_iphone_UIStatusBarStyle.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UIStatusBarStyle_Default = 0;
