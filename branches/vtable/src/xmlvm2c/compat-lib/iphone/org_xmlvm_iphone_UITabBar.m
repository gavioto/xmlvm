...
void __INIT_IMPL_org_xmlvm_iphone_UITabBar()
{
    if (!__TIB_org_xmlvm_iphone_UITabBar.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UITabBar.vtable[62] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_getDelegate__;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[63] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_setDelegate___org_xmlvm_iphone_UITabBarDelegate;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[64] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_getItems__;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[65] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_setItems___java_util_ArrayList;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[66] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_setItems___java_util_ArrayList_boolean;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[67] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_getSelectedItem__;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[68] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_setSelectedItem___org_xmlvm_iphone_UITabBarItem;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[69] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_setSelectedIndex___int;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[70] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_beginCustomizingItems___java_util_ArrayList;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[71] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_endCustomizingAnimated___boolean;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[72] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_isCustomizing__;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[73] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_getBarStyle__;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[74] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_setBarStyle___int;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[75] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_getTintColor__;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[76] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_setTintColor___org_xmlvm_iphone_UIColor;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[77] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_isTranslucent__;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[78] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_setTranslucent___boolean;
        __TIB_org_xmlvm_iphone_UITabBar.vtable[79] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBar_updateViews__;
