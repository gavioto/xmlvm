...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITabBarControllerDelegate);
    if (!__TIB_org_xmlvm_iphone_UITabBarControllerDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITabBarControllerDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITabBarControllerDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_UITabBarControllerDelegate()
{
    if (!__TIB_org_xmlvm_iphone_UITabBarControllerDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UITabBarControllerDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarControllerDelegate_shouldSelectViewController___org_xmlvm_iphone_UITabBarController_org_xmlvm_iphone_UIViewController;
        __TIB_org_xmlvm_iphone_UITabBarControllerDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarControllerDelegate_didSelectViewController___org_xmlvm_iphone_UITabBarController_org_xmlvm_iphone_UIViewController;
        __TIB_org_xmlvm_iphone_UITabBarControllerDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarControllerDelegate_willBeginCustomizingViewControllers___org_xmlvm_iphone_UITabBarController_java_util_ArrayList;
        __TIB_org_xmlvm_iphone_UITabBarControllerDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarControllerDelegate_willEndCustomizingViewControllers___org_xmlvm_iphone_UITabBarController_java_util_ArrayList_boolean;
        __TIB_org_xmlvm_iphone_UITabBarControllerDelegate.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarControllerDelegate_didEndCustomizingViewControllers___org_xmlvm_iphone_UITabBarController_java_util_ArrayList_boolean;
        ...
        __CLASS_org_xmlvm_iphone_UITabBarControllerDelegate_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITabBarControllerDelegate, 3);
        __CLASS_org_xmlvm_iphone_UITabBarControllerDelegate_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITabBarControllerDelegate, 2);
        __CLASS_org_xmlvm_iphone_UITabBarControllerDelegate_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITabBarControllerDelegate, 1);
