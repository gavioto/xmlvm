...
__TIB_DEFINITION_org_xmlvm_iphone_UITabBarItem __TIB_org_xmlvm_iphone_UITabBarItem = {
    ...
    sizeof(org_xmlvm_iphone_UITabBarItem), // sizeInstance
    XMLVM_TYPE_CLASS};
...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UITabBarItem_1ARRAY;
...
{
    JAVA_OBJECT obj = __NEW_org_xmlvm_iphone_UITabBarItem();
    java_lang_reflect_Constructor* c = (java_lang_reflect_Constructor*) constructor;
    org_xmlvm_runtime_XMLVMArray* args = (org_xmlvm_runtime_XMLVMArray*) arguments;
    JAVA_ARRAY_OBJECT* argsArray = (JAVA_ARRAY_OBJECT*) args->fields.org_xmlvm_runtime_XMLVMArray.array_;
    switch (c->fields.java_lang_reflect_Constructor.slot_) {
    case 0:
        org_xmlvm_iphone_UITabBarItem___INIT___(obj);
        break;
    default:
...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITabBarItem);
    if (!__TIB_org_xmlvm_iphone_UITabBarItem.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITabBarItem();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITabBarItem);
}

void __INIT_IMPL_org_xmlvm_iphone_UITabBarItem()
{
    if (!__TIB_org_xmlvm_iphone_UITabBarItem.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_UITabBarItem.classInitializationBegan = 1;

        // Initialize base class if necessary
        if (!__TIB_org_xmlvm_iphone_UIBarItem.classInitialized) __INIT_IMPL_org_xmlvm_iphone_UIBarItem();
        ...
        __TIB_org_xmlvm_iphone_UITabBarItem.vtable[19] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarItem_getBadgeValue__;
        __TIB_org_xmlvm_iphone_UITabBarItem.vtable[20] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarItem_setBadgeValue___java_lang_String;
        __TIB_org_xmlvm_iphone_UITabBarItem.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarItem_setTitle___java_lang_String;
        ...
        __TIB_org_xmlvm_iphone_UITabBarItem.constructorDispatcherFunc = constructor_dispatcher;
        __TIB_org_xmlvm_iphone_UITabBarItem.declaredConstructors = &__constructor_reflection_data[0];
        __TIB_org_xmlvm_iphone_UITabBarItem.numDeclaredConstructors = sizeof(__constructor_reflection_data) / sizeof(XMLVM_CONSTRUCTOR_REFLECTION_DATA);
        __TIB_org_xmlvm_iphone_UITabBarItem.methodDispatcherFunc = method_dispatcher;
        __TIB_org_xmlvm_iphone_UITabBarItem.declaredMethods = &__method_reflection_data[0];
        __TIB_org_xmlvm_iphone_UITabBarItem.numDeclaredMethods = sizeof(__method_reflection_data) / sizeof(XMLVM_METHOD_REFLECTION_DATA);
        __CLASS_org_xmlvm_iphone_UITabBarItem = XMLVM_CREATE_CLASS_OBJECT(&__TIB_org_xmlvm_iphone_UITabBarItem);
        __TIB_org_xmlvm_iphone_UITabBarItem.clazz = __CLASS_org_xmlvm_iphone_UITabBarItem;
        __CLASS_org_xmlvm_iphone_UITabBarItem_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITabBarItem, 3);
        __CLASS_org_xmlvm_iphone_UITabBarItem_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITabBarItem, 2);
        __CLASS_org_xmlvm_iphone_UITabBarItem_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITabBarItem, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_UITabBarItem()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UITabBarItem(me);
