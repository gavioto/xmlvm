...
void __INIT_IMPL_org_xmlvm_iphone_UITableViewCell()
{
    if (!__TIB_org_xmlvm_iphone_UITableViewCell.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[62] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_setSelected___boolean;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[63] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_isSelected__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[64] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getEditingStyle__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[27] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_layoutSubviews__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[65] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getContentView__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[66] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_setBackgroundView___org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[67] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getBackgroundView__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[68] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_setSelectedBackgroundView___org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[69] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getSelectedBackgroundView__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[70] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getTextLabel__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[71] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getDetailTextLabel__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[72] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getImageView__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[73] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getAccessoryView__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[74] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_setAccessoryView___org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[75] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getReuseIdentifier__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[76] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_getSelectionStyle__;
        __TIB_org_xmlvm_iphone_UITableViewCell.vtable[77] = (VTABLE_PTR) &org_xmlvm_iphone_UITableViewCell_setSelectionStyle___int;
