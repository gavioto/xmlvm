...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle);
    if (!__TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITableViewCellSeparatorStyle();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle);
}

void __INIT_IMPL_org_xmlvm_iphone_UITableViewCellSeparatorStyle()
{
    if (!__TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.classInitializationBegan = 1;
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UITableViewCellSeparatorStyle_None = 0;
