...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITableViewRowAnimation);
    if (!__TIB_org_xmlvm_iphone_UITableViewRowAnimation.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITableViewRowAnimation();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITableViewRowAnimation);
}

void __INIT_IMPL_org_xmlvm_iphone_UITableViewRowAnimation()
{
    if (!__TIB_org_xmlvm_iphone_UITableViewRowAnimation.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UITableViewRowAnimation_Fade = 0;
        ...
        __CLASS_org_xmlvm_iphone_UITableViewRowAnimation_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewRowAnimation, 3);
        __CLASS_org_xmlvm_iphone_UITableViewRowAnimation_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewRowAnimation, 2);
        __CLASS_org_xmlvm_iphone_UITableViewRowAnimation_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewRowAnimation, 1);
