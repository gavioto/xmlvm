...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UITableViewScrollPosition, 3, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UITableViewScrollPosition)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UITableViewScrollPosition 3
