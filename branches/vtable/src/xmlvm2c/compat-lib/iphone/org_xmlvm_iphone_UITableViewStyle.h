...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UITableViewStyle, 3, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UITableViewStyle)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UITableViewStyle 3
