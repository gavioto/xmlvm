...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITextAutocorrectionType);
    if (!__TIB_org_xmlvm_iphone_UITextAutocorrectionType.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITextAutocorrectionType();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITextAutocorrectionType);
}

void __INIT_IMPL_org_xmlvm_iphone_UITextAutocorrectionType()
{
    if (!__TIB_org_xmlvm_iphone_UITextAutocorrectionType.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UITextAutocorrectionType_Default = 0;
        ...
        __CLASS_org_xmlvm_iphone_UITextAutocorrectionType_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITextAutocorrectionType, 3);
        __CLASS_org_xmlvm_iphone_UITextAutocorrectionType_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITextAutocorrectionType, 2);
        __CLASS_org_xmlvm_iphone_UITextAutocorrectionType_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITextAutocorrectionType, 1);
