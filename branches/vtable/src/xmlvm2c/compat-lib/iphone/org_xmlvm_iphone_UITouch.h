...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UITouch, 12, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UITouch)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UITouch 12
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITouch_locationInView___org_xmlvm_iphone_UIView 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITouch_getView__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITouch_getWindow__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITouch_getTapCount__ 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITouch_getTimestamp__ 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITouch_getPhase__ 11
