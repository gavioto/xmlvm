...
void __INIT_IMPL_org_xmlvm_iphone_UIViewController()
{
    if (!__TIB_org_xmlvm_iphone_UIViewController.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIViewController.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_loadView__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_isViewLoaded__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_viewDidLoad__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[16] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_viewDidUnload__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[17] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_viewWillAppearInternal___boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[18] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_requestInternalFrame__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[19] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_updateViews__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[20] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_viewWillAppear___boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[21] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_viewDidAppear___boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[22] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_viewWillDisappear___boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[23] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_viewDidDisappear___boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[24] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_shouldAutorotateToInterfaceOrientation___int;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[25] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_rotatingHeaderView__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[26] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_rotatingFooterView__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[27] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_willRotateToInterfaceOrientation___int_double;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[28] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_willAnimateRotationToInterfaceOrientation___int_double;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[29] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_didRotateFromInterfaceOrientation___int;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[30] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_willAnimateFirstHalfOfRotationToInterfaceOrientation___int_double;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[31] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_didAnimateFirstHalfOfRotationToInterfaceOrientation___int;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[32] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_willAnimateSecondHalfOfRotationFromInterfaceOrientation___int_double;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[33] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_didReceiveMemoryWarning__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[34] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_getView__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[35] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setView___org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[36] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_getTitle__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[37] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setTitle___java_lang_String;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[38] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_wantsFullScreenLayout__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[39] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setWantsFullScreenLayout___boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[40] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_getInterfaceOrientation__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[41] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_getNavigationController__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[42] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_getNavigationItem__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[43] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_editButtonItem__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[44] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_isEditing__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[45] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setEditing___boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[46] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setEditing___boolean_boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[47] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_hidesBottomBarWhenPushed__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[48] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setHidesBottomBarWhenPushed___boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[49] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_getTabBarController__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[50] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setParentController___org_xmlvm_iphone_UIViewController;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[51] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_getTabBarItem__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[52] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setTabBarItem___org_xmlvm_iphone_UITabBarItem;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[53] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_getToolbarItems__;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[54] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setToolbarItems___java_util_ArrayList;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[55] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_setToolbarItems___java_util_ArrayList_boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[56] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_presentModalViewController___org_xmlvm_iphone_UIViewController_boolean;
        __TIB_org_xmlvm_iphone_UIViewController.vtable[57] = (VTABLE_PTR) &org_xmlvm_iphone_UIViewController_dismissModalViewControllerAnimated___boolean;
