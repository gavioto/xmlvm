...
public enum Targets {
    ...
    PYTHON, OBJC, QOOXDOO, IPHONE, IPHONEC, IPHONEANDROID, IPHONECANDROID, VTABLE, WEBOS, IPHONETEMPLATE(SKELETON),
    ANDROIDTEMPLATE(SKELETON), ANDROIDMIGRATETEMPLATE(SKELETON), IPHONEUPDATETEMPLATE(SKELETON),
	ANDROIDUPDATETEMPLATE(SKELETON), CSHARP, GENCSHARPWRAPPERS, WP7, WP7ANDROID;
