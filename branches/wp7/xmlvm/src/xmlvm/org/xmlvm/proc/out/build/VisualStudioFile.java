...
public class VisualStudioFile extends BuildFile {
    ...
    public String composeBuildFiles(List<OutputFile> allfiles, Arguments arguments) {
        ...
        VisualStudioProject proj;
        try {
            proj = new VisualStudioProject(projname, allfiles);
    ...
    private class VisualStudioProject {
        ...
        private VisualStudioProject(String name, List<OutputFile> allfiles) throws IOException {
