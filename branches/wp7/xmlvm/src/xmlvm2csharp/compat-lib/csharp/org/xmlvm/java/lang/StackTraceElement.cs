...
public override int equals(java.lang.Object n1){
...
if (_other._lineNumber != _lineNumber) return 0;
java.lang.String _otherFileName = _other._fileName;
if ((_otherFileName!=_fileName) && (_fileName==null || _fileName.equals(_otherFileName)==0)) return 0;

java.lang.String _otherMethodName = _other._methodName;
if ((_otherMethodName!=_methodName) && (_methodName==null || _methodName.equals(_otherMethodName)==0)) return 0;

java.lang.String _otherDeclaringClass = _other._declaringClass;
if ((_otherDeclaringClass!=_declaringClass) && (_declaringClass==null || _declaringClass.equals(_otherDeclaringClass)==0)) return 0;
...
public virtual int isNativeMethod(){
