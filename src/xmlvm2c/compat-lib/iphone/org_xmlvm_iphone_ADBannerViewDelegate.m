...
void __INIT_IMPL_org_xmlvm_iphone_ADBannerViewDelegate()
{
    if (!__TIB_org_xmlvm_iphone_ADBannerViewDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_ADBannerViewDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_ADBannerViewDelegate_didLoadAd___org_xmlvm_iphone_ADBannerView;
        __TIB_org_xmlvm_iphone_ADBannerViewDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_ADBannerViewDelegate_shouldBegin___org_xmlvm_iphone_ADBannerView_boolean;
        __TIB_org_xmlvm_iphone_ADBannerViewDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_ADBannerViewDelegate_didFailToReceiveAdWithError___org_xmlvm_iphone_ADBannerView_org_xmlvm_iphone_NSError;
        __TIB_org_xmlvm_iphone_ADBannerViewDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_ADBannerViewDelegate_didFinish___org_xmlvm_iphone_ADBannerView;
