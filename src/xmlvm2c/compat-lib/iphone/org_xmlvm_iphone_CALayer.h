...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_CALayer, 16, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_CALayer)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_CALayer 16
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_addAnimation___org_xmlvm_iphone_CAAnimation_java_lang_String 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_animationForKey___java_lang_String 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_removeAllAnimations__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_removeAnimationForKey___java_lang_String 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_animationKeys__ 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_renderInContext___org_xmlvm_iphone_CGContext 11
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_getDelegate__ 12
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_setDelegate___org_xmlvm_iphone_UIView 13
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_getAnchorPoint__ 14
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CALayer_setAnchorPoint___org_xmlvm_iphone_CGPoint 15
