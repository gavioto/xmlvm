...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_CGBitmapContext, 34, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_CGBitmapContext)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_CGBitmapContext 34
