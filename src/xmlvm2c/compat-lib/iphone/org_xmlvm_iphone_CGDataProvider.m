...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CGDataProvider);
    if (!__TIB_org_xmlvm_iphone_CGDataProvider.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CGDataProvider();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CGDataProvider);
}

void __INIT_IMPL_org_xmlvm_iphone_CGDataProvider()
{
    if (!__TIB_org_xmlvm_iphone_CGDataProvider.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_CGDataProvider_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGDataProvider, 3);
        __CLASS_org_xmlvm_iphone_CGDataProvider_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGDataProvider, 2);
        __CLASS_org_xmlvm_iphone_CGDataProvider_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGDataProvider, 1);
