...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_CGFont, 9, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_CGFont)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_CGFont 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CGFont_getAscent__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CGFont_getDescent__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CGFont_getUnitsPerEm__ 8
