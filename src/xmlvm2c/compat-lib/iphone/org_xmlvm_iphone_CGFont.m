...
void __INIT_IMPL_org_xmlvm_iphone_CGFont()
{
    if (!__TIB_org_xmlvm_iphone_CGFont.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CGFont.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_CGFont_getAscent__;
        __TIB_org_xmlvm_iphone_CGFont.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_CGFont_getDescent__;
        __TIB_org_xmlvm_iphone_CGFont.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_CGFont_getUnitsPerEm__;
        ...
        __CLASS_org_xmlvm_iphone_CGFont_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGFont, 3);
        __CLASS_org_xmlvm_iphone_CGFont_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGFont, 2);
        __CLASS_org_xmlvm_iphone_CGFont_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGFont, 1);
