...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_CGImage, 7, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_CGImage)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_CGImage 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CGImage_getSize__ 6
