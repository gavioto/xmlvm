...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CGPathDrawingMode);
    if (!__TIB_org_xmlvm_iphone_CGPathDrawingMode.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CGPathDrawingMode();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CGPathDrawingMode);
}

void __INIT_IMPL_org_xmlvm_iphone_CGPathDrawingMode()
{
    if (!__TIB_org_xmlvm_iphone_CGPathDrawingMode.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_CGPathDrawingMode_kCGPathFill = 0;
        ...
        __CLASS_org_xmlvm_iphone_CGPathDrawingMode_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGPathDrawingMode, 3);
        __CLASS_org_xmlvm_iphone_CGPathDrawingMode_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGPathDrawingMode, 2);
        __CLASS_org_xmlvm_iphone_CGPathDrawingMode_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CGPathDrawingMode, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_CGPathDrawingMode()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CGPathDrawingMode(me);
