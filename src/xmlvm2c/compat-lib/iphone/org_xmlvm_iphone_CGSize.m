...
void __INIT_IMPL_org_xmlvm_iphone_CGSize()
{
    if (!__TIB_org_xmlvm_iphone_CGSize.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CGSize.vtable[2] = (VTABLE_PTR) &org_xmlvm_iphone_CGSize_toString__;
        __TIB_org_xmlvm_iphone_CGSize.vtable[0] = (VTABLE_PTR) &org_xmlvm_iphone_CGSize_equals___java_lang_Object;
