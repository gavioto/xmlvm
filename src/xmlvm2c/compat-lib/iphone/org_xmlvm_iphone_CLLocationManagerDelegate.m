...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_CLLocationManagerDelegate);
    if (!__TIB_org_xmlvm_iphone_CLLocationManagerDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_CLLocationManagerDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_CLLocationManagerDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_CLLocationManagerDelegate()
{
    if (!__TIB_org_xmlvm_iphone_CLLocationManagerDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_CLLocationManagerDelegate.vtable[3] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocationManagerDelegate_didUpdateToLocation___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLLocation_org_xmlvm_iphone_CLLocation;
        __TIB_org_xmlvm_iphone_CLLocationManagerDelegate.vtable[4] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocationManagerDelegate_didFailWithError___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_NSError;
        __TIB_org_xmlvm_iphone_CLLocationManagerDelegate.vtable[5] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocationManagerDelegate_didUpdateHeading___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLHeading;
        __TIB_org_xmlvm_iphone_CLLocationManagerDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocationManagerDelegate_locationManagerShouldDisplayHeadingCalibration___org_xmlvm_iphone_CLLocationManager;
        __TIB_org_xmlvm_iphone_CLLocationManagerDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocationManagerDelegate_didEnterRegion___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLRegion;
        __TIB_org_xmlvm_iphone_CLLocationManagerDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocationManagerDelegate_didExitRegion___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLRegion;
        __TIB_org_xmlvm_iphone_CLLocationManagerDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_CLLocationManagerDelegate_monitoringDidFailForRegion___org_xmlvm_iphone_CLLocationManager_org_xmlvm_iphone_CLRegion_org_xmlvm_iphone_NSError;
