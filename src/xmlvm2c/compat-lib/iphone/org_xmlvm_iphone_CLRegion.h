...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_CLRegion, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_CLRegion)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_CLRegion 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLRegion_getCenter__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLRegion_getIdentifier__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLRegion_getRadius__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CLRegion_containsCoordinate___org_xmlvm_iphone_CLLocationCoordinate2D 9
