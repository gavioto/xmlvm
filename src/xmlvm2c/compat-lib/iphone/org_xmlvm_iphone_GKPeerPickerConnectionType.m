...
void __INIT_IMPL_org_xmlvm_iphone_GKPeerPickerConnectionType()
{
    if (!__TIB_org_xmlvm_iphone_GKPeerPickerConnectionType.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_GKPeerPickerConnectionType_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKPeerPickerConnectionType, 3);
        __CLASS_org_xmlvm_iphone_GKPeerPickerConnectionType_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKPeerPickerConnectionType, 2);
        __CLASS_org_xmlvm_iphone_GKPeerPickerConnectionType_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKPeerPickerConnectionType, 1);
