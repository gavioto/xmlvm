...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_GKPeerPickerController, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_GKPeerPickerController)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_GKPeerPickerController 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerController_getDelegate__ 3
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerController_setDelegate___org_xmlvm_iphone_GKPeerPickerControllerDelegate 4
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerController_isVisible__ 5
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerController_getConnectionTypesMask__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerController_setConnectionTypesMask___int 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerController_show__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerController_dismiss__ 9
