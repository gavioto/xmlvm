...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_MFMailComposeViewController);
    if (!__TIB_org_xmlvm_iphone_MFMailComposeViewController.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_MFMailComposeViewController();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_MFMailComposeViewController);
}

void __INIT_IMPL_org_xmlvm_iphone_MFMailComposeViewController()
{
    if (!__TIB_org_xmlvm_iphone_MFMailComposeViewController.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.classInitializationBegan = 1;

        // Initialize base class if necessary
        if (!__TIB_org_xmlvm_iphone_UINavigationController.classInitialized) __INIT_IMPL_org_xmlvm_iphone_UINavigationController();
        ...
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.vtable[77] = (VTABLE_PTR) &org_xmlvm_iphone_MFMailComposeViewController_getMailComposeDelegate__;
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.vtable[78] = (VTABLE_PTR) &org_xmlvm_iphone_MFMailComposeViewController_setMailComposeDelegate___org_xmlvm_iphone_MFMailComposeViewControllerDelegate;
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.vtable[79] = (VTABLE_PTR) &org_xmlvm_iphone_MFMailComposeViewController_addAttachmentData___org_xmlvm_iphone_NSData_org_xmlvm_iphone_NSString_java_lang_String;
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.vtable[80] = (VTABLE_PTR) &org_xmlvm_iphone_MFMailComposeViewController_setBccRecipients___java_util_ArrayList;
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.vtable[81] = (VTABLE_PTR) &org_xmlvm_iphone_MFMailComposeViewController_setCcRecipients___java_util_ArrayList;
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.vtable[82] = (VTABLE_PTR) &org_xmlvm_iphone_MFMailComposeViewController_setMessageBody___java_lang_String_boolean;
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.vtable[83] = (VTABLE_PTR) &org_xmlvm_iphone_MFMailComposeViewController_setSubject___java_lang_String;
        __TIB_org_xmlvm_iphone_MFMailComposeViewController.vtable[84] = (VTABLE_PTR) &org_xmlvm_iphone_MFMailComposeViewController_setToRecipients___java_util_ArrayList;
        ...
        __CLASS_org_xmlvm_iphone_MFMailComposeViewController_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeViewController, 3);
        __CLASS_org_xmlvm_iphone_MFMailComposeViewController_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeViewController, 2);
        __CLASS_org_xmlvm_iphone_MFMailComposeViewController_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMailComposeViewController, 1);
