...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_MKAnnotationViewDragState);
    if (!__TIB_org_xmlvm_iphone_MKAnnotationViewDragState.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_MKAnnotationViewDragState();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_MKAnnotationViewDragState);
}

void __INIT_IMPL_org_xmlvm_iphone_MKAnnotationViewDragState()
{
    if (!__TIB_org_xmlvm_iphone_MKAnnotationViewDragState.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_MKAnnotationViewDragState_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKAnnotationViewDragState, 3);
        __CLASS_org_xmlvm_iphone_MKAnnotationViewDragState_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKAnnotationViewDragState, 2);
        __CLASS_org_xmlvm_iphone_MKAnnotationViewDragState_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKAnnotationViewDragState, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_MKAnnotationViewDragState()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_MKAnnotationViewDragState(me);
