...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_MKMapSize);
    if (!__TIB_org_xmlvm_iphone_MKMapSize.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_MKMapSize();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_MKMapSize);
}

void __INIT_IMPL_org_xmlvm_iphone_MKMapSize()
{
    if (!__TIB_org_xmlvm_iphone_MKMapSize.classInitializationBegan) {
