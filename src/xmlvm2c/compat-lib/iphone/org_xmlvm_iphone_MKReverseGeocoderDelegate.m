...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_MKReverseGeocoderDelegate);
    if (!__TIB_org_xmlvm_iphone_MKReverseGeocoderDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_MKReverseGeocoderDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_MKReverseGeocoderDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_MKReverseGeocoderDelegate()
{
    if (!__TIB_org_xmlvm_iphone_MKReverseGeocoderDelegate.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_MKReverseGeocoderDelegate_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKReverseGeocoderDelegate, 3);
        __CLASS_org_xmlvm_iphone_MKReverseGeocoderDelegate_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKReverseGeocoderDelegate, 2);
        __CLASS_org_xmlvm_iphone_MKReverseGeocoderDelegate_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKReverseGeocoderDelegate, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_MKReverseGeocoderDelegate()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_MKReverseGeocoderDelegate(me);
