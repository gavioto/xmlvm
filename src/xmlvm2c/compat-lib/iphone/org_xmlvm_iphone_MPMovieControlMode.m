...
void __INIT_IMPL_org_xmlvm_iphone_MPMovieControlMode()
{
    if (!__TIB_org_xmlvm_iphone_MPMovieControlMode.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_MPMovieControlMode_Default = 0;
        ...
        __CLASS_org_xmlvm_iphone_MPMovieControlMode_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MPMovieControlMode, 3);
        __CLASS_org_xmlvm_iphone_MPMovieControlMode_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MPMovieControlMode, 2);
        __CLASS_org_xmlvm_iphone_MPMovieControlMode_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MPMovieControlMode, 1);
