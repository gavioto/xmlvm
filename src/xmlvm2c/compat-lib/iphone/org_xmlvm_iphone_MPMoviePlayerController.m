...
void __INIT_IMPL_org_xmlvm_iphone_MPMoviePlayerController()
{
    if (!__TIB_org_xmlvm_iphone_MPMoviePlayerController.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_play__;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_stop__;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_getContentURL__;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_getBackgroundColor__;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_setBackgroundColor___org_xmlvm_iphone_UIColor;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_getInitialPlaybackTime__;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_setInitialPlaybackTime___double;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_getScalingMode__;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_setScalingMode___int;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_getMovieControlMode__;
        __TIB_org_xmlvm_iphone_MPMoviePlayerController.vtable[16] = (VTABLE_PTR) &org_xmlvm_iphone_MPMoviePlayerController_setMovieControlMode___int;
