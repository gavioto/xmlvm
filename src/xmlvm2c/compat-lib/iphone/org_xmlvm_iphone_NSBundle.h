...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSBundle, 9, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSBundle)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSBundle 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSBundle_pathForResource___java_lang_String_java_lang_String_java_lang_String 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSBundle_pathForResource___java_lang_String_java_lang_String 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSBundle_bundlePath__ 8
