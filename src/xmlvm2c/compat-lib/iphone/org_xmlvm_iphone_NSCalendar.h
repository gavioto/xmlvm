...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSCalendar, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSCalendar)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSCalendar 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSCalendar_components___int_org_xmlvm_iphone_NSDate 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSCalendar_components___int_org_xmlvm_iphone_NSDate_org_xmlvm_iphone_NSData_int 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSCalendar_dateByAddingComponents___org_xmlvm_iphone_NSDateComponents_org_xmlvm_iphone_NSDate_int 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSCalendar_dateFromComponents___org_xmlvm_iphone_NSDateComponents 9
