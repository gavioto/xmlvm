...
void __INIT_IMPL_org_xmlvm_iphone_NSCalendar()
{
    if (!__TIB_org_xmlvm_iphone_NSCalendar.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSCalendar.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSCalendar_components___int_org_xmlvm_iphone_NSDate;
        __TIB_org_xmlvm_iphone_NSCalendar.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSCalendar_components___int_org_xmlvm_iphone_NSDate_org_xmlvm_iphone_NSData_int;
        __TIB_org_xmlvm_iphone_NSCalendar.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSCalendar_dateByAddingComponents___org_xmlvm_iphone_NSDateComponents_org_xmlvm_iphone_NSDate_int;
        __TIB_org_xmlvm_iphone_NSCalendar.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSCalendar_dateFromComponents___org_xmlvm_iphone_NSDateComponents;
