...
void __INIT_IMPL_org_xmlvm_iphone_NSErrorHolder()
{
    if (!__TIB_org_xmlvm_iphone_NSErrorHolder.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSErrorHolder.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSErrorHolder_description__;
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_NSErrorHolder()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSErrorHolder(me);
