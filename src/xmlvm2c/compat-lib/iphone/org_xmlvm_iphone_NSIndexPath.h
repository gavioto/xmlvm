...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSIndexPath, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSIndexPath)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSIndexPath 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSIndexPath_getSection__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSIndexPath_getRow__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSIndexPath_setSection___int 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSIndexPath_setRow___int 9
