...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_NSIndexPath);
    if (!__TIB_org_xmlvm_iphone_NSIndexPath.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_NSIndexPath();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_NSIndexPath);
}

void __INIT_IMPL_org_xmlvm_iphone_NSIndexPath()
{
    if (!__TIB_org_xmlvm_iphone_NSIndexPath.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSIndexPath.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSIndexPath_getSection__;
        __TIB_org_xmlvm_iphone_NSIndexPath.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSIndexPath_getRow__;
        __TIB_org_xmlvm_iphone_NSIndexPath.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSIndexPath_setSection___int;
        __TIB_org_xmlvm_iphone_NSIndexPath.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSIndexPath_setRow___int;
