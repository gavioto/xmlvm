...
void __INIT_IMPL_org_xmlvm_iphone_NSMutableData()
{
    if (!__TIB_org_xmlvm_iphone_NSMutableData.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSMutableData.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSMutableData_byteCount__;
        __TIB_org_xmlvm_iphone_NSMutableData.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_NSMutableData_getByte___int;
        __TIB_org_xmlvm_iphone_NSMutableData.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_NSMutableData_appendByte___int;
        __TIB_org_xmlvm_iphone_NSMutableData.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_NSMutableData_appendBytes___byte_1ARRAY;
