...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_NSNumberFormatter);
    if (!__TIB_org_xmlvm_iphone_NSNumberFormatter.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_NSNumberFormatter();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_NSNumberFormatter);
}

void __INIT_IMPL_org_xmlvm_iphone_NSNumberFormatter()
{
    if (!__TIB_org_xmlvm_iphone_NSNumberFormatter.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSNumberFormatter.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSNumberFormatter_setNumberStyle___int;
        __TIB_org_xmlvm_iphone_NSNumberFormatter.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSNumberFormatter_numberStyle__;
        __TIB_org_xmlvm_iphone_NSNumberFormatter.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSNumberFormatter_maximumFractionDigits__;
        __TIB_org_xmlvm_iphone_NSNumberFormatter.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSNumberFormatter_setMaximumFractionDigits___int;
