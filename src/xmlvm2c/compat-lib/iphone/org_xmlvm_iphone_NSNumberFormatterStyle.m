...
void __INIT_IMPL_org_xmlvm_iphone_NSNumberFormatterStyle()
{
    if (!__TIB_org_xmlvm_iphone_NSNumberFormatterStyle.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_NSNumberFormatterStyle_NoStyle = 0;
        ...
        __CLASS_org_xmlvm_iphone_NSNumberFormatterStyle_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSNumberFormatterStyle, 3);
        __CLASS_org_xmlvm_iphone_NSNumberFormatterStyle_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSNumberFormatterStyle, 2);
        __CLASS_org_xmlvm_iphone_NSNumberFormatterStyle_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSNumberFormatterStyle, 1);
