...
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSObject_retain__ 3
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSObject_release__ 4
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSObject_dealloc__ 5
