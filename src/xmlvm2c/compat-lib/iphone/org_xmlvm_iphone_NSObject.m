...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_NSObject);
    if (!__TIB_org_xmlvm_iphone_NSObject.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_NSObject();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_NSObject);
}

void __INIT_IMPL_org_xmlvm_iphone_NSObject()
{
    if (!__TIB_org_xmlvm_iphone_NSObject.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSObject.vtable[3] = (VTABLE_PTR) &org_xmlvm_iphone_NSObject_retain__;
        __TIB_org_xmlvm_iphone_NSObject.vtable[4] = (VTABLE_PTR) &org_xmlvm_iphone_NSObject_release__;
        __TIB_org_xmlvm_iphone_NSObject.vtable[5] = (VTABLE_PTR) &org_xmlvm_iphone_NSObject_dealloc__;
