...
void __INIT_IMPL_org_xmlvm_iphone_NSTimeZone()
{
    if (!__TIB_org_xmlvm_iphone_NSTimeZone.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSTimeZone.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSTimeZone_name__;
        __TIB_org_xmlvm_iphone_NSTimeZone.vtable[2] = (VTABLE_PTR) &org_xmlvm_iphone_NSTimeZone_toString__;
        ...
        __CLASS_org_xmlvm_iphone_NSTimeZone_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSTimeZone, 3);
        __CLASS_org_xmlvm_iphone_NSTimeZone_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSTimeZone, 2);
        __CLASS_org_xmlvm_iphone_NSTimeZone_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSTimeZone, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_NSTimeZone()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSTimeZone(me);
