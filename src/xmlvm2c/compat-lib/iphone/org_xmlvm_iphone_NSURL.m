...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_NSURL);
    if (!__TIB_org_xmlvm_iphone_NSURL.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_NSURL();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_NSURL);
}

void __INIT_IMPL_org_xmlvm_iphone_NSURL()
{
    if (!__TIB_org_xmlvm_iphone_NSURL.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSURL.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSURL_absoluteString__;
        ...
        __CLASS_org_xmlvm_iphone_NSURL_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSURL, 3);
        __CLASS_org_xmlvm_iphone_NSURL_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSURL, 2);
        __CLASS_org_xmlvm_iphone_NSURL_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSURL, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_NSURL()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSURL(me);
