...
void __INIT_IMPL_org_xmlvm_iphone_NSUserDefaults()
{
    if (!__TIB_org_xmlvm_iphone_NSUserDefaults.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_objectForKey___java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_setObject___java_lang_Object_java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_setInteger___int_java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_integerForKey___java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_synchronize__;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_setBool___boolean_java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_boolForKey___java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_setFloat___float_java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_floatForKey___java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_dataForKey___java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[16] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_stringForKey___java_lang_String;
        __TIB_org_xmlvm_iphone_NSUserDefaults.vtable[17] = (VTABLE_PTR) &org_xmlvm_iphone_NSUserDefaults_remove___java_lang_String;
        ...
        __CLASS_org_xmlvm_iphone_NSUserDefaults_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSUserDefaults, 3);
        __CLASS_org_xmlvm_iphone_NSUserDefaults_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSUserDefaults, 2);
        __CLASS_org_xmlvm_iphone_NSUserDefaults_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSUserDefaults, 1);
