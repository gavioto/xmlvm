...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSXMLParser, 12, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSXMLParser)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSXMLParser 12
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSXMLParser_setDelegate___org_xmlvm_iphone_NSXMLParserDelegate 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSXMLParser_setShouldProcessNamespaces___boolean 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSXMLParser_shouldProcessNamespaces__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSXMLParser_setShouldReportNamespacePrefixes___boolean 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSXMLParser_shouldReportNamespacePrefixes__ 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSXMLParser_parse__ 11
