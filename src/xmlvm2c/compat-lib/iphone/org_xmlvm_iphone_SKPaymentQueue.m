...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_SKPaymentQueue);
    if (!__TIB_org_xmlvm_iphone_SKPaymentQueue.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_SKPaymentQueue();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_SKPaymentQueue);
}

void __INIT_IMPL_org_xmlvm_iphone_SKPaymentQueue()
{
    if (!__TIB_org_xmlvm_iphone_SKPaymentQueue.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKPaymentQueue.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentQueue_addTransactionObserver___org_xmlvm_iphone_SKPaymentTransactionObserver;
        __TIB_org_xmlvm_iphone_SKPaymentQueue.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentQueue_removeTransactionObserver___org_xmlvm_iphone_SKPaymentTransactionObserver;
        __TIB_org_xmlvm_iphone_SKPaymentQueue.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentQueue_getTransactions__;
        __TIB_org_xmlvm_iphone_SKPaymentQueue.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentQueue_addPayment___org_xmlvm_iphone_SKPayment;
        __TIB_org_xmlvm_iphone_SKPaymentQueue.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentQueue_finishTransaction___org_xmlvm_iphone_SKPaymentTransaction;
        __TIB_org_xmlvm_iphone_SKPaymentQueue.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentQueue_restoreCompletedTransactions__;
        ...
        __CLASS_org_xmlvm_iphone_SKPaymentQueue_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentQueue, 3);
        __CLASS_org_xmlvm_iphone_SKPaymentQueue_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentQueue, 2);
        __CLASS_org_xmlvm_iphone_SKPaymentQueue_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentQueue, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_SKPaymentQueue()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SKPaymentQueue(me);
