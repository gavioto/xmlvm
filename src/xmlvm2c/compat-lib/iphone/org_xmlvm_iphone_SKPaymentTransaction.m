...
void __INIT_IMPL_org_xmlvm_iphone_SKPaymentTransaction()
{
    if (!__TIB_org_xmlvm_iphone_SKPaymentTransaction.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getError__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getOriginalTransaction__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getPayment__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getTransactionDate__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getTransactionIdentifier__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getTransactionReceipt__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getTransactionState__;
