...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_SKPaymentTransaction);
    if (!__TIB_org_xmlvm_iphone_SKPaymentTransaction.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_SKPaymentTransaction();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_SKPaymentTransaction);
}

void __INIT_IMPL_org_xmlvm_iphone_SKPaymentTransaction()
{
    if (!__TIB_org_xmlvm_iphone_SKPaymentTransaction.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getError__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getOriginalTransaction__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getPayment__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getTransactionDate__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[13] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getTransactionIdentifier__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[14] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getTransactionReceipt__;
        __TIB_org_xmlvm_iphone_SKPaymentTransaction.vtable[15] = (VTABLE_PTR) &org_xmlvm_iphone_SKPaymentTransaction_getTransactionState__;
        ...
        __CLASS_org_xmlvm_iphone_SKPaymentTransaction_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentTransaction, 3);
        __CLASS_org_xmlvm_iphone_SKPaymentTransaction_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentTransaction, 2);
        __CLASS_org_xmlvm_iphone_SKPaymentTransaction_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKPaymentTransaction, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_SKPaymentTransaction()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SKPaymentTransaction(me);
