...
void __INIT_IMPL_org_xmlvm_iphone_SKProduct()
{
    if (!__TIB_org_xmlvm_iphone_SKProduct.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKProduct.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_SKProduct_getLocalizedDescription__;
        __TIB_org_xmlvm_iphone_SKProduct.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_SKProduct_getLocalizedTitle__;
        __TIB_org_xmlvm_iphone_SKProduct.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_SKProduct_getPrice__;
        __TIB_org_xmlvm_iphone_SKProduct.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_SKProduct_getPriceLocale__;
        __TIB_org_xmlvm_iphone_SKProduct.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_SKProduct_getProductIdentifier__;
