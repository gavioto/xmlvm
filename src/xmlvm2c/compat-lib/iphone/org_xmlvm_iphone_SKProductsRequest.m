...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_SKProductsRequest);
    if (!__TIB_org_xmlvm_iphone_SKProductsRequest.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_SKProductsRequest();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_SKProductsRequest);
}

void __INIT_IMPL_org_xmlvm_iphone_SKProductsRequest()
{
    if (!__TIB_org_xmlvm_iphone_SKProductsRequest.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_SKProductsRequest.classInitializationBegan = 1;

        // Initialize base class if necessary
        if (!__TIB_org_xmlvm_iphone_SKRequest.classInitialized) __INIT_IMPL_org_xmlvm_iphone_SKRequest();
        ...
        __TIB_org_xmlvm_iphone_SKProductsRequest.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_SKProductsRequest_getProductsDelegate__;
        __TIB_org_xmlvm_iphone_SKProductsRequest.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_SKProductsRequest_setProductsDelegate___org_xmlvm_iphone_SKProductsRequestDelegate;
        ...
        __CLASS_org_xmlvm_iphone_SKProductsRequest_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsRequest, 3);
        __CLASS_org_xmlvm_iphone_SKProductsRequest_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsRequest, 2);
        __CLASS_org_xmlvm_iphone_SKProductsRequest_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsRequest, 1);
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_SKProductsRequest()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SKProductsRequest(me);
