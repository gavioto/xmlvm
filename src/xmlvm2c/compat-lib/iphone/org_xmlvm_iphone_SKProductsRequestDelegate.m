...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_SKProductsRequestDelegate);
    if (!__TIB_org_xmlvm_iphone_SKProductsRequestDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_SKProductsRequestDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_SKProductsRequestDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_SKProductsRequestDelegate()
{
    if (!__TIB_org_xmlvm_iphone_SKProductsRequestDelegate.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_SKProductsRequestDelegate_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsRequestDelegate, 3);
        __CLASS_org_xmlvm_iphone_SKProductsRequestDelegate_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsRequestDelegate, 2);
        __CLASS_org_xmlvm_iphone_SKProductsRequestDelegate_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsRequestDelegate, 1);
