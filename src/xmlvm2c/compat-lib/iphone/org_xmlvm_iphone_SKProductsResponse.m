...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_SKProductsResponse_1ARRAY;
...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_SKProductsResponse);
    if (!__TIB_org_xmlvm_iphone_SKProductsResponse.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_SKProductsResponse();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_SKProductsResponse);
}

void __INIT_IMPL_org_xmlvm_iphone_SKProductsResponse()
{
    if (!__TIB_org_xmlvm_iphone_SKProductsResponse.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_SKProductsResponse.classInitializationBegan = 1;
        ...
        __TIB_org_xmlvm_iphone_SKProductsResponse.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_SKProductsResponse_getInvalidProductIdentifiers__;
        __TIB_org_xmlvm_iphone_SKProductsResponse.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_SKProductsResponse_getProducts__;
        ...
        __CLASS_org_xmlvm_iphone_SKProductsResponse_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsResponse, 3);
        __CLASS_org_xmlvm_iphone_SKProductsResponse_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsResponse, 2);
        __CLASS_org_xmlvm_iphone_SKProductsResponse_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsResponse, 1);
