...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_SKRequest, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_SKRequest)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_SKRequest 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKRequest_start__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKRequest_cancel__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKRequest_getDelegate__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKRequest_setDelegate___org_xmlvm_iphone_SKRequestDelegate 9
