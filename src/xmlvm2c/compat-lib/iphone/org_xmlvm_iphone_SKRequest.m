...
void __INIT_IMPL_org_xmlvm_iphone_SKRequest()
{
    if (!__TIB_org_xmlvm_iphone_SKRequest.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKRequest.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_SKRequest_start__;
        __TIB_org_xmlvm_iphone_SKRequest.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_SKRequest_cancel__;
        __TIB_org_xmlvm_iphone_SKRequest.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_SKRequest_getDelegate__;
        __TIB_org_xmlvm_iphone_SKRequest.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_SKRequest_setDelegate___org_xmlvm_iphone_SKRequestDelegate;
