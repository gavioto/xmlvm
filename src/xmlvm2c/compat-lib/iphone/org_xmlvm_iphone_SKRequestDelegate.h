...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_SKRequestDelegate, 5, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_SKRequestDelegate)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_SKRequestDelegate 5
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKRequestDelegate_requestDidFailWithError___org_xmlvm_iphone_SKRequest_org_xmlvm_iphone_NSError 3
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_SKRequestDelegate_requestDidFinish___org_xmlvm_iphone_SKRequest 4
