...
void __INIT_IMPL_org_xmlvm_iphone_SKRequestDelegate()
{
    if (!__TIB_org_xmlvm_iphone_SKRequestDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_SKRequestDelegate.vtable[3] = (VTABLE_PTR) &org_xmlvm_iphone_SKRequestDelegate_requestDidFailWithError___org_xmlvm_iphone_SKRequest_org_xmlvm_iphone_NSError;
        __TIB_org_xmlvm_iphone_SKRequestDelegate.vtable[4] = (VTABLE_PTR) &org_xmlvm_iphone_SKRequestDelegate_requestDidFinish___org_xmlvm_iphone_SKRequest;
