...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIAcceleration, 9, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIAcceleration)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIAcceleration 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIAcceleration_x__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIAcceleration_y__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIAcceleration_z__ 8
