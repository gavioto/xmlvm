...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIAccelerometer, 8, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIAccelerometer)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIAccelerometer 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIAccelerometer_setUpdateInterval___double 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIAccelerometer_setDelegate___org_xmlvm_iphone_UIAccelerometerDelegate 7
