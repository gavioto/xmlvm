...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIAccelerometer);
    if (!__TIB_org_xmlvm_iphone_UIAccelerometer.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIAccelerometer();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIAccelerometer);
}

void __INIT_IMPL_org_xmlvm_iphone_UIAccelerometer()
{
    if (!__TIB_org_xmlvm_iphone_UIAccelerometer.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIAccelerometer.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIAccelerometer_setUpdateInterval___double;
        __TIB_org_xmlvm_iphone_UIAccelerometer.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIAccelerometer_setDelegate___org_xmlvm_iphone_UIAccelerometerDelegate;
        ...
        __CLASS_org_xmlvm_iphone_UIAccelerometer_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIAccelerometer, 3);
        __CLASS_org_xmlvm_iphone_UIAccelerometer_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIAccelerometer, 2);
        __CLASS_org_xmlvm_iphone_UIAccelerometer_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIAccelerometer, 1);
