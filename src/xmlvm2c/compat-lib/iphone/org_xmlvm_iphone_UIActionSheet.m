...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIActionSheet);
    if (!__TIB_org_xmlvm_iphone_UIActionSheet.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIActionSheet();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIActionSheet);
}

void __INIT_IMPL_org_xmlvm_iphone_UIActionSheet()
{
    if (!__TIB_org_xmlvm_iphone_UIActionSheet.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIActionSheet.vtable[62] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheet_showFromTabBar___org_xmlvm_iphone_UITabBar;
        __TIB_org_xmlvm_iphone_UIActionSheet.vtable[63] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheet_showFromToolbar___org_xmlvm_iphone_UIToolbar;
        __TIB_org_xmlvm_iphone_UIActionSheet.vtable[64] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheet_showInView___org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_UIActionSheet.vtable[65] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheet_dismissWithClickedButtonIndex___int_boolean;
