...
void __INIT_IMPL_org_xmlvm_iphone_UIActionSheet()
{
    if (!__TIB_org_xmlvm_iphone_UIActionSheet.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIActionSheet.vtable[65] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheet_showFromTabBar___org_xmlvm_iphone_UITabBar;
        __TIB_org_xmlvm_iphone_UIActionSheet.vtable[66] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheet_showFromToolbar___org_xmlvm_iphone_UIToolbar;
        __TIB_org_xmlvm_iphone_UIActionSheet.vtable[67] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheet_showInView___org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_UIActionSheet.vtable[68] = (VTABLE_PTR) &org_xmlvm_iphone_UIActionSheet_dismissWithClickedButtonIndex___int_boolean;
