...
void __INIT_IMPL_org_xmlvm_iphone_UIActivityIndicatorView()
{
    if (!__TIB_org_xmlvm_iphone_UIActivityIndicatorView.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIActivityIndicatorView.vtable[62] = (VTABLE_PTR) &org_xmlvm_iphone_UIActivityIndicatorView_setActivityIndicatorViewStyle___int;
        __TIB_org_xmlvm_iphone_UIActivityIndicatorView.vtable[63] = (VTABLE_PTR) &org_xmlvm_iphone_UIActivityIndicatorView_getActivityIndicatorViewStyle__;
        __TIB_org_xmlvm_iphone_UIActivityIndicatorView.vtable[64] = (VTABLE_PTR) &org_xmlvm_iphone_UIActivityIndicatorView_setHidesWhenStopped___boolean;
        __TIB_org_xmlvm_iphone_UIActivityIndicatorView.vtable[65] = (VTABLE_PTR) &org_xmlvm_iphone_UIActivityIndicatorView_getHidesWhenStopped__;
        __TIB_org_xmlvm_iphone_UIActivityIndicatorView.vtable[66] = (VTABLE_PTR) &org_xmlvm_iphone_UIActivityIndicatorView_startAnimating__;
        __TIB_org_xmlvm_iphone_UIActivityIndicatorView.vtable[67] = (VTABLE_PTR) &org_xmlvm_iphone_UIActivityIndicatorView_stopAnimating__;
