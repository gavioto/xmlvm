...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIActivityIndicatorViewStyle);
    if (!__TIB_org_xmlvm_iphone_UIActivityIndicatorViewStyle.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIActivityIndicatorViewStyle();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIActivityIndicatorViewStyle);
}

void __INIT_IMPL_org_xmlvm_iphone_UIActivityIndicatorViewStyle()
{
    if (!__TIB_org_xmlvm_iphone_UIActivityIndicatorViewStyle.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_UIActivityIndicatorViewStyle.classInitializationBegan = 1;
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UIActivityIndicatorViewStyle_WhiteLarge = 0;
