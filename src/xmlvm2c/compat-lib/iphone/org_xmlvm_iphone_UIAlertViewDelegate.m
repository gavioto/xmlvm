...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIAlertViewDelegate);
    if (!__TIB_org_xmlvm_iphone_UIAlertViewDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIAlertViewDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIAlertViewDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_UIAlertViewDelegate()
{
    if (!__TIB_org_xmlvm_iphone_UIAlertViewDelegate.classInitializationBegan) {
