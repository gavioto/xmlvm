...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIEvent);
    if (!__TIB_org_xmlvm_iphone_UIEvent.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIEvent();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIEvent);
}

void __INIT_IMPL_org_xmlvm_iphone_UIEvent()
{
    if (!__TIB_org_xmlvm_iphone_UIEvent.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIEvent.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIEvent_allTouches__;
        ...
        __CLASS_org_xmlvm_iphone_UIEvent_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIEvent, 3);
        __CLASS_org_xmlvm_iphone_UIEvent_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIEvent, 2);
        __CLASS_org_xmlvm_iphone_UIEvent_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIEvent, 1);
