...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIFont, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIFont)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIFont 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIFont_fontWithSize___float 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIFont_familyName__ 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIFont_fontName__ 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIFont_pointSize__ 9
