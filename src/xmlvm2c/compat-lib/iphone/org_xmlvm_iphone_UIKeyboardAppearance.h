...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIKeyboardAppearance, 3, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIKeyboardAppearance)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIKeyboardAppearance 3
