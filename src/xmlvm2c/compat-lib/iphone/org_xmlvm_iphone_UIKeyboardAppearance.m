...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIKeyboardAppearance);
    if (!__TIB_org_xmlvm_iphone_UIKeyboardAppearance.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIKeyboardAppearance();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIKeyboardAppearance);
}

void __INIT_IMPL_org_xmlvm_iphone_UIKeyboardAppearance()
{
    if (!__TIB_org_xmlvm_iphone_UIKeyboardAppearance.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UIKeyboardAppearance_Default = 0;
        ...
        __CLASS_org_xmlvm_iphone_UIKeyboardAppearance_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIKeyboardAppearance, 3);
        __CLASS_org_xmlvm_iphone_UIKeyboardAppearance_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIKeyboardAppearance, 2);
        __CLASS_org_xmlvm_iphone_UIKeyboardAppearance_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIKeyboardAppearance, 1);
