...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UILineBreakMode, 3, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UILineBreakMode)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UILineBreakMode 3
