...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_3ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_2ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_1ARRAY;
...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIPreferencesTableCell);
    if (!__TIB_org_xmlvm_iphone_UIPreferencesTableCell.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIPreferencesTableCell();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIPreferencesTableCell);
}

void __INIT_IMPL_org_xmlvm_iphone_UIPreferencesTableCell()
{
    if (!__TIB_org_xmlvm_iphone_UIPreferencesTableCell.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_UIPreferencesTableCell.classInitializationBegan = 1;
        ...
        __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[62] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_setTitle___java_lang_String;
        __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[63] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_getTitle__;
        __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[64] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_setEnabled___boolean;
        __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[65] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_setGroupCell___boolean;
        __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[66] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_isGroupCell__;
        ...
        __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTableCell, 3);
        __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTableCell, 2);
        __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTableCell, 1);
