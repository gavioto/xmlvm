...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_3ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_2ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_1ARRAY;
...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        org_xmlvm_iphone_UIPreferencesTextTableCell_setValue___java_lang_String(receiver, argsArray[0]);
        break;
    case 1:
        org_xmlvm_iphone_UIPreferencesTextTableCell_getValue__(receiver);
        break;
    case 2:
        org_xmlvm_iphone_UIPreferencesTextTableCell_xmlvmKeyTyped___char(receiver, ((java_lang_Character*) argsArray[0])->fields.java_lang_Character.value_);
        break;
    default:
        XMLVM_INTERNAL_ERROR();
        break;
...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIPreferencesTextTableCell);
    if (!__TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIPreferencesTextTableCell();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIPreferencesTextTableCell);
}

void __INIT_IMPL_org_xmlvm_iphone_UIPreferencesTextTableCell()
{
    if (!__TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.classInitializationBegan = 1;

        // Initialize base class if necessary
        if (!__TIB_org_xmlvm_iphone_UIPreferencesTableCell.classInitialized) __INIT_IMPL_org_xmlvm_iphone_UIPreferencesTableCell();
        ...
        __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.vtable[67] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTextTableCell_setValue___java_lang_String;
        __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.vtable[68] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTextTableCell_getValue__;
        __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.vtable[69] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTextTableCell_xmlvmKeyTyped___char;
        ...
        __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.methodDispatcherFunc = method_dispatcher;
        __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.declaredMethods = &__method_reflection_data[0];
        __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.numDeclaredMethods = sizeof(__method_reflection_data) / sizeof(XMLVM_METHOD_REFLECTION_DATA);
        ...
        __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell, 3);
        __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell, 2);
        __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell, 1);
