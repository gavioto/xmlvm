...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIResponder);
    if (!__TIB_org_xmlvm_iphone_UIResponder.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIResponder();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIResponder);
}

void __INIT_IMPL_org_xmlvm_iphone_UIResponder()
{
    if (!__TIB_org_xmlvm_iphone_UIResponder.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIResponder.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIResponder_touchesBegan___java_util_Set_org_xmlvm_iphone_UIEvent;
        __TIB_org_xmlvm_iphone_UIResponder.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIResponder_touchesCancelled___java_util_Set_org_xmlvm_iphone_UIEvent;
        ...
        __TIB_org_xmlvm_iphone_UIResponder.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UIResponder_touchesMoved___java_util_Set_org_xmlvm_iphone_UIEvent;
        __TIB_org_xmlvm_iphone_UIResponder.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_UIResponder_getNextResponder__;
        __TIB_org_xmlvm_iphone_UIResponder.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_UIResponder_resignFirstResponder__;
        __TIB_org_xmlvm_iphone_UIResponder.vtable[12] = (VTABLE_PTR) &org_xmlvm_iphone_UIResponder_becomeFirstResponder__;
