...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIScreen, 8, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIScreen)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIScreen 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIScreen_getBounds__ 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIScreen_getApplicationFrame__ 7
