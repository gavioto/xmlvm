...
void __INIT_IMPL_org_xmlvm_iphone_UISegmentedControl()
{
    if (!__TIB_org_xmlvm_iphone_UISegmentedControl.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UISegmentedControl.vtable[70] = (VTABLE_PTR) &org_xmlvm_iphone_UISegmentedControl_setTitle___java_lang_String_int;
        __TIB_org_xmlvm_iphone_UISegmentedControl.vtable[71] = (VTABLE_PTR) &org_xmlvm_iphone_UISegmentedControl_titleForSegmentAtIndex___int;
        __TIB_org_xmlvm_iphone_UISegmentedControl.vtable[72] = (VTABLE_PTR) &org_xmlvm_iphone_UISegmentedControl_setImage___org_xmlvm_iphone_UIImage_int;
        __TIB_org_xmlvm_iphone_UISegmentedControl.vtable[73] = (VTABLE_PTR) &org_xmlvm_iphone_UISegmentedControl_imageForSegmentAtIndex___int;
