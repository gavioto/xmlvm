...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITabBarDelegate);
    if (!__TIB_org_xmlvm_iphone_UITabBarDelegate.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITabBarDelegate();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITabBarDelegate);
}

void __INIT_IMPL_org_xmlvm_iphone_UITabBarDelegate()
{
    if (!__TIB_org_xmlvm_iphone_UITabBarDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UITabBarDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarDelegate_willBeginCustomizingItems___org_xmlvm_iphone_UITabBar_java_util_ArrayList;
        __TIB_org_xmlvm_iphone_UITabBarDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarDelegate_didBeginCustomizingItems___org_xmlvm_iphone_UITabBar_java_util_ArrayList;
        __TIB_org_xmlvm_iphone_UITabBarDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarDelegate_willEndCustomizingItems___org_xmlvm_iphone_UITabBar_java_util_ArrayList_boolean;
        __TIB_org_xmlvm_iphone_UITabBarDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UITabBarDelegate_didEndCustomizingItems___org_xmlvm_iphone_UITabBar_java_util_ArrayList_boolean;
