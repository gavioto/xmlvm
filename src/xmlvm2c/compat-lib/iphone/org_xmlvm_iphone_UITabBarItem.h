...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UITabBarItem, 21, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UITabBarItem)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UITabBarItem 21
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITabBarItem_getBadgeValue__ 19
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITabBarItem_setBadgeValue___java_lang_String 20
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITabBarItem_setTitle___java_lang_String 15
