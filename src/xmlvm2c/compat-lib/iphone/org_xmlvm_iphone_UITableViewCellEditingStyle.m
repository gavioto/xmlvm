...
void __INIT_IMPL_org_xmlvm_iphone_UITableViewCellEditingStyle()
{
    if (!__TIB_org_xmlvm_iphone_UITableViewCellEditingStyle.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UITableViewCellEditingStyle_None = 0;
        ...
        __CLASS_org_xmlvm_iphone_UITableViewCellEditingStyle_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellEditingStyle, 3);
        __CLASS_org_xmlvm_iphone_UITableViewCellEditingStyle_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellEditingStyle, 2);
        __CLASS_org_xmlvm_iphone_UITableViewCellEditingStyle_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellEditingStyle, 1);
