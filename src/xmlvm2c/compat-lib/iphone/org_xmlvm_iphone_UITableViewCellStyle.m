...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UITableViewCellStyle_3ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UITableViewCellStyle_2ARRAY;
JAVA_OBJECT __CLASS_org_xmlvm_iphone_UITableViewCellStyle_1ARRAY;
...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITableViewCellStyle);
    if (!__TIB_org_xmlvm_iphone_UITableViewCellStyle.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITableViewCellStyle();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITableViewCellStyle);
}

void __INIT_IMPL_org_xmlvm_iphone_UITableViewCellStyle()
{
    if (!__TIB_org_xmlvm_iphone_UITableViewCellStyle.classInitializationBegan) {
        __TIB_org_xmlvm_iphone_UITableViewCellStyle.classInitializationBegan = 1;
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UITableViewCellStyle_Default = 0;
        ...
        __CLASS_org_xmlvm_iphone_UITableViewCellStyle_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellStyle, 3);
        __CLASS_org_xmlvm_iphone_UITableViewCellStyle_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellStyle, 2);
        __CLASS_org_xmlvm_iphone_UITableViewCellStyle_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellStyle, 1);
