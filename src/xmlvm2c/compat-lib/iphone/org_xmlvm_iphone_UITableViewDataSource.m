...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITableViewDataSource);
    if (!__TIB_org_xmlvm_iphone_UITableViewDataSource.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITableViewDataSource();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITableViewDataSource);
}

void __INIT_IMPL_org_xmlvm_iphone_UITableViewDataSource()
{
    if (!__TIB_org_xmlvm_iphone_UITableViewDataSource.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_UITableViewDataSource_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewDataSource, 3);
        __CLASS_org_xmlvm_iphone_UITableViewDataSource_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewDataSource, 2);
        __CLASS_org_xmlvm_iphone_UITableViewDataSource_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewDataSource, 1);
