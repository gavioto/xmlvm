...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITextField);
    if (!__TIB_org_xmlvm_iphone_UITextField.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITextField();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITextField);
}

void __INIT_IMPL_org_xmlvm_iphone_UITextField()
{
    if (!__TIB_org_xmlvm_iphone_UITextField.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UITextField.vtable[65] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getAutocapitalizationType__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[66] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setAutocapitalizationType___int;
        __TIB_org_xmlvm_iphone_UITextField.vtable[67] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getAutocorrectionType__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[68] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setAutocorrectionType___int;
        __TIB_org_xmlvm_iphone_UITextField.vtable[69] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_isEnablesReturnKeyAutomatically__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[70] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setEnablesReturnKeyAutomatically___boolean;
        __TIB_org_xmlvm_iphone_UITextField.vtable[71] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getKeyboardAppearance__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[72] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setKeyboardAppearance___int;
        __TIB_org_xmlvm_iphone_UITextField.vtable[73] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getKeyboardType__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[74] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setKeyboardType___int;
        __TIB_org_xmlvm_iphone_UITextField.vtable[75] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getReturnKeyType__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[76] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setReturnKeyType___int;
        __TIB_org_xmlvm_iphone_UITextField.vtable[77] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_isSecureTextEntry__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[78] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setSecureTextEntry___boolean;
        __TIB_org_xmlvm_iphone_UITextField.vtable[79] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setText___java_lang_String;
        __TIB_org_xmlvm_iphone_UITextField.vtable[80] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getText__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[81] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setTextColor___org_xmlvm_iphone_UIColor;
        __TIB_org_xmlvm_iphone_UITextField.vtable[82] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getTextColor__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[83] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setBorderStyle___int;
        __TIB_org_xmlvm_iphone_UITextField.vtable[84] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getBorderStyle__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[85] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getFont__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[86] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setFont___org_xmlvm_iphone_UIFont;
        __TIB_org_xmlvm_iphone_UITextField.vtable[87] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_isAdjustsFontSizeToFitWidth__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[88] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setAdjustsFontSizeToFitWidth___boolean;
        __TIB_org_xmlvm_iphone_UITextField.vtable[89] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getTextAlignment__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[90] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setTextAlignment___int;
        __TIB_org_xmlvm_iphone_UITextField.vtable[91] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_xmlvmKeyTyped___char;
        __TIB_org_xmlvm_iphone_UITextField.vtable[92] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setPlaceholder___java_lang_String;
        __TIB_org_xmlvm_iphone_UITextField.vtable[93] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getPlaceholder__;
        __TIB_org_xmlvm_iphone_UITextField.vtable[94] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_setDelegate___org_xmlvm_iphone_UITextFieldDelegate;
        __TIB_org_xmlvm_iphone_UITextField.vtable[95] = (VTABLE_PTR) &org_xmlvm_iphone_UITextField_getDelegate__;
        ...
        __CLASS_org_xmlvm_iphone_UITextField_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITextField, 3);
        __CLASS_org_xmlvm_iphone_UITextField_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITextField, 2);
        __CLASS_org_xmlvm_iphone_UITextField_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITextField, 1);
