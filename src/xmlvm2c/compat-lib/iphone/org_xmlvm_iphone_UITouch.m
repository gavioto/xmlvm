...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UITouch);
    if (!__TIB_org_xmlvm_iphone_UITouch.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UITouch();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UITouch);
}

void __INIT_IMPL_org_xmlvm_iphone_UITouch()
{
    if (!__TIB_org_xmlvm_iphone_UITouch.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UITouch.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UITouch_locationInView___org_xmlvm_iphone_UIView;
        __TIB_org_xmlvm_iphone_UITouch.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UITouch_getView__;
        __TIB_org_xmlvm_iphone_UITouch.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UITouch_getWindow__;
        __TIB_org_xmlvm_iphone_UITouch.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UITouch_getTapCount__;
        __TIB_org_xmlvm_iphone_UITouch.vtable[10] = (VTABLE_PTR) &org_xmlvm_iphone_UITouch_getTimestamp__;
        __TIB_org_xmlvm_iphone_UITouch.vtable[11] = (VTABLE_PTR) &org_xmlvm_iphone_UITouch_getPhase__;
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_UITouch()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UITouch(me);
