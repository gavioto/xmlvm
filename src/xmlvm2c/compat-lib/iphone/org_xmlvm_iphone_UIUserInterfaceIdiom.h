...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIUserInterfaceIdiom, 3, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIUserInterfaceIdiom)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIUserInterfaceIdiom 3
