...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIUserInterfaceIdiom);
    if (!__TIB_org_xmlvm_iphone_UIUserInterfaceIdiom.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIUserInterfaceIdiom();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIUserInterfaceIdiom);
}

void __INIT_IMPL_org_xmlvm_iphone_UIUserInterfaceIdiom()
{
    if (!__TIB_org_xmlvm_iphone_UIUserInterfaceIdiom.classInitializationBegan) {
        ...
        //Initialize interfaces if necessary and assign tib to implementedInterfaces        _STATIC_org_xmlvm_iphone_UIUserInterfaceIdiom_Phone = 0;
        ...
        __CLASS_org_xmlvm_iphone_UIUserInterfaceIdiom_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIUserInterfaceIdiom, 3);
        __CLASS_org_xmlvm_iphone_UIUserInterfaceIdiom_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIUserInterfaceIdiom, 2);
        __CLASS_org_xmlvm_iphone_UIUserInterfaceIdiom_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIUserInterfaceIdiom, 1);
