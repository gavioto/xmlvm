...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIViewGL);
    if (!__TIB_org_xmlvm_iphone_UIViewGL.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIViewGL();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIViewGL);
}

void __INIT_IMPL_org_xmlvm_iphone_UIViewGL()
{
    if (!__TIB_org_xmlvm_iphone_UIViewGL.classInitializationBegan) {
