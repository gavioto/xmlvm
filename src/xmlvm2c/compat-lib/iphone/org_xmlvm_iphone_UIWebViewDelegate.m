...
void __INIT_IMPL_org_xmlvm_iphone_UIWebViewDelegate()
{
    if (!__TIB_org_xmlvm_iphone_UIWebViewDelegate.classInitializationBegan) {
        ...
        __TIB_org_xmlvm_iphone_UIWebViewDelegate.vtable[6] = (VTABLE_PTR) &org_xmlvm_iphone_UIWebViewDelegate_didFailLoadWithError___org_xmlvm_iphone_UIWebView_org_xmlvm_iphone_NSError;
        __TIB_org_xmlvm_iphone_UIWebViewDelegate.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_UIWebViewDelegate_shouldStartLoadWithRequest___org_xmlvm_iphone_UIWebView_org_xmlvm_iphone_NSURLRequest_int;
        __TIB_org_xmlvm_iphone_UIWebViewDelegate.vtable[8] = (VTABLE_PTR) &org_xmlvm_iphone_UIWebViewDelegate_webViewDidFinishLoad___org_xmlvm_iphone_UIWebView;
        __TIB_org_xmlvm_iphone_UIWebViewDelegate.vtable[9] = (VTABLE_PTR) &org_xmlvm_iphone_UIWebViewDelegate_webViewDidStartLoad___org_xmlvm_iphone_UIWebView;
