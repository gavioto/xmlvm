...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ABPeoplePickerNavigationController___INIT___]
    ABPeoplePickerNavigationController* objCObj = [[ABPeoplePickerNavigationController alloc ] init];
    org_xmlvm_ios_ABPeoplePickerNavigationController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ABPeoplePickerNavigationController___INIT____org_xmlvm_ios_UIViewController]

    ABPeoplePickerNavigationController* objCObj = [[ABPeoplePickerNavigationController alloc] initWithRootViewController:(UIViewController*) (((org_xmlvm_ios_UIViewController*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_ABPeoplePickerNavigationController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    ABPeoplePickerNavigationController* objCObj = [[ABPeoplePickerNavigationController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ABPeoplePickerNavigationController_getDisplayedProperties__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz displayedProperties];
