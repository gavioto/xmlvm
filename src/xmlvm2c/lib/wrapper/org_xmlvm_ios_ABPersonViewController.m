...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ABPersonViewController___INIT___]
    ABPersonViewController* objCObj = [[ABPersonViewController alloc ] init];
    org_xmlvm_ios_ABPersonViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ABPersonViewController___INIT____java_lang_String_org_xmlvm_ios_NSBundle]
NSString * ObjCVar1 = toNSString(n1);
    
    ABPersonViewController* objCObj = [[ABPersonViewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ABPersonViewController_getShouldShowLinkedPeople__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz shouldShowLinkedPeople];
    return objCObj;
//XMLVM_END_WRAPPER
