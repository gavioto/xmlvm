...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ADInterstitialAd___INIT___]
    ADInterstitialAd* objCObj = [[ADInterstitialAd alloc ] init];
    org_xmlvm_ios_ADInterstitialAd_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ADInterstitialAd_isActionInProgress__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz isActionInProgress];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ADInterstitialAd_presentInView___org_xmlvm_ios_UIView]
    ...
    BOOL objCObj = [thiz  presentInView:(UIView*) (((org_xmlvm_ios_UIView*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
