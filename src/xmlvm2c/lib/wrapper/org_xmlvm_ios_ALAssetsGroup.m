...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ALAssetsGroup___INIT___]
    ALAssetsGroup* objCObj = [[ALAssetsGroup alloc ] init];
    org_xmlvm_ios_ALAssetsGroup_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ALAssetsGroup_posterImage__]
    ...
    CGImageRef objCObj = [thiz posterImage];    XMLVM_VAR_INIT_REF(CGImage, refVar, objCObj);
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_ALAssetsGroup_numberOfAssets__]
    ...
    int objCObj = [thiz numberOfAssets];
