...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVAssetReaderTrackOutput___INIT___]
    AVAssetReaderTrackOutput* objCObj = [[AVAssetReaderTrackOutput alloc ] init];
    org_xmlvm_ios_AVAssetReaderTrackOutput_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVAssetReaderTrackOutput_getTrack__]
    ...
    XMLVM_VAR_THIZ;
    AVAssetTrack* objCObj = [thiz track];    if (!__TIB_org_xmlvm_ios_AVAssetTrack.classInitialized) __INIT_org_xmlvm_ios_AVAssetTrack();
