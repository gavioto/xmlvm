...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVAssetReaderVideoCompositionOutput___INIT___]
    AVAssetReaderVideoCompositionOutput* objCObj = [[AVAssetReaderVideoCompositionOutput alloc ] init];
    org_xmlvm_ios_AVAssetReaderVideoCompositionOutput_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVAssetReaderVideoCompositionOutput_getVideoTracks__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz videoTracks];
