...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVAssetTrackSegment___INIT___]
    AVAssetTrackSegment* objCObj = [[AVAssetTrackSegment alloc ] init];
    org_xmlvm_ios_AVAssetTrackSegment_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVAssetTrackSegment_getTimeMapping__]
    ...
    XMLVM_VAR_THIZ;
    CMTimeMapping objCObj = [thiz timeMapping];
