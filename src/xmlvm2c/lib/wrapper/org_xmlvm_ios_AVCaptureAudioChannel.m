...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureAudioChannel___INIT___]
    AVCaptureAudioChannel* objCObj = [[AVCaptureAudioChannel alloc ] init];
    org_xmlvm_ios_AVCaptureAudioChannel_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureAudioChannel_getAveragePowerLevel__]
    ...
    XMLVM_VAR_THIZ;
    float objCObj = [thiz averagePowerLevel];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureAudioChannel_getPeakHoldLevel__]
    ...
    XMLVM_VAR_THIZ;
    float objCObj = [thiz peakHoldLevel];
    return objCObj;
//XMLVM_END_WRAPPER
