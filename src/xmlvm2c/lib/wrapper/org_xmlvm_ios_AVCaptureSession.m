...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureSession___INIT___]
    AVCaptureSession* objCObj = [[AVCaptureSession alloc ] init];
    org_xmlvm_ios_AVCaptureSession_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureSession_canSetSessionPreset___java_lang_String]
    ...
    BOOL objCObj = [thiz  canSetSessionPreset:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureSession_getSessionPreset__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz sessionPreset];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureSession_canAddInput___org_xmlvm_ios_AVCaptureInput]
    ...
    BOOL objCObj = [thiz  canAddInput:(AVCaptureInput*) (((org_xmlvm_ios_AVCaptureInput*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureSession_canAddOutput___org_xmlvm_ios_AVCaptureOutput]
    ...
    BOOL objCObj = [thiz  canAddOutput:(AVCaptureOutput*) (((org_xmlvm_ios_AVCaptureOutput*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureSession_isInterrupted__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz isInterrupted];
    return objCObj;
//XMLVM_END_WRAPPER
