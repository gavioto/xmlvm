...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureVideoDataOutput___INIT___]
    AVCaptureVideoDataOutput* objCObj = [[AVCaptureVideoDataOutput alloc ] init];
    org_xmlvm_ios_AVCaptureVideoDataOutput_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureVideoDataOutput_getSampleBufferCallbackQueue__]
    ...
    XMLVM_VAR_THIZ;
    NSObject* objCObj = [thiz sampleBufferCallbackQueue];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureVideoDataOutput_getMinFrameDuration__]
    ...
    XMLVM_VAR_THIZ;
    CMTime objCObj = [thiz minFrameDuration];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCaptureVideoDataOutput_getAlwaysDiscardsLateVideoFrames__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz alwaysDiscardsLateVideoFrames];
    return objCObj;
//XMLVM_END_WRAPPER
