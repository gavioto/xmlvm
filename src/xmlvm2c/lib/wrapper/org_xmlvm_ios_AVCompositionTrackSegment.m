...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCompositionTrackSegment___INIT____org_xmlvm_ios_NSURL_int_org_xmlvm_ios_CMTimeRange_org_xmlvm_ios_CMTimeRange]
    ...
    AVCompositionTrackSegment* objCObj = [[AVCompositionTrackSegment alloc] initWithURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) trackID:n2 sourceTimeRange:toCMTimeRange(n3) targetTimeRange:toCMTimeRange(n4)];
    org_xmlvm_ios_AVCompositionTrackSegment_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCompositionTrackSegment___INIT____org_xmlvm_ios_CMTimeRange]

    AVCompositionTrackSegment* objCObj = [[AVCompositionTrackSegment alloc] initWithTimeRange:toCMTimeRange(n1)];
    org_xmlvm_ios_AVCompositionTrackSegment_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCompositionTrackSegment___INIT___]
    AVCompositionTrackSegment* objCObj = [[AVCompositionTrackSegment alloc ] init];
    org_xmlvm_ios_AVCompositionTrackSegment_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVCompositionTrackSegment_getSourceTrackID__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz sourceTrackID];
    return objCObj;
//XMLVM_END_WRAPPER
