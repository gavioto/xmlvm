...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVMutableVideoCompositionLayerInstruction___INIT___]
    AVMutableVideoCompositionLayerInstruction* objCObj = [[AVMutableVideoCompositionLayerInstruction alloc ] init];
    org_xmlvm_ios_AVMutableVideoCompositionLayerInstruction_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
