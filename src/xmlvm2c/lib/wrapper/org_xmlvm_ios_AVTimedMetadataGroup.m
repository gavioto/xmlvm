...
NSArray * ObjCVar1 = toNSArray(n1);
    ...
    AVTimedMetadataGroup* objCObj = [[AVTimedMetadataGroup alloc] initWithItems:ObjCVar1 timeRange:toCMTimeRange(n2)];
    [ObjCVar1 release];

    org_xmlvm_ios_AVTimedMetadataGroup_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_AVTimedMetadataGroup___INIT___]
    AVTimedMetadataGroup* objCObj = [[AVTimedMetadataGroup alloc ] init];
    org_xmlvm_ios_AVTimedMetadataGroup_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
