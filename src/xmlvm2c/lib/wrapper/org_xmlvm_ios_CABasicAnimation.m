...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CABasicAnimation___INIT___]
    CABasicAnimation* objCObj = [[CABasicAnimation alloc ] init];
    org_xmlvm_ios_CABasicAnimation_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CABasicAnimation_getFromValue__]
    ...
    XMLVM_VAR_THIZ;
    NSObject* objCObj = [thiz fromValue];
    return xmlvm_get_associated_c_object (objCObj);
//XMLVM_END_WRAPPER
