...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAMediaTimingFunction___INIT____float_float_float_float]
    ...
    CAMediaTimingFunction* objCObj = [[CAMediaTimingFunction alloc] initWithControlPoints:n1 :n2 :n3 :n4];
    org_xmlvm_ios_CAMediaTimingFunction_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAMediaTimingFunction___INIT___]
    CAMediaTimingFunction* objCObj = [[CAMediaTimingFunction alloc ] init];
    org_xmlvm_ios_CAMediaTimingFunction_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [CAMediaTimingFunction  functionWithName:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAMediaTimingFunction_functionWithControlPoints___float_float_float_float]
    ...
    NSObject* objCObj =  [CAMediaTimingFunction  functionWithControlPoints:n1 :n2 :n3 :n4];
