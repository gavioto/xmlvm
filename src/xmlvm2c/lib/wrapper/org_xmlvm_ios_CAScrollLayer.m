...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAScrollLayer___INIT___]
    CAScrollLayer* objCObj = [[CAScrollLayer alloc ] init];
    org_xmlvm_ios_CAScrollLayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAScrollLayer___INIT____java_lang_Object]
    ...
    CAScrollLayer* objCObj = [[CAScrollLayer alloc] initWithLayer:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj];
    org_xmlvm_ios_CAScrollLayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAScrollLayer_getScrollMode__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz scrollMode];
