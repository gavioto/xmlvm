...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATiledLayer___INIT___]
    CATiledLayer* objCObj = [[CATiledLayer alloc ] init];
    org_xmlvm_ios_CATiledLayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATiledLayer___INIT____java_lang_Object]
    ...
    CATiledLayer* objCObj = [[CATiledLayer alloc] initWithLayer:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj];
    org_xmlvm_ios_CATiledLayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATiledLayer_fadeDuration__]
    ...
    double objCObj =  [CATiledLayer fadeDuration];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATiledLayer_getLevelsOfDetail__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz levelsOfDetail];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATiledLayer_getLevelsOfDetailBias__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz levelsOfDetailBias];
    return objCObj;
//XMLVM_END_WRAPPER
