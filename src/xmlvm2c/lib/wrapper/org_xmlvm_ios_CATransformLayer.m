...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATransformLayer___INIT___]
    CATransformLayer* objCObj = [[CATransformLayer alloc ] init];
    org_xmlvm_ios_CATransformLayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CATransformLayer___INIT____java_lang_Object]
    ...
    CATransformLayer* objCObj = [[CATransformLayer alloc] initWithLayer:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj];
    org_xmlvm_ios_CATransformLayer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
