...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CAValueFunction___INIT___]
    CAValueFunction* objCObj = [[CAValueFunction alloc ] init];
    org_xmlvm_ios_CAValueFunction_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [CAValueFunction  functionWithName:ObjCVar1];
    [ObjCVar1 release];
