...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    long objCObj = CFFTPCreateParsedResourceListing(var1,a2->fields.org_xmlvm_runtime_XMLVMArray.array_,n3,&var4);
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    CFRunLoopSourceRef objCObj = CFNetworkExecuteProxyAutoConfigurationScript(ObjCVar1,var2,((org_xmlvm_ios_NSObject*) n3)->fields.org_xmlvm_ios_NSObject.wrappedObj,&var4);
...
XMLVM_VAR_IOS_REF(CFURL, var1, n1);
    ...
    CFRunLoopSourceRef objCObj = CFNetworkExecuteProxyAutoConfigurationURL(var1,var2,((org_xmlvm_ios_NSObject*) n3)->fields.org_xmlvm_ios_NSObject.wrappedObj,&var4);
    org_xmlvm_ios_Reference_set___java_lang_Object(n4, fromCFStreamClientContext(var4));
        XMLVM_VAR_INIT_REF(CFRunLoopSource, refVar, objCObj);
