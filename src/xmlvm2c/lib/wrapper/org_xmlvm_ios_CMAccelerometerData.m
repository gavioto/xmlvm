...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CMAccelerometerData___INIT___]
    CMAccelerometerData* objCObj = [[CMAccelerometerData alloc ] init];
    org_xmlvm_ios_CMAccelerometerData_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CMAccelerometerData_getAcceleration__]
    ...
    XMLVM_VAR_THIZ;
    CMAcceleration objCObj = [thiz acceleration];
