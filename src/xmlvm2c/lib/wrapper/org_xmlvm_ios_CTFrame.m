...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CTFrame___INIT___]
    CTFrame* objCObj = [[CTFrame alloc ] init];
    org_xmlvm_ios_CTFrame_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CTFrame_getLineOrigins___org_xmlvm_ios_CFRange_org_xmlvm_ios_Reference<CGPoint>]
