...
XMLVM_VAR_IOS_REF(CFAllocator, var1, n1);
    ...
    CVPixelBuffer* objCObj = [[CVPixelBuffer alloc] create:var1];
    org_xmlvm_ios_CVPixelBuffer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_CVPixelBuffer___INIT___]
    CVPixelBuffer* objCObj = [[CVPixelBuffer alloc ] init];
    org_xmlvm_ios_CVPixelBuffer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
