...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_EAAccessoryManager___INIT___]
    EAAccessoryManager* objCObj = [[EAAccessoryManager alloc ] init];
    org_xmlvm_ios_EAAccessoryManager_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_EAAccessoryManager_sharedAccessoryManager__]
    ...
    EAAccessoryManager* objCObj =  [EAAccessoryManager sharedAccessoryManager];
    if (!__TIB_org_xmlvm_ios_EAAccessoryManager.classInitialized) __INIT_org_xmlvm_ios_EAAccessoryManager();
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_EAAccessoryManager_getConnectedAccessories__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz connectedAccessories];
