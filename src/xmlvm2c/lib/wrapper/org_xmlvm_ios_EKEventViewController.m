...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_EKEventViewController___INIT___]
    EKEventViewController* objCObj = [[EKEventViewController alloc ] init];
    org_xmlvm_ios_EKEventViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_EKEventViewController___INIT____java_lang_String_org_xmlvm_ios_NSBundle]
NSString * ObjCVar1 = toNSString(n1);
    
    EKEventViewController* objCObj = [[EKEventViewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_EKEventViewController_getAllowsCalendarPreview__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz allowsCalendarPreview];
    return objCObj;
//XMLVM_END_WRAPPER
