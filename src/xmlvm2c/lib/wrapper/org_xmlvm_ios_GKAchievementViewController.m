...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKAchievementViewController___INIT___]
    GKAchievementViewController* objCObj = [[GKAchievementViewController alloc ] init];
    org_xmlvm_ios_GKAchievementViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKAchievementViewController___INIT____org_xmlvm_ios_UIViewController]

    GKAchievementViewController* objCObj = [[GKAchievementViewController alloc] initWithRootViewController:(UIViewController*) (((org_xmlvm_ios_UIViewController*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_GKAchievementViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    GKAchievementViewController* objCObj = [[GKAchievementViewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
