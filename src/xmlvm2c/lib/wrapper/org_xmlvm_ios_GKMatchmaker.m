...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKMatchmaker___INIT___]
    GKMatchmaker* objCObj = [[GKMatchmaker alloc ] init];
    org_xmlvm_ios_GKMatchmaker_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKMatchmaker_sharedMatchmaker__]
    ...
    GKMatchmaker* objCObj =  [GKMatchmaker sharedMatchmaker];
    if (!__TIB_org_xmlvm_ios_GKMatchmaker.classInitialized) __INIT_org_xmlvm_ios_GKMatchmaker();
