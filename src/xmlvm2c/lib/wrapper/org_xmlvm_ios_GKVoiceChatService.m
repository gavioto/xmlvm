...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKVoiceChatService___INIT___]
    GKVoiceChatService* objCObj = [[GKVoiceChatService alloc ] init];
    org_xmlvm_ios_GKVoiceChatService_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKVoiceChatService_isVoIPAllowed__]
    ...
    BOOL objCObj =  [GKVoiceChatService isVoIPAllowed];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKVoiceChatService_isMicrophoneMuted__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz isMicrophoneMuted];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKVoiceChatService_getRemoteParticipantVolume__]
    ...
    XMLVM_VAR_THIZ;
    float objCObj = [thiz remoteParticipantVolume];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKVoiceChatService_isOutputMeteringEnabled__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz isOutputMeteringEnabled];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKVoiceChatService_isInputMeteringEnabled__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz isInputMeteringEnabled];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKVoiceChatService_getOutputMeterLevel__]
    ...
    XMLVM_VAR_THIZ;
    float objCObj = [thiz outputMeterLevel];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_GKVoiceChatService_getInputMeterLevel__]
    ...
    XMLVM_VAR_THIZ;
    float objCObj = [thiz inputMeterLevel];
    return objCObj;
//XMLVM_END_WRAPPER
