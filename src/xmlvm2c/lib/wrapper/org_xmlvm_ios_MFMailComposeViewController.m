...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MFMailComposeViewController___INIT___]
    MFMailComposeViewController* objCObj = [[MFMailComposeViewController alloc ] init];
    org_xmlvm_ios_MFMailComposeViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MFMailComposeViewController___INIT____org_xmlvm_ios_UIViewController]

    MFMailComposeViewController* objCObj = [[MFMailComposeViewController alloc] initWithRootViewController:(UIViewController*) (((org_xmlvm_ios_UIViewController*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_MFMailComposeViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    MFMailComposeViewController* objCObj = [[MFMailComposeViewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MFMailComposeViewController_canSendMail__]
    ...
    BOOL objCObj =  [MFMailComposeViewController canSendMail];
