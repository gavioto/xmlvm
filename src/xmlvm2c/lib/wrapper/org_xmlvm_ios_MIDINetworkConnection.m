...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDINetworkConnection___INIT___]
    MIDINetworkConnection* objCObj = [[MIDINetworkConnection alloc ] init];
    org_xmlvm_ios_MIDINetworkConnection_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDINetworkConnection_connectionWithHost___org_xmlvm_ios_MIDINetworkHost]
    ...
    NSObject* objCObj =  [MIDINetworkConnection  connectionWithHost:(MIDINetworkHost*) (((org_xmlvm_ios_MIDINetworkHost*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
