...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDISetup___INIT____org_xmlvm_ios_MIDISetup]
    ...
    MIDISetup* objCObj = [[MIDISetup alloc] create:(MIDISetup*) (((org_xmlvm_ios_MIDISetup*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_MIDISetup_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MIDISetup___INIT___]
    MIDISetup* objCObj = [[MIDISetup alloc ] init];
    org_xmlvm_ios_MIDISetup_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
