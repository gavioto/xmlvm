...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKCircleView___INIT____org_xmlvm_ios_MKCircle]
    ...
    MKCircleView* objCObj = [[MKCircleView alloc] initWithCircle:(MKCircle*) (((org_xmlvm_ios_MKCircle*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_MKCircleView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKCircleView___INIT___]
    MKCircleView* objCObj = [[MKCircleView alloc ] init];
    org_xmlvm_ios_MKCircleView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKCircleView___INIT____org_xmlvm_ios_CGRect]
    ...
    MKCircleView* objCObj = [[MKCircleView alloc] initWithFrame:toCGRect(n1)];
    org_xmlvm_ios_MKCircleView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKCircleView_getCircle__]
    ...
    XMLVM_VAR_THIZ;
    MKCircle* objCObj = [thiz circle];    if (!__TIB_org_xmlvm_ios_MKCircle.classInitialized) __INIT_org_xmlvm_ios_MKCircle();
