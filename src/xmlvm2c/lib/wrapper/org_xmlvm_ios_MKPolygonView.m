...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKPolygonView___INIT____org_xmlvm_ios_MKPolygon]
    ...
    MKPolygonView* objCObj = [[MKPolygonView alloc] initWithPolygon:(MKPolygon*) (((org_xmlvm_ios_MKPolygon*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_MKPolygonView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKPolygonView___INIT___]
    MKPolygonView* objCObj = [[MKPolygonView alloc ] init];
    org_xmlvm_ios_MKPolygonView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MKPolygonView___INIT____org_xmlvm_ios_CGRect]
    ...
    MKPolygonView* objCObj = [[MKPolygonView alloc] initWithFrame:toCGRect(n1)];
    org_xmlvm_ios_MKPolygonView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
