...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaEntity___INIT___]
    MPMediaEntity* objCObj = [[MPMediaEntity alloc ] init];
    org_xmlvm_ios_MPMediaEntity_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    BOOL objCObj =  [MPMediaEntity  canFilterByProperty:ObjCVar1];
    [ObjCVar1 release];
