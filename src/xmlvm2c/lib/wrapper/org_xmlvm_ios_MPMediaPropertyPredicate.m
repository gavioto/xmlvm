...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaPropertyPredicate___INIT___]
    MPMediaPropertyPredicate* objCObj = [[MPMediaPropertyPredicate alloc ] init];
    org_xmlvm_ios_MPMediaPropertyPredicate_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaPropertyPredicate_getProperty__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz property];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_MPMediaPropertyPredicate_getComparisonType__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz comparisonType];
    return objCObj;
//XMLVM_END_WRAPPER
