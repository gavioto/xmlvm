...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSCountedSet___INIT____int]
    ...
    NSCountedSet* objCObj = [[NSCountedSet alloc] initWithCapacity:n1];
    org_xmlvm_ios_NSCountedSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSCountedSet___INIT____java_util_List]
NSArray * ObjCVar1 = toNSArray(n1);
    
    NSCountedSet* objCObj = [[NSCountedSet alloc] initWithArray:ObjCVar1];
    [ObjCVar1 release];
...
NSSet * ObjCVar1 = toNSSet(n1);
    ...
    NSCountedSet* objCObj = [[NSCountedSet alloc] initWithSet:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSCountedSet___INIT___]
    NSCountedSet* objCObj = [[NSCountedSet alloc ] init];
    org_xmlvm_ios_NSCountedSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_OBJECT_ARRAY(a1, n1); 
    ...
    NSCountedSet* objCObj = [[NSCountedSet alloc] initWithObjects:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ count:n2];
    org_xmlvm_ios_NSCountedSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSSet * ObjCVar1 = toNSSet(n1);
    ...
    NSCountedSet* objCObj = [[NSCountedSet alloc] initWithSet:ObjCVar1 copyItems:n2];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSCountedSet_countForObject___java_lang_Object]
    ...
    int objCObj = [thiz  countForObject:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj];
