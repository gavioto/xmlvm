...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSDirectoryEnumerator___INIT___]
    NSDirectoryEnumerator* objCObj = [[NSDirectoryEnumerator alloc ] init];
    org_xmlvm_ios_NSDirectoryEnumerator_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
