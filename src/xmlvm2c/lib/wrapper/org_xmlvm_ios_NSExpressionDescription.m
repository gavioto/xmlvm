...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSExpressionDescription___INIT___]
    NSExpressionDescription* objCObj = [[NSExpressionDescription alloc ] init];
    org_xmlvm_ios_NSExpressionDescription_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSExpressionDescription_expressionResultType__]
    ...
    int objCObj = [thiz expressionResultType];
