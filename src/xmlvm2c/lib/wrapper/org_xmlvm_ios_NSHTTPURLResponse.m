...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSHTTPURLResponse___INIT___]
    NSHTTPURLResponse* objCObj = [[NSHTTPURLResponse alloc ] init];
    org_xmlvm_ios_NSHTTPURLResponse_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar2 = toNSString(n2);
    ...
    NSHTTPURLResponse* objCObj = [[NSHTTPURLResponse alloc] initWithURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) MIMEType:ObjCVar2 expectedContentLength:n3 textEncodingName:ObjCVar4];
    [ObjCVar2 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSHTTPURLResponse_localizedStringForStatusCode___int]
    ...
    NSString* objCObj =  [NSHTTPURLResponse  localizedStringForStatusCode:n1];
