...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSKeyedArchiver___INIT____org_xmlvm_ios_NSMutableData]
    ...
    NSKeyedArchiver* objCObj = [[NSKeyedArchiver alloc] initForWritingWithMutableData:(NSMutableData*) (((org_xmlvm_ios_NSMutableData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSKeyedArchiver_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSKeyedArchiver___INIT___]
    NSKeyedArchiver* objCObj = [[NSKeyedArchiver alloc ] init];
    org_xmlvm_ios_NSKeyedArchiver_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSKeyedArchiver_archivedDataWithRootObject___java_lang_Object]
    ...
    NSData* objCObj =  [NSKeyedArchiver  archivedDataWithRootObject:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj];
...
NSString * ObjCVar2 = toNSString(n2);
    ...
    BOOL objCObj =  [NSKeyedArchiver  archiveRootObject:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj toFile:ObjCVar2];
    [ObjCVar2 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSKeyedArchiver_classNameForClass___org_xmlvm_ios_Class]
    ...
    NSString* objCObj =  [NSKeyedArchiver  classNameForClassStatic:(Class*) (((org_xmlvm_ios_Class*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSKeyedArchiver_classNameForClass___org_xmlvm_ios_Class]
    ...
    NSString* objCObj = [thiz  classNameForClass:(Class*) (((org_xmlvm_ios_Class*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
