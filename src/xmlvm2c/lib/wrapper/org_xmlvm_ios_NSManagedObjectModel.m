...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSManagedObjectModel___INIT___]
    ...
    NSManagedObjectModel* objCObj = [[NSManagedObjectModel alloc]init];

    org_xmlvm_ios_NSManagedObjectModel_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSManagedObjectModel___INIT____org_xmlvm_ios_NSURL]

    NSManagedObjectModel* objCObj = [[NSManagedObjectModel alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSManagedObjectModel_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSManagedObjectModel_configurations__]
    ...
    NSArray* objCObj = [thiz configurations];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSManagedObjectModel_entitiesForConfiguration___java_lang_String]
    ...
    NSArray* objCObj = [thiz  entitiesForConfiguration:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSManagedObjectModel_versionIdentifiers__]
    ...
    NSSet* objCObj = [thiz versionIdentifiers];
