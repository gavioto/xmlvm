...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMappingModel___INIT____org_xmlvm_ios_NSURL]
    ...
    NSMappingModel* objCObj = [[NSMappingModel alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMappingModel_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMappingModel___INIT___]
    NSMappingModel* objCObj = [[NSMappingModel alloc ] init];
    org_xmlvm_ios_NSMappingModel_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMappingModel_entityMappings__]
    ...
    NSArray* objCObj = [thiz entityMappings];
