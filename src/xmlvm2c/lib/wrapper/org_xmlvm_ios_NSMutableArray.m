...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableArray___INIT____int]
    ...
    NSMutableArray* objCObj = [[NSMutableArray alloc] initWithCapacity:n1];
    org_xmlvm_ios_NSMutableArray_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableArray___INIT___]
    NSMutableArray* objCObj = [[NSMutableArray alloc ] init];
    org_xmlvm_ios_NSMutableArray_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_OBJECT_ARRAY(a1, n1); 
    ...
    NSMutableArray* objCObj = [[NSMutableArray alloc] initWithObjects:a1->fields.org_xmlvm_runtime_XMLVMArray.array_ count:n2];
    org_xmlvm_ios_NSMutableArray_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSArray * ObjCVar1 = toNSArray(n1);
    ...
    NSMutableArray* objCObj = [[NSMutableArray alloc] initWithArray:ObjCVar1];
    [ObjCVar1 release];
...
NSArray * ObjCVar1 = toNSArray(n1);
    ...
    NSMutableArray* objCObj = [[NSMutableArray alloc] initWithArray:ObjCVar1 copyItems:n2];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSMutableArray* objCObj = [[NSMutableArray alloc] initWithContentsOfFile:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableArray___INIT____org_xmlvm_ios_NSURL]
    ...
    NSMutableArray* objCObj = [[NSMutableArray alloc] initWithContentsOfURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMutableArray_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableArray_arrayWithCapacity___int]
    ...
    NSArray* objCObj =  [NSMutableArray  arrayWithCapacity:n1];
