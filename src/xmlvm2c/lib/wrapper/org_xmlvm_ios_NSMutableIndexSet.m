...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableIndexSet___INIT___]
    NSMutableIndexSet* objCObj = [[NSMutableIndexSet alloc ] init];
    org_xmlvm_ios_NSMutableIndexSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableIndexSet___INIT____int]
    ...
    NSMutableIndexSet* objCObj = [[NSMutableIndexSet alloc] initWithIndex:n1];
    org_xmlvm_ios_NSMutableIndexSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableIndexSet___INIT____org_xmlvm_ios_NSRange]

    NSMutableIndexSet* objCObj = [[NSMutableIndexSet alloc] initWithIndexesInRange:toNSRange(n1)];
    org_xmlvm_ios_NSMutableIndexSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableIndexSet___INIT____org_xmlvm_ios_NSIndexSet]

    NSMutableIndexSet* objCObj = [[NSMutableIndexSet alloc] initWithIndexSet:(NSIndexSet*) (((org_xmlvm_ios_NSIndexSet*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMutableIndexSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
