...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableURLRequest___INIT___]
    NSMutableURLRequest* objCObj = [[NSMutableURLRequest alloc ] init];
    org_xmlvm_ios_NSMutableURLRequest_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableURLRequest___INIT____org_xmlvm_ios_NSURL]

    NSMutableURLRequest* objCObj = [[NSMutableURLRequest alloc] initWithURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_NSMutableURLRequest_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSMutableURLRequest___INIT____org_xmlvm_ios_NSURL_int_double]

    NSMutableURLRequest* objCObj = [[NSMutableURLRequest alloc] initWithURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) cachePolicy:n2 timeoutInterval:n3];
    org_xmlvm_ios_NSMutableURLRequest_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
