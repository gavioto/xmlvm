...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSNotificationCenter___INIT___]
    NSNotificationCenter* objCObj = [[NSNotificationCenter alloc ] init];
    org_xmlvm_ios_NSNotificationCenter_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSNotificationCenter_defaultCenter__]
    ...
    NSObject* objCObj =  [NSNotificationCenter defaultCenter];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSNotificationCenter_addObserverForName___java_lang_String_java_lang_Object_org_xmlvm_ios_NSOperationQueue_java_lang_Object]
    ...
    NSObject* objCObj = [thiz  addObserverForName:ObjCVar1 object:((org_xmlvm_ios_NSObject*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj queue:(NSOperationQueue*) (((org_xmlvm_ios_NSOperationQueue*) n3)->fields.org_xmlvm_ios_NSObject.wrappedObj) usingBlock:((org_xmlvm_ios_NSObject*) n4)->fields.org_xmlvm_ios_NSObject.wrappedObj];
    [ObjCVar1 release];
