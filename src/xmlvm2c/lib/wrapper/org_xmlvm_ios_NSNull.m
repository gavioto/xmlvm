...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSNull___INIT___]
    NSNull* objCObj = [[NSNull alloc ] init];
    org_xmlvm_ios_NSNull_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSNull_null__]
    ...
    NSNull* objCObj =  [NSNull null];
    if (!__TIB_org_xmlvm_ios_NSNull.classInitialized) __INIT_org_xmlvm_ios_NSNull();
