...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSPort___INIT___]
    NSPort* objCObj = [[NSPort alloc ] init];
    org_xmlvm_ios_NSPort_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSPort_reservedSpaceLength__]
    ...
    int objCObj = [thiz reservedSpaceLength];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSPort_sendBeforeDate___org_xmlvm_ios_NSDate_java_util_List_org_xmlvm_ios_NSPort_int]
    ...
    BOOL objCObj = [thiz  sendBeforeDate:(NSDate*) (((org_xmlvm_ios_NSDate*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) components:ObjCVar2 from:(NSPort*) (((org_xmlvm_ios_NSPort*) n3)->fields.org_xmlvm_ios_NSObject.wrappedObj) reserved:n4];
    [ObjCVar2 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSPort_sendBeforeDate___org_xmlvm_ios_NSDate_int_java_util_List_org_xmlvm_ios_NSPort_int]
    ...
    BOOL objCObj = [thiz  sendBeforeDate:(NSDate*) (((org_xmlvm_ios_NSDate*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) msgid:n2 components:ObjCVar3 from:(NSPort*) (((org_xmlvm_ios_NSPort*) n4)->fields.org_xmlvm_ios_NSObject.wrappedObj) reserved:n5];
    [ObjCVar3 release];
