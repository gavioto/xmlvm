...
JAVA_OBJECT jObject4 = org_xmlvm_ios_Reference_get__(n4);
    ...
    NSData* objCObj =  [NSPropertyListSerialization  dataWithPropertyList:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj format:n2 options:n3 error:&var4];
...
JAVA_OBJECT jObject5 = org_xmlvm_ios_Reference_get__(n5);
    ...
    int objCObj =  [NSPropertyListSerialization  writePropertyList:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj toStream:(NSOutputStream*) (((org_xmlvm_ios_NSOutputStream*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj) format:n3 options:n4 error:&var5];
...
XMLVM_VAR_INT_ARRAY(a3, n3); 
    ...
    NSObject* objCObj =  [NSPropertyListSerialization  propertyListWithData:(NSData*) (((org_xmlvm_ios_NSData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) options:n2 format:a3->fields.org_xmlvm_runtime_XMLVMArray.array_ error:&var4];
...
XMLVM_VAR_INT_ARRAY(a3, n3); 
    ...
    NSObject* objCObj =  [NSPropertyListSerialization  propertyListWithStream:(NSInputStream*) (((org_xmlvm_ios_NSInputStream*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) options:n2 format:a3->fields.org_xmlvm_runtime_XMLVMArray.array_ error:&var4];
...
JAVA_OBJECT jObject3 = org_xmlvm_ios_Reference_get__(n3);
    ...
    NSData* objCObj =  [NSPropertyListSerialization  dataFromPropertyList:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj format:n2 errorDescription:&var3];
...
XMLVM_VAR_INT_ARRAY(a3, n3); 
    ...
    NSObject* objCObj =  [NSPropertyListSerialization  propertyListFromData:(NSData*) (((org_xmlvm_ios_NSData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) mutabilityOption:n2 format:a3->fields.org_xmlvm_runtime_XMLVMArray.array_ errorDescription:&var4];
