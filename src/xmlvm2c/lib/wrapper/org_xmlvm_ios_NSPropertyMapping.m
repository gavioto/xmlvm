...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSPropertyMapping___INIT___]
    NSPropertyMapping* objCObj = [[NSPropertyMapping alloc ] init];
    org_xmlvm_ios_NSPropertyMapping_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSPropertyMapping_valueExpression__]
    ...
    NSExpression* objCObj = [thiz valueExpression];
