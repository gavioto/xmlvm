...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSSortDescriptor* objCObj = [[NSSortDescriptor alloc] initWithKey:ObjCVar1 ascending:n2];
    [ObjCVar1 release];

    org_xmlvm_ios_NSSortDescriptor_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSSortDescriptor* objCObj = [[NSSortDescriptor alloc] initWithKey:ObjCVar1 ascending:n2 comparator:((org_xmlvm_ios_NSObject*) n3)->fields.org_xmlvm_ios_NSObject.wrappedObj];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSortDescriptor___INIT___]
    NSSortDescriptor* objCObj = [[NSSortDescriptor alloc ] init];
    org_xmlvm_ios_NSSortDescriptor_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSortDescriptor_comparator__]
    ...
    NSObject* objCObj = [thiz comparator];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSortDescriptor_compareObject___java_lang_Object_java_lang_Object]
    ...
    int objCObj = [thiz  compareObject:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj toObject:((org_xmlvm_ios_NSObject*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSSortDescriptor_reversedSortDescriptor__]
    ...
    NSObject* objCObj = [thiz reversedSortDescriptor];
