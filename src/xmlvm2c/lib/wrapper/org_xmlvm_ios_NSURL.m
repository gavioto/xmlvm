...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSURL* objCObj = [[NSURL alloc] initWithScheme:ObjCVar1 host:ObjCVar2 path:ObjCVar3];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSURL* objCObj = [[NSURL alloc] initFileURLWithPath:ObjCVar1 isDirectory:n2];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL___INIT____java_lang_String_org_xmlvm_ios_NSURL_URLType]
    ...
    NSURL* objCObj = [[NSURL alloc] initWithString:ObjCVar1];
    [ObjCVar1 release];
    ...
    NSURL* objCObj = [[NSURL alloc] initFileURLWithPath:ObjCVar1];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSURL* objCObj = [[NSURL alloc] initWithString:ObjCVar1 relativeToURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL___INIT___]
    NSURL* objCObj = [[NSURL alloc ] init];
    org_xmlvm_ios_NSURL_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [NSURL  fileURLWithPath:ObjCVar1 isDirectory:n2];
    [ObjCVar1 release];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    NSObject* objCObj =  [NSURL  fileURLWithPath:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL_absoluteString__]
    ...
    NSString* objCObj = [thiz absoluteString];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL_relativeString__]
    ...
    NSString* objCObj = [thiz relativeString];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL_resourceSpecifier__]
    ...
    NSString* objCObj = [thiz resourceSpecifier];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL_fragment__]
    ...
    NSString* objCObj = [thiz fragment];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL_parameterString__]
    ...
    NSString* objCObj = [thiz parameterString];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL_relativePath__]
    ...
    NSString* objCObj = [thiz relativePath];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL_isFileReferenceURL__]
    ...
    BOOL objCObj = [thiz isFileReferenceURL];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_NSURL_setResourceData___org_xmlvm_ios_NSData]
    ...
    BOOL objCObj = [thiz  setResourceData:(NSData*) (((org_xmlvm_ios_NSData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
