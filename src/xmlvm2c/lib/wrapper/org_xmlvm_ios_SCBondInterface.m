...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SCBondInterface___INIT____org_xmlvm_ios_SCPreferences]
    ...
    SCBondInterface* objCObj = [[SCBondInterface alloc] create:(SCPreferences*) (((org_xmlvm_ios_SCPreferences*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_SCBondInterface_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SCBondInterface___INIT___]
    SCBondInterface* objCObj = [[SCBondInterface alloc ] init];
    org_xmlvm_ios_SCBondInterface_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
