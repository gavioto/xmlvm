...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SCNetworkSet___INIT____org_xmlvm_ios_SCPreferences]
    ...
    SCNetworkSet* objCObj = [[SCNetworkSet alloc] create:(SCPreferences*) (((org_xmlvm_ios_SCPreferences*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_SCNetworkSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SCNetworkSet___INIT___]
    SCNetworkSet* objCObj = [[SCNetworkSet alloc ] init];
    org_xmlvm_ios_SCNetworkSet_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
