...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SCVLANInterface___INIT____org_xmlvm_ios_SCPreferences_org_xmlvm_ios_SCNetworkInterface_org_xmlvm_ios_NSNumber]
    ...
    SCVLANInterface* objCObj = [[SCVLANInterface alloc] create:(SCPreferences*) (((org_xmlvm_ios_SCPreferences*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_SCVLANInterface_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SCVLANInterface___INIT___]
    SCVLANInterface* objCObj = [[SCVLANInterface alloc ] init];
    org_xmlvm_ios_SCVLANInterface_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
