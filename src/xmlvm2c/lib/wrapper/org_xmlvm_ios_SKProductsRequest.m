...
NSSet * ObjCVar1 = toNSSet(n1);
    ...
    SKProductsRequest* objCObj = [[SKProductsRequest alloc] initWithProductIdentifiers:ObjCVar1];
    [ObjCVar1 release];

    org_xmlvm_ios_SKProductsRequest_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SKProductsRequest___INIT___]
    SKProductsRequest* objCObj = [[SKProductsRequest alloc ] init];
    org_xmlvm_ios_SKProductsRequest_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
