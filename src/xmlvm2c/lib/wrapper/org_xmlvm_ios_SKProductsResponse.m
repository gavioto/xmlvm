...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SKProductsResponse___INIT___]
    SKProductsResponse* objCObj = [[SKProductsResponse alloc ] init];
    org_xmlvm_ios_SKProductsResponse_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_SKProductsResponse_getInvalidProductIdentifiers__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz invalidProductIdentifiers];
    return fromNSArray(objCObj);
//XMLVM_END_WRAPPER
