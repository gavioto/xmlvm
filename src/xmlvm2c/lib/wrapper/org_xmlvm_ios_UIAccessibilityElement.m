...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIAccessibilityElement___INIT____java_lang_Object]
    ...
    UIAccessibilityElement* objCObj = [[UIAccessibilityElement alloc] initWithAccessibilityContainer:((org_xmlvm_ios_NSObject*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj];
    org_xmlvm_ios_UIAccessibilityElement_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIAccessibilityElement___INIT___]
    UIAccessibilityElement* objCObj = [[UIAccessibilityElement alloc ] init];
    org_xmlvm_ios_UIAccessibilityElement_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIAccessibilityElement_getAccessibilityContainer__]
    ...
    XMLVM_VAR_THIZ;
    NSObject* objCObj = [thiz accessibilityContainer];
