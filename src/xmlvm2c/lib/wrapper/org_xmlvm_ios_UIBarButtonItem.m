...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIBarButtonItem___INIT____org_xmlvm_ios_UIView]
    ...
    UIBarButtonItem* objCObj = [[UIBarButtonItem alloc] initWithCustomView:(UIView*) (((org_xmlvm_ios_UIView*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_UIBarButtonItem_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIBarButtonItem___INIT___]
    UIBarButtonItem* objCObj = [[UIBarButtonItem alloc ] init];
    org_xmlvm_ios_UIBarButtonItem_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIBarButtonItem_getPossibleTitles__]
    ...
    XMLVM_VAR_THIZ;
    NSSet* objCObj = [thiz possibleTitles];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIBarButtonItem_getCustomView__]
    ...
    XMLVM_VAR_THIZ;
    UIView* objCObj = [thiz customView];    if (!__TIB_org_xmlvm_ios_UIView.classInitialized) __INIT_org_xmlvm_ios_UIView();
