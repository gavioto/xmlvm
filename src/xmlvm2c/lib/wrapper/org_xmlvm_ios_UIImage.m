...
NSString * ObjCVar1 = toNSString(n1);
    ...
    UIImage* objCObj = [[UIImage alloc] initWithContentsOfFile:ObjCVar1];
    [ObjCVar1 release];

    org_xmlvm_ios_UIImage_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIImage___INIT____org_xmlvm_ios_NSData]

    UIImage* objCObj = [[UIImage alloc] initWithData:(NSData*) (((org_xmlvm_ios_NSData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_UIImage_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_IOS_REF(CGImage, var1, n1);
    ...
    UIImage* objCObj = [[UIImage alloc] initWithCGImage:var1];
    org_xmlvm_ios_UIImage_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
XMLVM_VAR_IOS_REF(CGImage, var1, n1);
    ...
    UIImage* objCObj = [[UIImage alloc] initWithCGImage:var1 scale:n2 orientation:n3];
    org_xmlvm_ios_UIImage_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIImage___INIT___]
    UIImage* objCObj = [[UIImage alloc ] init];
    org_xmlvm_ios_UIImage_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIImage_getImageOrientation__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz imageOrientation];
    return objCObj;
//XMLVM_END_WRAPPER
