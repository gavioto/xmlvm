...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILocalizedIndexedCollation___INIT___]
    UILocalizedIndexedCollation* objCObj = [[UILocalizedIndexedCollation alloc ] init];
    org_xmlvm_ios_UILocalizedIndexedCollation_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILocalizedIndexedCollation_currentCollation__]
    ...
    UILocalizedIndexedCollation* objCObj =  [UILocalizedIndexedCollation currentCollation];
    if (!__TIB_org_xmlvm_ios_UILocalizedIndexedCollation.classInitialized) __INIT_org_xmlvm_ios_UILocalizedIndexedCollation();
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILocalizedIndexedCollation_getSectionTitles__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz sectionTitles];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UILocalizedIndexedCollation_sectionForSectionIndexTitleAtIndex___int]
    ...
    int objCObj = [thiz  sectionForSectionIndexTitleAtIndex:n1];
