...
NSString * ObjCVar1 = toNSString(n1);
    ...
    UIMarkupTextPrintFormatter* objCObj = [[UIMarkupTextPrintFormatter alloc] initWithMarkupText:ObjCVar1];
    [ObjCVar1 release];

    org_xmlvm_ios_UIMarkupTextPrintFormatter_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIMarkupTextPrintFormatter___INIT___]
    UIMarkupTextPrintFormatter* objCObj = [[UIMarkupTextPrintFormatter alloc ] init];
    org_xmlvm_ios_UIMarkupTextPrintFormatter_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIMarkupTextPrintFormatter_getMarkupText__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz markupText];
