...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPanGestureRecognizer___INIT___]
    UIPanGestureRecognizer* objCObj = [[UIPanGestureRecognizer alloc ] init];
    org_xmlvm_ios_UIPanGestureRecognizer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPanGestureRecognizer_getMinimumNumberOfTouches__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz minimumNumberOfTouches];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPanGestureRecognizer_getMaximumNumberOfTouches__]
    ...
    XMLVM_VAR_THIZ;
    int objCObj = [thiz maximumNumberOfTouches];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPanGestureRecognizer_translationInView___org_xmlvm_ios_UIView]
    ...
    CGPoint objCObj = [thiz  translationInView:(UIView*) (((org_xmlvm_ios_UIView*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPanGestureRecognizer_velocityInView___org_xmlvm_ios_UIView]
    ...
    CGPoint objCObj = [thiz  velocityInView:(UIView*) (((org_xmlvm_ios_UIView*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
