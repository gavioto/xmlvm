...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInfo___INIT___]
    UIPrintInfo* objCObj = [[UIPrintInfo alloc ] init];
    org_xmlvm_ios_UIPrintInfo_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInfo_printInfo__]
    ...
    UIPrintInfo* objCObj =  [UIPrintInfo printInfo];
    if (!__TIB_org_xmlvm_ios_UIPrintInfo.classInitialized) __INIT_org_xmlvm_ios_UIPrintInfo();
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInfo_getPrinterID__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz printerID];
