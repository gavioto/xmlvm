...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController___INIT___]
    UIPrintInteractionController* objCObj = [[UIPrintInteractionController alloc ] init];
    org_xmlvm_ios_UIPrintInteractionController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_isPrintingAvailable__]
    ...
    BOOL objCObj =  [UIPrintInteractionController isPrintingAvailable];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_printableUTIs__]
    ...
    NSSet* objCObj =  [UIPrintInteractionController printableUTIs];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_canPrintURL___org_xmlvm_ios_NSURL]
    ...
    BOOL objCObj =  [UIPrintInteractionController  canPrintURL:(NSURL*) (((org_xmlvm_ios_NSURL*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_canPrintData___org_xmlvm_ios_NSData]
    ...
    BOOL objCObj =  [UIPrintInteractionController  canPrintData:(NSData*) (((org_xmlvm_ios_NSData*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_getShowsPageRange__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz showsPageRange];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_getPrintingItem__]
    ...
    XMLVM_VAR_THIZ;
    NSObject* objCObj = [thiz printingItem];
    return xmlvm_get_associated_c_object (objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_getPrintingItems__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz printingItems];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_presentAnimated___boolean_java_lang_Object]
    ...
    BOOL objCObj = [thiz  presentAnimated:n1 completionHandler:((org_xmlvm_ios_NSObject*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_presentFromRect___org_xmlvm_ios_CGRect_org_xmlvm_ios_UIView_boolean_java_lang_Object]
    ...
    BOOL objCObj = [thiz  presentFromRect:toCGRect(n1) inView:(UIView*) (((org_xmlvm_ios_UIView*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj) animated:n3 completionHandler:((org_xmlvm_ios_NSObject*) n4)->fields.org_xmlvm_ios_NSObject.wrappedObj];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintInteractionController_presentFromBarButtonItem___org_xmlvm_ios_UIBarButtonItem_boolean_java_lang_Object]
    ...
    BOOL objCObj = [thiz  presentFromBarButtonItem:(UIBarButtonItem*) (((org_xmlvm_ios_UIBarButtonItem*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj) animated:n2 completionHandler:((org_xmlvm_ios_NSObject*) n3)->fields.org_xmlvm_ios_NSObject.wrappedObj];
