...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintPageRenderer___INIT___]
    UIPrintPageRenderer* objCObj = [[UIPrintPageRenderer alloc ] init];
    org_xmlvm_ios_UIPrintPageRenderer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintPageRenderer_getHeaderHeight__]
    ...
    XMLVM_VAR_THIZ;
    float objCObj = [thiz headerHeight];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintPageRenderer_getFooterHeight__]
    ...
    XMLVM_VAR_THIZ;
    float objCObj = [thiz footerHeight];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintPageRenderer_getPrintFormatters__]
    ...
    XMLVM_VAR_THIZ;
    NSArray* objCObj = [thiz printFormatters];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIPrintPageRenderer_printFormattersForPageAtIndex___int]
    ...
    NSArray* objCObj = [thiz  printFormattersForPageAtIndex:n1];
