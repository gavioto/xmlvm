...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UISplitViewController___INIT___]
    UISplitViewController* objCObj = [[UISplitViewController alloc ] init];
    org_xmlvm_ios_UISplitViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UISplitViewController___INIT____java_lang_String_org_xmlvm_ios_NSBundle]
NSString * ObjCVar1 = toNSString(n1);
    
    UISplitViewController* objCObj = [[UISplitViewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
