...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UISwitch___INIT____org_xmlvm_ios_CGRect]
    ...
    UISwitch* objCObj = [[UISwitch alloc] initWithFrame:toCGRect(n1)];
    org_xmlvm_ios_UISwitch_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UISwitch___INIT___]
    UISwitch* objCObj = [[UISwitch alloc ] init];
    org_xmlvm_ios_UISwitch_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
