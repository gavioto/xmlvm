...
NSString * ObjCVar1 = toNSString(n1);
    ...
    UITabBarItem* objCObj = [[UITabBarItem alloc] initWithTitle:ObjCVar1 image:(UIImage*) (((org_xmlvm_ios_UIImage*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj) tag:n3];
    [ObjCVar1 release];

    org_xmlvm_ios_UITabBarItem_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITabBarItem___INIT____int_int]

    UITabBarItem* objCObj = [[UITabBarItem alloc] initWithTabBarSystemItem:n1 tag:n2];
    org_xmlvm_ios_UITabBarItem_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITabBarItem___INIT___]
    UITabBarItem* objCObj = [[UITabBarItem alloc ] init];
    org_xmlvm_ios_UITabBarItem_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITabBarItem_getBadgeValue__]
    ...
    XMLVM_VAR_THIZ;
    NSString* objCObj = [thiz badgeValue];
