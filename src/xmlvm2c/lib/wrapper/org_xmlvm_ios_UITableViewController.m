...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITableViewController___INIT____int]
    ...
    UITableViewController* objCObj = [[UITableViewController alloc] initWithStyle:n1];
    org_xmlvm_ios_UITableViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITableViewController___INIT___]
    UITableViewController* objCObj = [[UITableViewController alloc ] init];
    org_xmlvm_ios_UITableViewController_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    UITableViewController* objCObj = [[UITableViewController alloc] initWithNibName:ObjCVar1 bundle:(NSBundle*) (((org_xmlvm_ios_NSBundle*) n2)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITableViewController_getTableView__]
    ...
    XMLVM_VAR_THIZ;
    UITableView* objCObj = [thiz tableView];    if (!__TIB_org_xmlvm_ios_UITableView.classInitialized) __INIT_org_xmlvm_ios_UITableView();
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITableViewController_getClearsSelectionOnViewWillAppear__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz clearsSelectionOnViewWillAppear];
    return objCObj;
//XMLVM_END_WRAPPER
