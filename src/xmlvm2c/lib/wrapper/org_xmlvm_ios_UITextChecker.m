...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITextChecker___INIT___]
    UITextChecker* objCObj = [[UITextChecker alloc ] init];
    org_xmlvm_ios_UITextChecker_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITextChecker_rangeOfMisspelledWordInString___java_lang_String_org_xmlvm_ios_NSRange_int_boolean_java_lang_String]
    ...
    NSRange objCObj = [thiz  rangeOfMisspelledWordInString:ObjCVar1 range:toNSRange(n2) startingAt:n3 wrap:n4 language:ObjCVar5];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITextChecker_guessesForWordRange___org_xmlvm_ios_NSRange_java_lang_String_java_lang_String]
    ...
    NSArray* objCObj = [thiz  guessesForWordRange:toNSRange(n1) inString:ObjCVar2 language:ObjCVar3];
    [ObjCVar2 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITextChecker_completionsForPartialWordRange___org_xmlvm_ios_NSRange_java_lang_String_java_lang_String]
    ...
    NSArray* objCObj = [thiz  completionsForPartialWordRange:toNSRange(n1) inString:ObjCVar2 language:ObjCVar3];
    [ObjCVar2 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITextChecker_ignoredWords__]
    ...
    NSArray* objCObj = [thiz ignoredWords];
...
NSString * ObjCVar1 = toNSString(n1);
    ...
    BOOL objCObj =  [UITextChecker  hasLearnedWord:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITextChecker_availableLanguages__]
    ...
    NSArray* objCObj =  [UITextChecker availableLanguages];
