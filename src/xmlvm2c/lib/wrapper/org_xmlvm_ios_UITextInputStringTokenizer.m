...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITextInputStringTokenizer___INIT____org_xmlvm_ios_UIResponder]
    ...
    UITextInputStringTokenizer* objCObj = [[UITextInputStringTokenizer alloc] initWithTextInput:(UIResponder*) (((org_xmlvm_ios_UIResponder*) n1)->fields.org_xmlvm_ios_NSObject.wrappedObj)];
    org_xmlvm_ios_UITextInputStringTokenizer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UITextInputStringTokenizer___INIT___]
    UITextInputStringTokenizer* objCObj = [[UITextInputStringTokenizer alloc ] init];
    org_xmlvm_ios_UITextInputStringTokenizer_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
