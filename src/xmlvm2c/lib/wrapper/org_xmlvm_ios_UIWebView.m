...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIWebView___INIT___]
    UIWebView* objCObj = [[UIWebView alloc ] init];
    org_xmlvm_ios_UIWebView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER

//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIWebView___INIT____org_xmlvm_ios_CGRect]

    UIWebView* objCObj = [[UIWebView alloc] initWithFrame:toCGRect(n1)];
    org_xmlvm_ios_UIWebView_INTERNAL_CONSTRUCTOR(me, objCObj);
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIWebView_canGoForward__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz canGoForward];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIWebView_stringByEvaluatingJavaScriptFromString___java_lang_String]
    ...
    NSString* objCObj = [thiz  stringByEvaluatingJavaScriptFromString:ObjCVar1];
    [ObjCVar1 release];
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIWebView_getScalesPageToFit__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz scalesPageToFit];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIWebView_getDetectsPhoneNumbers__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz detectsPhoneNumbers];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIWebView_getAllowsInlineMediaPlayback__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz allowsInlineMediaPlayback];
    return objCObj;
//XMLVM_END_WRAPPER
...
//XMLVM_BEGIN_WRAPPER[org_xmlvm_ios_UIWebView_getMediaPlaybackRequiresUserAction__]
    ...
    XMLVM_VAR_THIZ;
    BOOL objCObj = [thiz mediaPlaybackRequiresUserAction];
    return objCObj;
//XMLVM_END_WRAPPER
