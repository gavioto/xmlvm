...
public class Resources {
    ...
    public Drawable getDrawable(int resourceId) {
        ...
        return d;*/
        //TODO dummy
        final int star1=0x7f020001;
        final int star2=0x7f020002;
        final int star3=0x7f020003;
        final int star4=0x7f020004;
        
        String filename = null;
        switch(resourceId) {
        case star1 : filename = "star1.png"; break;
        case star2 : filename = "star2.png"; break;
        case star3 : filename = "star3.png"; break;
        case star4 : filename = "star4.png"; break;
        default: Assert.NOT_IMPLEMENTED();
        }
        
        Compatlib.System.String path = new Compatlib.System.String("res/drawable/" + filename);
        Uri uri = new Uri(path, UriKind.RelativeOrAbsolute);
        BitmapDrawable drawable = BitmapDrawable.xmlvmCreateWithImage(new BitmapImage(uri));
        return drawable;
    }
