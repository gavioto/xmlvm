...
public class SensorManager extends Object {
    ...
    public SensorManager() {
        ...
        accel.ReadingChanged.__add(new ReadingChangedEventHandler(this, new String("accelerometer_ReadingChanged")));
        accel.Start();
    }
    ...
    public void accelerometer_ReadingChanged(Object sender, AccelerometerReadingEventArgs args) {
        ...
        float[] values = new float[] { x, y, z, x, y, z };
