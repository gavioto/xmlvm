 ...
 * The JDK library.
 */
public class SaxonLibrary extends Library {
    private static final String ONE_JAR_LOCATION     = "/lib/saxon.jar";
    private static final String FILE_SYSTEM_LOCATION = "lib/saxon.jar";
    ...
    protected List<Targets> excludedTargets() {
        List<Targets> excluded = new ArrayList<Targets>();
        excluded.add(Targets.IPHONEANDROID);
        return excluded;
    }
}
