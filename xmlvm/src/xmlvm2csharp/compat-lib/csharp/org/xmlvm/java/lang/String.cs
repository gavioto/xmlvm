...
public void @this(org.xmlvm._nArrayAdapter<char> n1){
...
//XMLVM_BEGIN_WRAPPER[org.xmlvm.java.lang.String: char[] toCharArray()]
    return new org.xmlvm._nArrayAdapter<char>(this.str.ToCharArray());    
...
_tmpStr.@this(new org.xmlvm._nArrayAdapter<char>(global::System.Convert.ToString(n1).ToCharArray()));
return _tmpStr;
